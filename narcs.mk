...
MOVEDATA_NAMES_DIR := $(BUILD)/rawtext/750 $(BUILD)/rawtext/751
...
MSGDATA_COMPILETIME_DEPENDENCIES := $(notdir $(wildcard $(MSGDATA_COMPILETIME_DEPENDENCIES_DIR)/*.txt))
CHARMAP := charmap.txt
...
$(MONDATA_NARC): $(MONDATA_DEPENDENCIES)
	mkdir -p $(MONDATA_DIR) $(MONDATA_NAMES_DIR)
	$(ARMIPS) $^
