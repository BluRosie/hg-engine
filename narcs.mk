...
HEADBUTT_OBJ_DIR := $(BUILD)/headbutttrees_obj
HEADBUTT_NARC := $(BUILD_NARC)/headbutt.narc
HEADBUTT_TARGET := $(FILESYS)/a/2/5/2
HEADBUTT_DEPENDENCIES_DIR := data/headbutt

include $(HEADBUTT_DEPENDENCIES_DIR)/headbutt.mk

$(HEADBUTT_DIR) $(HEADBUTT_OBJ_DIR):
	mkdir -p $@

$(HEADBUTT_NARC): $(HEADBUTT_BINS)
	$(NARCHIVE) create $@ $(HEADBUTT_DIR) -nf

NARC_FILES += $(HEADBUTT_NARC)
REQUIRED_DIRECTORIES += $(HEADBUTT_DIR) $(HEADBUTT_OBJ_DIR)
