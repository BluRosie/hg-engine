...
MSGDATA_DEPENDENCIES_DIR_2 := $(MSGDATA_DEPENDENCIES_DIR)/custom
...
MSGDATA_ENGINE_DEPENDENCIES := $(wildcard $(MSGDATA_DEPENDENCIES_DIR)/*.txt)
MSGDATA_VANILLA_DEPENDENCIES := $(wildcard $(MSGDATA_DEPENDENCIES_DIR_2)/*.txt)
