...
BATTLEHUD_DEPENDENCIES := $(find $(BATTLEHUD_DEPENDENCIES_DIR)/*)
...
MOVEPARTICLES_DEPENDENCIES := $(find $(MOVEPARTICLES_DEPENDENCIES_DIR)/*)
...
MSGDATA_DEPENDENCIES := $(find $(MSGDATA_DEPENDENCIES_DIR)/*)
CHARMAP := charmap.txt

# find a better way to do this, pretty sure we can basename this in a separate target as well.  for the moment, just leave it and come back
$(MSGDATA_NARC): $(MSGDATA_DEPENDENCIES)
	$(PYTHON) $(NARCHIVE) extract $(MSGDATA_TARGET) -o $(MSGDATA_DIR) -nf
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/003.txt $(MSGDATA_DIR)/7_003
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/197.txt $(MSGDATA_DIR)/7_197
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/221.txt $(MSGDATA_DIR)/7_221
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/222.txt $(MSGDATA_DIR)/7_222
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/223.txt $(MSGDATA_DIR)/7_223
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/237.txt $(MSGDATA_DIR)/7_237
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/720.txt $(MSGDATA_DIR)/7_720
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/721.txt $(MSGDATA_DIR)/7_721
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/722.txt $(MSGDATA_DIR)/7_722
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/749.txt $(MSGDATA_DIR)/7_749
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/750.txt $(MSGDATA_DIR)/7_750
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/751.txt $(MSGDATA_DIR)/7_751
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/803.txt $(MSGDATA_DIR)/7_803
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/811.txt $(MSGDATA_DIR)/7_811
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/812.txt $(MSGDATA_DIR)/7_812
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/813.txt $(MSGDATA_DIR)/7_813
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/814.txt $(MSGDATA_DIR)/7_814
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/815.txt $(MSGDATA_DIR)/7_815
	$(MSGENC) -e -c $(CHARMAP) $(MSGDATA_DEPENDENCIES_DIR)/816.txt $(MSGDATA_DIR)/7_816
...
ITEMDATA_DEPENDENCIES := $(find $(ITEMDATA_DEPENDENCIES_DIR)/*)
...
OPENDEMO_DEPENDENCIES := $(find $(OPENDEMO_DEPENDENCIES_DIR)/*)
...
FOOTPRINTS_DEPENDENCIES := $(find $(FOOTPRINTS_DEPENDENCIES_DIR)/*)
...
MOVEANIM_DEPENDENCIES := $(find $(MOVEANIM_DEPENDENCIES_DIR)/*)

$(MOVEANIM_NARC): $(MOVEANIM_DEPENDENCIES)
...
MOVESUBANIM_DEPENDENCIES := $(find $(MOVESUBANIM_DEPENDENCIES_DIR)/*)

$(MOVESUBANIM_NARC): $(MOVESUBANIM_DEPENDENCIES)
...
MOVE_SEQ_DEPENDENCIES := $(find $(MOVE_SEQ_DEPENDENCIES_DIR)/*)

$(MOVE_SEQ_NARC): $(MOVE_SEQ_DEPENDENCIES)
...
BATTLE_EFF_DEPENDENCIES := $(find $(BATTLE_EFF_DEPENDENCIES_DIR)/*)

$(BATTLE_EFF_NARC): $(BATTLE_EFF_DEPENDENCIES)
...
BATTLE_SUB_DEPENDENCIES := $(find $(BATTLE_SUB_DEPENDENCIES_DIR)/*)

$(BATTLE_SUB_NARC): $(BATTLE_SUB_DEPENDENCIES)
...
ITEMGFX_DEPENDENCIES := $(find $(ITEMGFX_DEPENDENCIES_DIR)/*)
