...
BATTLETESTS_FILTER_FILES := $(wildcard test_filter.txt)
BATTLETESTS_FORCE_REGEN := $(if $(strip $(TEST_FILTER) $(BATTLETESTS_FILTER_FILES)),force-test,)
...
$(BATTLETESTS_HEADER) $(BATTLETESTS_MANIFEST): $(BATTLETESTS_TEST_FILES) $(BATTLETESTS_FILTER_FILES) $(BATTLETESTS_FORCE_REGEN) $(VENV_ACTIVATE)
