// Test: Zero to Hero - Worry Seed fails
...
BEGIN_TEST
{
    ...
    .enemyParty = {
        { .species = SPECIES_WOBBUFFET, .level = 50, .ability = ABILITY_TELEPATHY, .moves = { MOVE_WORRY_SEED }, .hp = FULL_HP },
    },
    ...
    .expectations = {
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Wobbuffet used Worry Seed!" },
