// Test: Zero to Hero - Gastro Acid fails
...
BEGIN_TEST
{
    ...
    .enemyParty = {
        { .species = SPECIES_WOBBUFFET, .level = 50, .ability = ABILITY_TELEPATHY, .moves = { MOVE_GASTRO_ACID }, .hp = FULL_HP },
    },
    ...
    .expectations = {
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Wobbuffet used Gastro Acid!" },
