...
BEGIN_TEST
{
    ...
    .expectations = {
        ...
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Mudsdale's Stamina" },
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Mudsdale's Defense rose!" },
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Kangaskhan's Sp. Atk fell!" },
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Mudsdale's Stamina" },
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Mudsdale's Defense rose!" },
    }
