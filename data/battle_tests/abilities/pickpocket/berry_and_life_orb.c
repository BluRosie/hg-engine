...
const struct TestBattleScenario BattleTests[] = {
...

    {
        ...
        .expectations = {
            { .expectationType = EXPECTATION_TYPE_HP_BAR, .battlerIDOrPartySlot = BATTLER_ENEMY_FIRST, .expectationValue.hpTaken = { 75, 75, 78, 78, 78, 79, 79, 82, 82, 83, 83, 86, 86, 87, 87, 90 } },
