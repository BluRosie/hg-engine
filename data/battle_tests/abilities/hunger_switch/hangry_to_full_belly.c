...
BEGIN_TEST
{
    ...
    .playerParty = {
        { .species = SPECIES_MORPEKO, .level = 50, .form = 1, .ability = ABILITY_HUNGER_SWITCH, .moves = { MOVE_CELEBRATE }, .hp = FULL_HP },
    },
    .enemyParty = {
        { .species = SPECIES_WOBBUFFET, .level = 50, .ability = ABILITY_TELEPATHY, .moves = { MOVE_CELEBRATE }, .hp = FULL_HP },
    },
    .playerScript = { {
