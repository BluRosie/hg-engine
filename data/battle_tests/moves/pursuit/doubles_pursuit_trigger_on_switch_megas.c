...
const struct TestBattleScenario BattleTests[] = {
    ...
    {   .battleType = BATTLE_TYPE_DOUBLE,
        ...
        .expectations = {
            ...
            { .expectationType = EXPECTATION_TYPE_HP_BAR, .battlerIDOrPartySlot = BATTLER_ENEMY_FIRST, .expectationValue.hpTaken = { 26, 26, 26, 27, 27, 27, 28, 28, 28, 29, 29, 29, 30, 30, 30, 31 } },
