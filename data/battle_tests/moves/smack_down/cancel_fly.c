...
BEGIN_TEST {
    ...
    .enemyParty = { {
                        ...
                        .ability = ABILITY_STURDY,
                        .item = ITEM_NONE,
                        .moves = { MOVE_SLEEP_TALK, MOVE_FLY, MOVE_NONE, MOVE_NONE },
                        .hp = FULL_HP,
                        .status = 0,
                        .condition2 = 0,
                        .moveEffectFlags = 0,
    ...
    .expectations = {
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Skarmory flew up high!" },
        ...
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "The opposing Skarmory used Sleep Talk!" },
    },
} END_TEST
