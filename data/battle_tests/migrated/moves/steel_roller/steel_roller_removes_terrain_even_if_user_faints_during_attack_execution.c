// Test: Steel Roller removes Terrain even if user faints during attack execution
// Source: /home/zebben/git/pokeemerald-expansion/test/battle/move_effect/steel_roller.c
    ...
    .enemyParty = {
        {
            ...
            .ability = ABILITY_NO_GUARD,
            .item = ITEM_LIFE_ORB,
            .moves = { MOVE_STEEL_ROLLER, MOVE_NONE, MOVE_NONE, MOVE_NONE },
            .hp = 1,
            .status = 0,
            .condition2 = 0,
            .moveEffectFlags = 0,
