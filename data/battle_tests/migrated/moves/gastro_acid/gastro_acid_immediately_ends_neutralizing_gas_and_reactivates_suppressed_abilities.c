// Test: Gastro Acid immediately ends Neutralizing Gas and reactivates suppressed abilities
// Source: /home/zebben/git/pokeemerald-expansion/test/battle/move_effect/gastro_acid.c
// Tags: move
    ...
    .playerParty = {
        {
            ...
            .item = ITEM_NONE,
            .moves = { MOVE_GASTRO_ACID, MOVE_NONE, MOVE_NONE, MOVE_NONE },
            .hp = FULL_HP,
            .status = 0,
            .condition2 = 0,
            .moveEffectFlags = 0,
