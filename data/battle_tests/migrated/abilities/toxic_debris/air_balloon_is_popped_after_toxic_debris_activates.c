// Test: Air Balloon is popped after Toxic Debris activates
...
BEGIN_TEST
    ...
    .expectations = {
        ...
        { .expectationType = EXPECTATION_TYPE_MESSAGE, .expectationValue.message = "Glimmora's Air Balloon popped!" }
    },
    .knownFailing = TRUE,
}
END_TEST
