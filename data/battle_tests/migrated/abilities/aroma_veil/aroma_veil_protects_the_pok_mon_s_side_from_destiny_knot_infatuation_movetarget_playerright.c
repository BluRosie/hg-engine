// Test: Aroma Veil protects the Pokemon's side from Destiny Knot infatuation [moveTarget=playerRight]
// Source: /home/zebben/git/pokeemerald-expansion/test/battle/ability/aroma_veil.c
// Tags: ability, protection
