...
// Called by Volt Absorb, Water Absorb and Earth Eater.
_Start:
    PrintAttackMessage 
    Wait 
    WaitButtonABTime 15
    UpdateMonDataFromVar OPCODE_GET, BATTLER_CATEGORY_MSG_BATTLER_TEMP, BMON_DATA_MAXHP, BSCRIPT_VAR_CALC_TEMP
    CompareMonDataToVar OPCODE_EQU, BATTLER_CATEGORY_MSG_BATTLER_TEMP, BMON_DATA_HP, BSCRIPT_VAR_CALC_TEMP, _HealthFull
    // This overwrites the target/defence_client, which we don't want to do.
