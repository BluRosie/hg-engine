...
_Start:
    ...
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_ATTACKER, BMON_DATA_HELD_ITEM, ITEM_NONE, _CheckDefenderItem
    // {0} obtained one {1}.
...
_CheckDefenderItem:
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_DEFENDER, BMON_DATA_HELD_ITEM, ITEM_NONE, _End
    // {0} obtained one {1}.
