...
_321:
    ...
    PrintMessage 1527, TAG_NICKNAME_ITEM, BATTLER_CATEGORY_DEFENDER, BATTLER_CATEGORY_MSG_TEMP
    Wait
    WaitButtonABTime 30
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_DEFENDER, BMON_DATA_HP, 0, _removeItem
    CompareMonDataToValue OPCODE_NEQ, BATTLER_CATEGORY_DEFENDER, BMON_DATA_ABILITY, ABILITY_CHEEK_POUCH, _removeItem
    ...
    UpdateHealthBar BATTLER_CATEGORY_DEFENDER
    Wait 
    UpdateHealthBarValue BATTLER_CATEGORY_DEFENDER
    //Call BATTLE_SUBSCRIPT_UPDATE_HP
    // {0} had its HP restored.
    PrintMessage 1396, TAG_NICKNAME, BATTLER_CATEGORY_DEFENDER
    Wait 
    WaitButtonABTime 30
