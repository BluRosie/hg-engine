...
_HandleChilanBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_NORMAL, _ReduceDamageMessage
    GoTo _End

_HandleOccaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_FIRE, _ReduceDamageMessage
    GoTo _End

_HandlePasshoBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_WATER, _ReduceDamageMessage
    GoTo _End

_HandleWacanBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_ELECTRIC, _ReduceDamageMessage
    GoTo _End

_HandleRindoBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_GRASS, _ReduceDamageMessage
    GoTo _End

_HandleYacheBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_ICE, _ReduceDamageMessage
    GoTo _End

_HandleChopleBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_FIGHTING, _ReduceDamageMessage
    GoTo _End

_HandleKebiaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_POISON, _ReduceDamageMessage
    GoTo _End

_HandleShucaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_GROUND, _ReduceDamageMessage
    GoTo _End

_HandleCobaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_FLYING, _ReduceDamageMessage
    GoTo _End

_HandlePayapaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_PSYCHIC, _ReduceDamageMessage
    GoTo _End

_HandleTangaBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_BUG, _ReduceDamageMessage
    GoTo _End

_HandleChartiBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_ROCK, _ReduceDamageMessage
    GoTo _End

_HandleKasibBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_GHOST, _ReduceDamageMessage
    GoTo _End

_HandleHabanBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_DRAGON, _ReduceDamageMessage
    GoTo _End

_HandleColburBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_DARK, _ReduceDamageMessage
    GoTo _End

_HandleRoseliBerry:
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_CALC_TEMP, TYPE_FAIRY, _ReduceDamageMessage
    GoTo _End

_HandleBabiriBerry:
    CompareVarToValue OPCODE_NEQ, BSCRIPT_VAR_CALC_TEMP, TYPE_STEEL, _End

_ReduceDamageMessage:
