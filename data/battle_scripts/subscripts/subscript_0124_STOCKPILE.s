...
_Start:
    PrintAttackMessage
    Wait
    // Stockpile has a maximum of 3.
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_ATTACKER, BMON_DATA_STOCKPILE_COUNT, 3, _FullStockpile
    PlayMoveAnimation BATTLER_CATEGORY_ATTACKER
    Wait
    // Don't play the attack animation a second time.
    ...
    CompareVarToValue OPCODE_FLAG_SET, BSCRIPT_VAR_BATTLE_STATUS, BATTLE_STATUS_FAIL_STAT_STAGE_CHANGE, _BoostSpecialDefense
    UpdateMonData OPCODE_ADD, BATTLER_CATEGORY_ATTACKER, BMON_DATA_STOCKPILE_DEF_BOOSTS, 1

_BoostSpecialDefense:
    UpdateVar OPCODE_SET, BSCRIPT_VAR_SIDE_EFFECT_PARAM, MOVE_SUBSCRIPT_PTR_SP_DEFENSE_UP_1_STAGE
    Call BATTLE_SUBSCRIPT_UPDATE_STAT_STAGE
    CompareVarToValue OPCODE_FLAG_SET, BSCRIPT_VAR_BATTLE_STATUS, BATTLE_STATUS_FAIL_STAT_STAGE_CHANGE, _Cleanup
