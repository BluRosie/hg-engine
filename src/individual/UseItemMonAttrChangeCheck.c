...
u32 UseItemMonAttrChangeCheck_Internal(struct PartyMenu *wk, void *dat);
 ...
 */
u32 __attribute__((section (".init"))) UNUSED UseItemMonAttrChangeCheck_Internal(struct PartyMenu *wk, void *dat)
{
