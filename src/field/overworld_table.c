...
struct OVERWORLD_TAG gOWTagToFileNum[] = // skip down a bit to see the parts that are specifically for pokémon
    {
        ...
        MON_FOLLOWER_ENTRY(SPECIES_ZYGARDE_COMPLETE, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_RUBY_CREAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_MATCHA_CREAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_MINT_CREAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_LEMON_CREAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_SALTED_CREAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_RUBY_SWIRL, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_CARAMEL_SWIRL, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ALCREMIE_RAINBOW_SWIRL, OVERWORLD_SIZE_SMALL)
