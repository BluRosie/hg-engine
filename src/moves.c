...
u16 move_effect_to_subscripts[] =
{
	...
	[ADD_STATUS_EFF_UNUSED_1]                    = SUB_SEQ_UNUSED_1,
	[ADD_STATUS_EFF_ATK_UP_CHARGE_TURN_SOLAR_BLADE]= SUB_SEQ_HEAL_USER_AND_ALLY,
	[ADD_STATUS_EFF_SP_ATK_UP_CHARGE_TURN_SOLAR_BEAM]= SUB_SEQ_ATK_UP_CHARGE_TURN_SOLAR_BLADE,
	[ADD_STATUS_EFF_POWER_HERB_SOLAR_BLADE]      = SUB_SEQ_SP_ATK_UP_CHARGE_TURN_SOLAR_BEAM,
	[ADD_STATUS_EFF_ATK_UP_CHARGE_TURN_SOLAR_BLADE]= SUB_SEQ_POWER_HERB_SOLAR_BLADE,
	[ADD_STATUS_EFF_ATK_UP_SUN_SKIP]             = SUB_SEQ_ATK_UP_SUN_SKIP,
};
