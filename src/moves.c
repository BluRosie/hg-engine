...
u16 move_effect_to_subscripts[] =
{
	...
	//null effects
	[ADD_STATUS_EFF_HEAL_STATUS]                 = SUB_SEQ_HEAL_STATUS,
	[ADD_STATUS_EFF_VICTORY_DANCE]               = SUB_SEQ_ATK_DEF_SPEED_UP,
	[ADD_STATUS_EFF_HEAL_USER_AND_ALLY]          = SUB_SEQ_HEAL_USER_AND_ALLY,
};
