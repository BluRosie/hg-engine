...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_UNOVA] = {0x2E, SEQ_VS_UNOVA},
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_UNOVA_ACE_M, ANIM_MUSIC_COMBO_UNOVA*4},
    {TRAINERCLASS_UNOVA_ACE_F, ANIM_MUSIC_COMBO_UNOVA*4},
    // (***END OF VANILLA ENTRIES***)
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_HIKER, .music1 = SEQ_EYE_MOUNT, .music2 = SEQ_EYE_MOUNT},
    {.class = TRAINERCLASS_BATTLE_GIRL, .music1 = SEQ_EYE_FIGHT, .music2 = SEQ_EYE_FIGHT},
    {.class = TRAINERCLASS_FISHERMAN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_BLACK_BELT, .music1 = SEQ_EYE_FIGHT, .music2 = SEQ_EYE_FIGHT},
    {.class = TRAINERCLASS_PKMN_BREEDER_M, .music1 = SEQ_GS_EYE_K_SHOUNEN, .music2 = SEQ_GS_EYE_K_SHOUNEN},
    {.class = TRAINERCLASS_PKMN_BREEDER_F, .music1 = SEQ_GS_EYE_K_SHOUJO, .music2 = SEQ_GS_EYE_K_SHOUJO},
    {.class = TRAINERCLASS_COWGIRL, .music1 = SEQ_EYE_MOUNT, .music2 = SEQ_EYE_MOUNT},
    ...
    {.class = TRAINERCLASS_ACE_TRAINER_M_GS, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    {.class = TRAINERCLASS_ACE_TRAINER_F_GS, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    {.class = TRAINERCLASS_WAITRESS, .music1 = SEQ_GS_EYE_K_SHOUNEN, .music2 = SEQ_GS_EYE_K_SHOUNEN},
    {.class = TRAINERCLASS_VETERAN, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    {.class = TRAINERCLASS_DRAGON_TAMER, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    ...
    {.class = TRAINERCLASS_PKMN_RANGER_M, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    {.class = TRAINERCLASS_PKMN_RANGER_F, .music1 = SEQ_EYE_ELITE, .music2 = SEQ_EYE_ELITE},
    ...
    {.class = TRAINERCLASS_TUBER_M, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
    {.class = TRAINERCLASS_TUBER_F, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    ...
    {.class = TRAINERCLASS_RUIN_MANIAC, .music1 = SEQ_EYE_MOUNT, .music2 = SEQ_EYE_MOUNT},
    {.class = TRAINERCLASS_PSYCHIC_M, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_PSYCHIC_F, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    ...
    {.class = TRAINERCLASS_SCHOOL_KID_F, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    ...
    {.class = TRAINERCLASS_RANCHER, .music1 = SEQ_EYE_MOUNT, .music2 = SEQ_EYE_MOUNT},
    ...
    {.class = TRAINERCLASS_BUG_CATCHER_F, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
    {.class = TRAINERCLASS_SHRINE_MAIDEN, .music1 = SEQ_GS_EYE_BOUZU, .music2 = SEQ_GS_EYE_BOUZU},
    {.class = TRAINERCLASS_BIRD_KEEPER, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
};
