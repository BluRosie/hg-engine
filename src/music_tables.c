...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_BLUE] = {0x1B, SEQ_2381 },
    ...
    [ANIM_MUSIC_COMBO_KIMONO_GIRL] = {0x2D, SEQ_2383},
    [ANIM_MUSIC_COMBO_RED] = {0x2E, SEQ_2385},
    // (***END OF VANILLA ENTRIES***)
    [ANIM_MUSIC_COMBO_ELDER] = {0x2E, SEQ_2382},
    [ANIM_MUSIC_COMBO_BUCK] = {0x2E, SEQ_2384},
    [ANIM_MUSIC_COMBO_SAGE] = {0x2D, SEQ_2383},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_SAGE, ANIM_MUSIC_COMBO_SAGE*4}
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_SAGE, .music1 = SEQ_GS_EYE_MAIKO, .music2 = SEQ_GS_EYE_MAIKO},
};
