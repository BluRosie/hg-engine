...
const u8 sTrainerGenders[] = {
    ...
    [TRAINERCLASS_BUG_CATCHER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_SHRINE_MAIDEN] = TRAINER_FEMALE,
    [TRAINERCLASS_TEACHER_REY] = TRAINER_MALE,
    [TRAINERCLASS_UNOVA_ACE_M] = TRAINER_MALE,
    [TRAINERCLASS_UNOVA_ACE_F] = TRAINER_FEMALE,
};
