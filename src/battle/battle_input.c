...
void Sub_PokeIconResourceLoad(struct BI_PARAM *bip)
{
    ...
    // weather
    if (gBattleSystem->sp->field_condition & WEATHER_ANY_ICONS)
    {
        if (gBattleSystem->sp->field_condition & WEATHER_SUNNY_ANY)
        {
            nclr = BATTLE_GFX_SUN_NCLR;
        }
        else if (gBattleSystem->sp->field_condition & WEATHER_RAIN_ANY)
        {
            nclr = BATTLE_GFX_RAIN_NCLR;
        }
        else if (gBattleSystem->sp->field_condition & WEATHER_SANDSTORM_ANY)
        {
            nclr = BATTLE_GFX_SANDSTORM_NCLR;
        }
        else if (gBattleSystem->sp->field_condition & WEATHER_HAIL_ANY)
        {
