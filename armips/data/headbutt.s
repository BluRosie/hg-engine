...
headbuttheader  69,   0,   0   // Cherrygrove City Pokemon Centre
.close
...
headbuttheader  81,   0,   0   // Ecruteak Pokemon Centre
.close
...
headbuttheader 131,   0,   0   // Ecruteak City Pokemon Centre (Lower) 
.close
...
headbuttheader 144,   0,   0   // Cherrygrove City Pokemon Centre (Lower)
.close
...
headbuttheader 158,   0,   0   // Violet City Pokemon Centre
.close
...
headbuttheader 166,   0,   0   // Azalea Town Pokemon Centre
.close

headbuttheader 167,   0,   0   // Violet City Pokemon Centre (Lower)
.close

headbuttheader 168,   0,   0   // Azalea Town Pokemon Centre (Lower)
.close

headbuttheader 169,   0,   0   // Route 32 Pokemon Centre
.close

headbuttheader 170,   0,   0   // Route 32 Pokemon Centre (Lower)
.close
...
headbuttheader 185,   0,   0   // Goldenrod City Pokemon Centre
.close
...
headbuttheader 219,   0,   0   // Goldenrod City Pokemon Centre (Lower)
.close
...
headbuttheader 226,   0,   0   // Olivine City Pokemon Centre
.close
...
headbuttheader 236,   0,   0   // Cianwood City Pokemon Centre
.close
...
headbuttheader 241,   0,   0   // Cianwood City Pokemon Centre (Lower)
.close
...
headbuttheader 246,   0,   0   // Mahogany Town Pokemon Centre
.close
...
headbuttheader 293,   0,   0   // Blackthorn City Pokemon Centre
.close
...
headbuttheader 358,   0,   0   // Vermilion City Pokemon Centre
.close

headbuttheader 359,   0,   0   // Vermilion City Pokemon Centre (Lower)
.close

headbuttheader 360,   0,   0   // Vermilion City Pokemart
.close

headbuttheader 361,   0,   0   // Vermilion City Pokemon Centre
.close
...
headbuttheader 393,   0,   0   // Celadon City Pokemon Centre
.close

headbuttheader 394,   0,   0   // Celadon City Pokemon Centre (Lower)
.close
...
headbuttheader 428,   0,   0   // Cerulean City Pokemon Centre
.close
...
headbuttheader 434,   0,   0   // Lavender Town Pokemon Centre
.close
...
headbuttheader 466,   0,   0   // Route 10 Pokemon Centre
.close
...
headbuttheader 475,   0,   0   // Pewter City Pokemon Centre
.close

headbuttheader 476,   0,   0   // Pewter City Pokemon Centre (Lower)
.close
...
headbuttheader 482,   0,   0   // Fushsia City Pokemon Centre
.close

headbuttheader 483,   0,   0   // Fushsia City House
.close

headbuttheader 484,   0,   0   // Route 10 Pokemon Centre (Lower)
.close

headbuttheader 485,   0,   0   // Fuchsia City Pokemon Centre (Lower)
.close
...
headbuttheader 494,   0,   0   // Lavender Town Pokemon Centre (Lower)
.close

headbuttheader 495,   0,   0   // Cerulean City Pokemon Centre (Lower)
.close
...
headbuttheader 501,   0,   0   // Viridian City Pokemon Centre 
.close

headbuttheader 502,   0,   0   // Viridian City Pokemon Centre (Lower)
.close
...
headbuttheader 508,   0,   0   // Cinnabar Island Pokemon Centre
.close

headbuttheader 509,   0,   0   // Cinnabar Island Pokemon Centre (Lower)
.close

headbuttheader 510,   0,   0   // Route 28 House
.close

headbuttheader 511,   0,   0   // Route 3 Pokemon Centre
.close

headbuttheader 512,   0,   0   // Route 3 Pokemon Centre (Lower)
.close

headbuttheader 513,   0,   0   // Mt. Moon Square
.close

headbuttheader 514,   0,   0   // Mt. Silver Pokemon Centre
.close

headbuttheader 515,   0,   0   // Mt. Silver Pokemon Centre (Lower)
.close
...
headbuttheader 535,   0,   0   // Safari Zone Gate Pokemon Centre (Lower)
.close
...
headbuttheader 539,   0,   0   // Pokemon League Pokemon Centre (Lower)
.close