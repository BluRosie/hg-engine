...
// treecoords requires 6 pairs of x/y coordinates per tree.  fill the remaining pairs with -1s
...
headbuttheader  68,   0,   0   // Cherrygrove City Pokemart
.close

headbuttheader  69,   0,   0   // Cherrygrove City Pokemon Center
.close
...
headbuttheader  79,   0,   0   // Ecruteak City Pokemart
.close

headbuttheader  80,   0,   0   // Ecruteak City Gym
.close

headbuttheader  81,   0,   0   // Ecruteak Pokemon Center
.close
...
headbuttheader 131,   0,   0   // Ecruteak City Pokemon Center (Lower) 
.close
...
headbuttheader 143,   0,   0   // Mr Pokemons House
.close

headbuttheader 144,   0,   0   // Cherrygrove City Pokemon Center (Lower)
.close
...
headbuttheader 150,   0,   0   // Route 35 & Pokeathlon Dome Inbetween
.close
...
headbuttheader 157,   0,   0   // Violet City Pokemart
.close

headbuttheader 158,   0,   0   // Violet City Pokemon Center
.close

headbuttheader 159,   0,   0   // Violet City Pokemon School
.close
...
headbuttheader 165,   0,   0   // Azalea Town Pokemart
.close

headbuttheader 166,   0,   0   // Azalea Town Pokemon Center
.close

headbuttheader 167,   0,   0   // Violet City Pokemon Center (Lower)
.close

headbuttheader 168,   0,   0   // Azalea Town Pokemon Center (Lower)
.close

headbuttheader 169,   0,   0   // Route 32 Pokemon Center
.close

headbuttheader 170,   0,   0   // Route 32 Pokemon Center (Lower)
.close
...
headbuttheader 185,   0,   0   // Goldenrod City Pokemon Center
.close
...
headbuttheader 219,   0,   0   // Goldenrod City Pokemon Center (Lower)
.close
...
headbuttheader 226,   0,   0   // Olivine City Pokemon Center
.close

headbuttheader 227,   0,   0   // Olivine City Pokemart
.close
...
headbuttheader 231,   0,   0   // Olivine City Cafe
.close
...
headbuttheader 236,   0,   0   // Cianwood City Pokemon Center
.close
...
headbuttheader 241,   0,   0   // Cianwood City Pokemon Center (Lower)
.close
...
headbuttheader 246,   0,   0   // Mahogany Town Pokemon Center
.close
...
headbuttheader 280,   0,   0   // Pokeathlon Dome (Outside)
.close

headbuttheader 281,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 282,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 283,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 284,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 285,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 286,   0,   0   // Pokeathlon Dome (Inside)
.close

headbuttheader 287,   0,   0   // Pokeathlon Dome (Inside)
.close
...
headbuttheader 292,   0,   0   // Blackthorn City Pokemart
.close

headbuttheader 293,   0,   0   // Blackthorn City Pokemon Center
.close
...
headbuttheader 299,   0,   0   // Pokemon League Reception Gate
.close

headbuttheader 300,   0,   0   // Pokemon League
.close

headbuttheader 301,   0,   0   // Pokemon League (Wills Room)
.close

headbuttheader 302,   0,   0   // Pokemon League (Kogas Room)
.close

headbuttheader 303,   0,   0   // Pokemon League (Brunos Room)
.close

headbuttheader 304,   0,   0   // Pokemon League (Karens Room)
.close

headbuttheader 305,   0,   0   // Pokemon League (Lances Room)
.close

headbuttheader 306,   0,   0   // Pokemon League (Hall of Fame)
.close
...
headbuttheader 331,   0,   0   // Pokemon Daycare
.close
...
headbuttheader 358,   0,   0   // Vermilion City Pokemon Center
.close

headbuttheader 359,   0,   0   // Vermilion City Pokemon Center (Lower)
.close

headbuttheader 360,   0,   0   // Vermilion City Pokemart
.close

headbuttheader 361,   0,   0   // Vermilion City Pokemon Center
.close

headbuttheader 362,   0,   0   // Vermilion City Pokemon Fan Club
.close
...
headbuttheader 367,   0,   0   // Olivine City Pokemon Center (Lower)
.close

headbuttheader 368,   0,   0   // Mahogany Town Pokemon Center (Lower)
.close

headbuttheader 369,   0,   0   // Blackthorn Town Pokemon Center (Lower)
.close
...
headbuttheader 393,   0,   0   // Celadon City Pokemon Center
.close

headbuttheader 394,   0,   0   // Celadon City Pokemon Center (Lower)
.close
...
headbuttheader 407,   0,   0   // Saffron City Pokemon Center
.close

headbuttheader 408,   0,   0   // Saffron City Pokemon Center (Lower)
.close

headbuttheader 409,   0,   0   // Saffron City Pokemart
.close
...
headbuttheader 426,   0,   0   // Cerulean City Pokemart
.close

headbuttheader 427,   0,   0   // Cerulean City Gym
.close

headbuttheader 428,   0,   0   // Cerulean City Pokemon Center
.close
...
headbuttheader 433,   0,   0   // Lavender Town Pokemart
.close

headbuttheader 434,   0,   0   // Lavender Town Pokemon Center
.close
...
headbuttheader 466,   0,   0   // Route 10 Pokemon Center
.close
...
headbuttheader 474,   0,   0   // Pewter City Pokemart
.close

headbuttheader 475,   0,   0   // Pewter City Pokemon Center
.close

headbuttheader 476,   0,   0   // Pewter City Pokemon Center (Lower)
.close

headbuttheader 477,   0,   0   // Pewter City House
.close

headbuttheader 478,   0,   0   // Fushsia City Pokemart
.close
...
headbuttheader 482,   0,   0   // Fushsia City Pokemon Center
.close

headbuttheader 483,   0,   0   // Fushsia City House
.close

headbuttheader 484,   0,   0   // Route 10 Pokemon Center (Lower)
.close

headbuttheader 485,   0,   0   // Fuchsia City Pokemon Center (Lower)
.close
...
headbuttheader 494,   0,   0   // Lavender Town Pokemon Center (Lower)
.close

headbuttheader 495,   0,   0   // Cerulean City Pokemon Center (Lower)
.close
...
headbuttheader 500,   0,   0   // Viridian City Pokemart
.close

headbuttheader 501,   0,   0   // Viridian City Pokemon Center 
.close

headbuttheader 502,   0,   0   // Viridian City Pokemon Center (Lower)
.close
...
headbuttheader 508,   0,   0   // Cinnabar Island Pokemon Center
.close

headbuttheader 509,   0,   0   // Cinnabar Island Pokemon Center (Lower)
.close

headbuttheader 510,   0,   0   // Route 28 House
.close

headbuttheader 511,   0,   0   // Route 3 Pokemon Center
.close

headbuttheader 512,   0,   0   // Route 3 Pokemon Center (Lower)
.close

headbuttheader 513,   0,   0   // Mt. Moon Square
.close

headbuttheader 514,   0,   0   // Mt. Silver Pokemon Center
.close

headbuttheader 515,   0,   0   // Mt. Silver Pokemon Center (Lower)
.close
...
headbuttheader 528,   0,   0   // Frontier Access Pokemon Center
.close

headbuttheader 529,   0,   0   // Frontier Access Pokemon Center (Lower)
.close

headbuttheader 530,   0,   0   // Frontier Access Pokemart
.close
...
headbuttheader 534,   0,   0   // Safari Zone Gate Pokemon Center
.close

headbuttheader 535,   0,   0   // Safari Zone Gate Pokemon Center (Lower)
.close
...
headbuttheader 539,   0,   0   // Pokemon League Pokemon Center (Lower)
.close
