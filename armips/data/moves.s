...
movedata MOVE_RAGE, "Rage"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_RAGE, "The power of rage\nraises the Attack\nstat each time the\nuser is hit in battle."
...
movedata MOVE_FLAME_BURST, "Flame Burst"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_FLAME_BURST, "The user attacks the\nfoes with a bursting\nflame. It may also leave\nthe target with a burn."
...
movedata MOVE_MISTY_TERRAIN, "Misty Terrain"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_MISTY_TERRAIN, "The user turns the\nground into Misty\nTerrain for five\nturns. This powers up\nFairy-type moves."
...
movedata MOVE_PSYCHIC_TERRAIN, "Psychic Terrain"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_PSYCHIC_TERRAIN, "The user turns the\nground into Psychic\nTerrain for five\nturns. This powers up\nPsychic-type moves."
...
movedatalongname MOVE_DOUBLE_IRON_BASH, "Dual Iron Bash", "Double Iron Bash"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_DOUBLE_IRON_BASH, "The user rotates then\nstrikes twice with its\narms. This may also\nmake the target\nflinch."
...
movedatalongname MOVE_COLLISION_COURSE, "ColisionCourse","Collision Course" //Unimplemented
    battleeffect MOVE_EFFECT_HIT
    pss SPLIT_PHYSICAL
    basepower 100
    type TYPE_FIGHTING
