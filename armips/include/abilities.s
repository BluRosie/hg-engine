...
// gen 8
.equ ABILITY_INTREPID_SWORD, 234
.equ ABILITY_DAUNTLESS_SHIELD, 235
.equ ABILITY_LIBERO, 236
.equ ABILITY_BALL_FETCH, 237
.equ ABILITY_COTTON_DOWN, 238
.equ ABILITY_PROPELLER_TAIL, 239
.equ ABILITY_MIRROR_ARMOR, 240
.equ ABILITY_GULP_MISSILE, 241
.equ ABILITY_STALWART, 242
.equ ABILITY_STEAM_ENGINE, 243
.equ ABILITY_PUNK_ROCK, 244
.equ ABILITY_SAND_SPIT, 245
.equ ABILITY_ICE_SCALES, 246
.equ ABILITY_RIPEN, 247
.equ ABILITY_ICE_FACE, 248
.equ ABILITY_POWER_SPOT, 249
.equ ABILITY_MIMICRY, 250
.equ ABILITY_SCREEN_CLEANER, 251
.equ ABILITY_STEELY_SPIRIT, 252
.equ ABILITY_PERISH_BODY, 253
.equ ABILITY_WANDERING_SPIRIT, 254
.equ ABILITY_GORILLA_TACTICS, 255
.equ ABILITY_NEUTRALIZING_GAS, 256
.equ ABILITY_PASTEL_VEIL, 257
.equ ABILITY_HUNGER_SWITCH, 258
.equ ABILITY_QUICK_DRAW, 259
.equ ABILITY_UNSEEN_FIST, 260
.equ ABILITY_CURIOUS_MEDICINE, 261
.equ ABILITY_TRANSISTOR, 262
.equ ABILITY_DRAGONS_MAW, 263
.equ ABILITY_CHILLING_NEIGH, 264
.equ ABILITY_GRIM_NEIGH, 265
.equ ABILITY_AS_ONE_GLASTRIER, 266
.equ ABILITY_AS_ONE_SPECTRIER, 267

// gen 9
.equ ABILITY_LINGERING_AROMA, 268
.equ ABILITY_SEED_SOWER, 269
.equ ABILITY_THERMAL_EXCHANGE, 270
.equ ABILITY_ANGER_SHELL, 271
.equ ABILITY_PURIFYING_SALT, 272
.equ ABILITY_WELL_BAKED_BODY, 273
.equ ABILITY_WIND_RIDER, 274
.equ ABILITY_GUARD_DOG, 275
.equ ABILITY_ROCKY_PAYLOAD, 276
.equ ABILITY_WIND_POWER, 277
.equ ABILITY_ZERO_TO_HERO, 278
.equ ABILITY_COMMANDER, 279
.equ ABILITY_ELECTROMORPHOSIS, 280
.equ ABILITY_PROTOSYNTHESIS, 281
.equ ABILITY_QUARK_DRIVE, 282
.equ ABILITY_GOOD_AS_GOLD, 283
.equ ABILITY_VESSEL_OF_RUIN, 284
.equ ABILITY_SWORD_OF_RUIN, 285
.equ ABILITY_TABLETS_OF_RUIN, 286
.equ ABILITY_BEADS_OF_RUIN, 287
.equ ABILITY_ORICHALCUM_PULSE, 288
.equ ABILITY_HADRON_ENGINE, 289
.equ ABILITY_OPPORTUNIST, 290
.equ ABILITY_CUD_CHEW, 291
.equ ABILITY_SHARPNESS, 292
.equ ABILITY_SUPREME_OVERLORD, 293
.equ ABILITY_COSTAR, 294
.equ ABILITY_TOXIC_DEBRIS, 295
.equ ABILITY_ARMOR_TAIL, 296
.equ ABILITY_EARTH_EATER, 297
.equ ABILITY_MYCELIUM_MIGHT, 298
.equ ABILITY_HOSPITALITY, 299
.equ ABILITY_MINDS_EYE, 300
.equ ABILITY_EMBODY_ASPECT, 301
.equ ABILITY_EMBODY_ASPECT_2, 302
.equ ABILITY_EMBODY_ASPECT_3, 303
.equ ABILITY_EMBODY_ASPECT_4, 304
.equ ABILITY_TOXIC_CHAIN, 305
.equ ABILITY_SUPERSWEET_SYRUP, 306
.equ ABILITY_TERA_SHIFT, 307
.equ ABILITY_TERA_SHELL, 308
.equ ABILITY_TERAFORM_ZERO, 309
.equ ABILITY_POISON_PUPPETEER, 310
