...
OUTPUT_BATTLECONTROLLER_BEFOREMOVE2 = 'build/output_battlecontroller_beforemove2.bin'
OUTPUT_BATTLECONTROLLER_BEFOREMOVE3 = 'build/output_battlecontroller_beforemove3.bin'
OUTPUT_BATTLECONTROLLER_BEFOREMOVE4 = 'build/output_battlecontroller_beforemove4.bin'
OUTPUT_BATTLECONTROLLER_BEFOREMOVE5 = 'build/output_battlecontroller_beforemove5.bin'
OUTPUT_BATTLECONTROLLER_BEFOREMOVE6 = 'build/output_battlecontroller_beforemove6.bin'
...
NEW_OVERLAYS_NO_ARM9_EXT = [OUTPUT_BATTLE, OUTPUT_FIELD, OUTPUT_POKEDEX, OUTPUT_GETMONEVOLUTION, OUTPUT_GETMONEVOLUTION_BATTLE, OUTPUT_MOVEHITDEFENDERABILITYCHECK, OUTPUT_SWITCHINABILITYCHECK, OUTPUT_STATBUFFCHANGE,
                            OUTPUT_CALCBASEDAMAGE, OUTPUT_BATTLEFORMCHANGECHECK, OUTPUT_CHECKDEFENDERITEMEFFECTONHIT, OUTPUT_SERVERFIELDCONDITIONCHECK, OUTPUT_BATTLECONTROLLER_BEFOREMOVE, OUTPUT_BATTLECONTROLLER_BEFOREMOVE2, OUTPUT_BATTLECONTROLLER_BEFOREMOVE3, OUTPUT_BATTLECONTROLLER_BEFOREMOVE4, OUTPUT_BATTLECONTROLLER_BEFOREMOVE5, OUTPUT_BATTLECONTROLLER_BEFOREMOVE6]
