...
OUTPUT_CALCDAMAGEOVERALL = 'build/output_calcdamageoverall.bin'
OUTPUT_CALC_CHAINOTHERMODIFIERS = 'build/output_calc_chainothermodifiers.bin'
...
NEW_OVERLAYS_NO_ARM9_EXT = [OUTPUT_BATTLE, OUTPUT_FIELD, OUTPUT_POKEDEX, OUTPUT_GETMONEVOLUTION, OUTPUT_GETMONEVOLUTION_BATTLE, OUTPUT_MOVEHITDEFENDERABILITYCHECK, OUTPUT_SWITCHINABILITYCHECK, OUTPUT_STATBUFFCHANGE,
                            OUTPUT_CALCBASEDAMAGE, OUTPUT_BATTLEFORMCHANGECHECK, OUTPUT_CHECKDEFENDERITEMEFFECTONHIT, OUTPUT_SERVERFIELDCONDITIONCHECK, OUTPUT_CALCDAMAGEOVERALL, OUTPUT_CALC_CHAINOTHERMODIFIERS]
