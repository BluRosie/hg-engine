...
OUTPUT_BATTLECONTROLLER_TRYMOVE = 'build/output_battlecontroller_trymove.bin'
OUTPUT_BATTLECONTROLLER_TRYMOVE2 = 'build/output_battlecontroller_trymove2.bin'
...
NEW_OVERLAYS_NO_ARM9_EXT = [OUTPUT_BATTLE, OUTPUT_FIELD, OUTPUT_POKEDEX, OUTPUT_GETMONEVOLUTION, OUTPUT_GETMONEVOLUTION_BATTLE, OUTPUT_MOVEHITDEFENDERABILITYCHECK, OUTPUT_SWITCHINABILITYCHECK, OUTPUT_STATBUFFCHANGE,
                            OUTPUT_CALCBASEDAMAGE, OUTPUT_BATTLEFORMCHANGECHECK, OUTPUT_CHECKDEFENDERITEMEFFECTONHIT, OUTPUT_SERVERFIELDCONDITIONCHECK, OUTPUT_BATTLECONTROLLER_BEFOREMOVE, OUTPUT_BATTLECONTROLLER_TRYMOVE, OUTPUT_BATTLECONTROLLER_TRYMOVE2,]
