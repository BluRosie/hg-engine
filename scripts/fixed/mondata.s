...
mondata SPECIES_BULBASAUR, "Bulbasaur"
    ...
    mondexentry SPECIES_BULBASAUR,  "The seed on its back is filled with\nnutrients. The seed grows steadily\nlarger as its body grows." 
...
mondata SPECIES_VENUSAUR, "Venusaur"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_VENUSAUR,  "By spreading the broad petals of its\nflower and catching the sun’s rays, it\nfills its body with power." 
...
mondata SPECIES_CHARMELEON, "Charmeleon"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CHARMELEON,  "It is very hotheaded by nature, so it\nconstantly seeks opponents. It calms\ndown only when it wins." 
...
mondata SPECIES_CHARIZARD, "Charizard"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CHARIZARD,  "If CHARIZARD becomes furious, the flame\nat the tip of its tail flares up in a\nlight blue shade." 
...
mondata SPECIES_SQUIRTLE, "Squirtle"
    ...
    mondexentry SPECIES_SQUIRTLE,  "The shell is soft when it is born. It\nsoon becomes so resilient, prodding\nfingers will bounce off it." 
...
mondata SPECIES_BLASTOISE, "Blastoise"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BLASTOISE,  "It deliberately makes itself heavy so it\ncan withstand the recoil of the water\njets it fires." 
...
mondata SPECIES_METAPOD, "Metapod"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_METAPOD,  "Inside the shell, it is soft and weak as\nit prepares to evolve. It stays\nmotionless in the shell." 
...
mondata SPECIES_WEEDLE, "Weedle"
    ...
    mondexentry SPECIES_WEEDLE,  "Its poison stinger is very powerful. Its\nbright-colored body is intended to warn\noff its enemies." 
...
mondata SPECIES_KAKUNA, "Kakuna"
    ...
    mondexentry SPECIES_KAKUNA,  "Although it is a cocoon, it can move a\nlittle. It can extend its poison barb if\nit is attacked." 
...
mondata SPECIES_BEEDRILL, "Beedrill"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_BEEDRILL,  "It can take down any opponent with its\npowerful poison stingers. It sometimes\nattacks in swarms." 
...
mondata SPECIES_PIDGEY, "Pidgey"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PIDGEY,  "It usually hides in tall grass. Because\nit dislikes fighting, it protects itself\nby kicking up sand." 
...
mondata SPECIES_PIDGEOT, "Pidgeot"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PIDGEOT,  "Its well-developed chest muscles make it\nstrong enough to whip up a gusty\nwindstorm with just a few flaps." 
...
mondata SPECIES_RATICATE, "Raticate"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_RATICATE,  "Gnaws on anything with its tough fangs.\nIt can even topple concrete buildings by\ngnawing on them." 
...
mondata SPECIES_FEAROW, "Fearow"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_FEAROW,  "It shoots itself suddenly high into the\nsky, then plummets down in one fell\nswoop to strike its prey." 
...
mondata SPECIES_EKANS, "Ekans"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_EKANS,  "It can freely detach its jaw to swallow\nlarge prey whole. It can become too\nheavy to move, however." 
...
mondata SPECIES_ARBOK, "Arbok"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_ARBOK,  "Transfixing prey with the face-like\npattern on its belly, it binds and\npoisons the frightened victim." 
...
mondata SPECIES_PIKACHU, "Pikachu"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_PIKACHU,  "This intelligent Pokémon roasts hard\nberries with electricity to make them\ntender enough to eat." 
...
mondata SPECIES_RAICHU, "Raichu"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_RAICHU,  "When its electricity builds, its muscles\nare stimulated, and it becomes more\naggressive than usual." 
...
mondata SPECIES_SANDSLASH, "Sandslash"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_SANDSLASH,  "In an attempt to hide itself, it will\nrun around at top speed to kick up a\nblinding dust storm." 
...
mondata SPECIES_NIDORAN_F, "Nidoran♀"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_NIDORAN_F,  "The poison hidden in its small horn is\nextremely potent. Even a tiny scratch\ncan have fatal results." 
...
mondata SPECIES_NIDORINA, "Nidorina"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_NIDORINA,  "When feeding its young, it first chews\nthe food into a paste, then spits it out\nfor the offspring." 
...
mondata SPECIES_NIDORAN_M, "Nidoran♂"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_NIDORAN_M,  "It is small, but its horn is filled with\npoison. It charges then stabs with the\nhorn to inject poison." 
...
mondata SPECIES_CLEFAIRY, "Clefairy"
    ...
    mondexentry SPECIES_CLEFAIRY,  "The moonlight that it stores in the\nwings on its back apparently gives it\nthe ability to float in midair." 
...
mondata SPECIES_CLEFABLE, "Clefable"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_CLEFABLE,  "With its acute hearing, it can pick up\nsounds from far away. It usually hides\nin quiet places." 
...
mondata SPECIES_VULPIX, "Vulpix"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_VULPIX,  "As it develops, its single white tail\ngains color and splits into six. It is\nquite warm and cuddly." 
...
mondata SPECIES_NINETALES, "Ninetales"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_NINETALES,  "Some legends claim that each of its nine\ntails has its own unique type of special\nmystical power." 
...
mondata SPECIES_JIGGLYPUFF, "Jigglypuff"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_JIGGLYPUFF,  "If it inflates to sing a lullaby, it can\nperform longer and cause sure drowsiness\nin its audience." 
...
mondata SPECIES_WIGGLYTUFF, "Wigglytuff"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_WIGGLYTUFF,  "Their fur feels so good that if two of\nthem snuggle together, they won’t want\nto be separated." 
...
mondata SPECIES_ODDISH, "Oddish"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ODDISH,  "Awakened by moonlight, it roams actively\nat night. In the day, it stays quietly\nunderground." 
...
mondata SPECIES_VILEPLUME, "Vileplume"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_VILEPLUME,  "It has the world’s largest petals. With\nevery step, the petals shake out heavy\nclouds of toxic pollen." 
...
mondata SPECIES_PARAS, "Paras"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_PARAS,  "It is doused with mushroom spores when\nit is born. As its body grows, mushrooms\nsprout from its back." 
...
mondata SPECIES_PARASECT, "Parasect"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_PARASECT,  "It stays mostly in dark, damp places,\nthe preference not of the bug, but of\nthe big mushroom on its back." 
...
mondata SPECIES_VENONAT, "Venonat"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_VENONAT,  "Its eyes also function as radar units.\nIt catches and eats small bugs that hide\nin darkness." 
...
mondata SPECIES_DUGTRIO, "Dugtrio"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DUGTRIO,  "Its three heads bob separately up and\ndown to loosen the soil nearby, making\nit easier for it to burrow." 
...
mondata SPECIES_MEOWTH, "Meowth"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MEOWTH,  "It is fascinated by round objects. It\ncan’t stop playing with them until it\ntires and falls asleep." 
...
mondata SPECIES_GOLDUCK, "Golduck"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_GOLDUCK,  "When it swims at full speed using its\nlong, webbed limbs, its forehead somehow\nbegins to glow." 
...
mondata SPECIES_MANKEY, "Mankey"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MANKEY,  "It is extremely ill-tempered. Groups of\nthem will attack any handy target for no\nreason." 
...
mondata SPECIES_PRIMEAPE, "Primeape"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PRIMEAPE,  "If approached while asleep, it may\nawaken and angrily give chase in a\ngroggy state of semi-sleep." 
...
mondata SPECIES_GROWLITHE, "Growlithe"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_GROWLITHE,  "It has a brave and trustworthy nature.\nIt fearlessly stands up to bigger and\nstronger foes." 
...
mondata SPECIES_POLIWAG, "Poliwag"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_POLIWAG,  "Because it is inept at walking on its\nnewly grown legs, it always swims around\nin water." 
...
mondata SPECIES_POLIWRATH, "Poliwrath"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_POLIWRATH,  "This strong and skilled swimmer is even\ncapable of crossing the Pacific Ocean\njust by kicking." 
...
mondata SPECIES_KADABRA, "Kadabra"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_KADABRA,  "It possesses strong spiritual power. The\nmore danger it faces, the stronger its\npsychic power." 
...
mondata SPECIES_ALAKAZAM, "Alakazam"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ALAKAZAM,  "Closing both its eyes heightens all its\nother senses. This enables it to use its\nabilities to their extremes." 
...
mondata SPECIES_MACHOP, "Machop"
    ...
    mondexentry SPECIES_MACHOP,  "Always brimming with power, it passes\ntime by lifting boulders. Doing so makes\nit even stronger." 
...
mondata SPECIES_MACHOKE, "Machoke"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MACHOKE,  "It always goes at its full power, but\nthis very tough and durable Pokémon\nnever gets tired." 
...
mondata SPECIES_MACHAMP, "Machamp"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MACHAMP,  "It quickly swings its four arms to rock\nits opponents with ceaseless punches and\nchops from all angles." 
...
mondata SPECIES_WEEPINBELL, "Weepinbell"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_WEEPINBELL,  "Even though it is filled with acid, it\ndoes not melt because it also oozes a\nprotective fluid." 
...
mondata SPECIES_GEODUDE, "Geodude"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_GEODUDE,  "Most people may not notice, but a closer\nlook should reveal that there are many\nGEODUDE around." 
...
mondata SPECIES_GRAVELER, "Graveler"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_GRAVELER,  "With a free and uncaring nature, it\ndoesn’t mind if pieces break off while\nit rolls down mountains." 
...
mondata SPECIES_GOLEM, "Golem"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_GOLEM,  "It sheds its skin once a year. The\ndiscarded shell immediately hardens and\ncrumbles away." 
...
mondata SPECIES_PONYTA, "Ponyta"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_PONYTA,  "It is a weak runner immediately after\nbirth. It gradually becomes faster by\nchasing after its parents." 
...
mondata SPECIES_RAPIDASH, "Rapidash"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_RAPIDASH,  "At full gallop, its four hooves barely\ntouch the ground because it moves so\nincredibly fast." 
...
mondata SPECIES_SLOWPOKE, "Slowpoke"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_SLOWPOKE,  "It lazes vacantly near water. If\nsomething bites its tail, it won’t even\nnotice for a whole day." 
...
mondata SPECIES_MAGNETON, "Magneton"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MAGNETON,  "Three MAGNEMITE are linked by a strong\nmagnetic force. Earaches will occur if\nyou get too close." 
...
mondata SPECIES_DODUO, "Doduo"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DODUO,  "By alternately raising and lowering its\ntwo heads, it balances itself to be more\nstable while running." 
...
mondata SPECIES_DODRIO, "Dodrio"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DODRIO,  "It collects data and plans three times\nas wisely, but it may think too much and\nfall into a state of immobility." 
...
mondata SPECIES_SEEL, "Seel"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SEEL,  "Although it can’t walk well on land, it\nis a graceful swimmer. It especially\nloves being in frigid seas." 
...
mondata SPECIES_DEWGONG, "Dewgong"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_DEWGONG,  "Its streamlined body has little drag in\nwater. The colder the temperature, the\nfriskier it gets." 
...
mondata SPECIES_MUK, "Muk"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_MUK,  "They love to gather in smelly areas\nwhere sludge accumulates, making the\nstench around them worse." 
...
mondata SPECIES_SHELLDER, "Shellder"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SHELLDER,  "It swims facing backward by opening and\nclosing its two-piece shell. It is\nsurprisingly fast." 
...
mondata SPECIES_CLOYSTER, "Cloyster"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_CLOYSTER,  "Once it slams its shell shut, it is\nimpossible to open, even by those with\nsuperior strength." 
...
mondata SPECIES_GENGAR, "Gengar"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GENGAR,  "It steals heat from its surroundings. If\nyou feel a sudden chill, it is certain\nthat a GENGAR appeared." 
...
mondata SPECIES_ONIX, "Onix"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ONIX,  "It twists and squirms through the\nground. The thunderous roar of its\ntunneling echoes a long way." 
...
mondata SPECIES_HYPNO, "Hypno"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_HYPNO,  "When it is very hungry, it puts humans\nit meets to sleep, then it feasts on\ntheir dreams." 
...
mondata SPECIES_VOLTORB, "Voltorb"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_VOLTORB,  "It rolls to move. If the ground is\nuneven, a sudden jolt from hitting a\nbump can cause it to explode." 
...
mondata SPECIES_CUBONE, "Cubone"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_CUBONE,  "If it is sad or lonely, the skull it\nwears shakes and emits a plaintive and\nmournful sound." 
...
mondata SPECIES_MAROWAK, "Marowak"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MAROWAK,  "It has been seen pounding boulders with\nthe bone it carries in order to tap out\nmessages to others." 
...
mondata SPECIES_HITMONCHAN, "Hitmonchan"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_HITMONCHAN,  "Its punches slice the air. However, it\nseems to need a short break after\nfighting for three minutes." 
...
mondata SPECIES_LICKITUNG, "Lickitung"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_LICKITUNG,  "Its tongue has well-developed nerves\nthat run to the very tip, so it can be\ndeftly manipulated." 
...
mondata SPECIES_KOFFING, "Koffing"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_KOFFING,  "Its thin, filmy body is filled with\ngases that cause constant sniffles,\ncoughs and teary eyes." 
...
mondata SPECIES_WEEZING, "Weezing"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_WEEZING,  "If one of the twin KOFFING inflates, the\nother one deflates. It constantly mixes\nits poisonous gases." 
...
mondata SPECIES_RHYHORN, "Rhyhorn"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_RHYHORN,  "It is inept at turning because of its\nfour short legs. It can only charge and\nrun in one direction." 
...
mondata SPECIES_RHYDON, "Rhydon"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_RHYDON,  "Its rugged hide protects it from even\nthe heat of lava. However, the hide also\nmakes it insensitive." 
...
mondata SPECIES_CHANSEY, "Chansey"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_CHANSEY,  "It walks carefully to prevent its egg\nfrom breaking. However, it is extremely\nfast at running away." 
...
mondata SPECIES_TANGELA, "Tangela"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_TANGELA,  "The vines that cloak its entire body are\nalways jiggling. They effectively\nunnerve its foes." 
...
mondata SPECIES_KANGASKHAN, "Kangaskhan"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_KANGASKHAN,  "If it is safe, the young gets out of the\nbelly pouch to play. The adult keeps a\nclose eye on the youngster." 
...
mondata SPECIES_SEADRA, "Seadra"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SEADRA,  "An examination of its cells revealed the\npresence of a gene not found in HORSEA.\nIt became a hot topic." 
...
mondata SPECIES_GOLDEEN, "Goldeen"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_GOLDEEN,  "Its dorsal, pectoral and tail fins wave\nelegantly in water. That is why it is\nknown as the water dancer." 
...
mondata SPECIES_SEAKING, "Seaking"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SEAKING,  "During spawning season, SEAKING gather\nfrom all over, causing rivers to appear\na brilliant red." 
...
mondata SPECIES_STARYU, "Staryu"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_STARYU,  "At night, the middle of its body slowly\nflickers with the same rhythm as a human\nheartbeat." 
...
mondata SPECIES_STARMIE, "Starmie"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_STARMIE,  "The middle section of its body is called\nthe core. It glows in a different color\neach time it is seen." 
...
mondata SPECIES_MR_MIME, "Mr. Mime"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MR_MIME,  "A skilled mime from birth, it gains the\nability to create invisible objects as\nit matures." 
...
mondata SPECIES_SCYTHER, "Scyther"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SCYTHER,  "It slashes through grass with its sharp\nscythes, moving too fast for the human\neye to track." 
...
mondata SPECIES_JYNX, "Jynx"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_JYNX,  "It rocks its body rhythmically. It\nappears to alter the rhythm depending on\nhow it is feeling." 
...
mondata SPECIES_ELECTABUZZ, "Electabuzz"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_ELECTABUZZ,  "Electricity runs across the surface of\nits body. In darkness, its entire body\nglows a whitish-blue." 
...
mondata SPECIES_TAUROS, "Tauros"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_TAUROS,  "They fight each other by locking horns.\nThe herd’s protector takes pride in its\nbattle-scarred horns." 
...
mondata SPECIES_MAGIKARP, "Magikarp"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_MAGIKARP,  "An underpowered, pathetic Pokémon. It\nmay jump high on rare occasions, but\nusually not more than seven feet." 
...
mondata SPECIES_LAPRAS, "Lapras"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_LAPRAS,  "They have gentle hearts. Because they\nrarely fight, many have been caught.\nTheir number has dwindled." 
...
mondata SPECIES_DITTO, "Ditto"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_DITTO,  "It can transform into anything. When it\nsleeps, it changes into a stone to avoid\nbeing attacked." 
...
mondata SPECIES_VAPOREON, "Vaporeon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_VAPOREON,  "When VAPOREON’s fins begin to vibrate,\nit is a sign that rain will come within\na few hours." 
...
mondata SPECIES_OMANYTE, "Omanyte"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_OMANYTE,  "Revived from an ancient fossil, this\nPokémon uses air stored in its shell to\nsink and rise in water." 
...
mondata SPECIES_OMASTAR, "Omastar"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_OMASTAR,  "Apparently, it cracked SHELLDER’s shell\nwith its sharp fangs and sucked out the\ninsides." 
...
mondata SPECIES_KABUTO, "Kabuto"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_KABUTO,  "On rare occasions, some have been found\nas fossils which they became while\nhiding on the ocean floor." 
...
mondata SPECIES_KABUTOPS, "Kabutops"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_KABUTOPS,  "In the water, it tucks in its limbs to\nbecome more compact, then it wiggles its\nshell to swim fast." 
...
mondata SPECIES_AERODACTYL, "Aerodactyl"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_AERODACTYL,  "A vicious Pokémon from the distant past,\nit appears to have flown by spreading\nits wings and gliding." 
...
mondata SPECIES_SNORLAX, "Snorlax"
    ...
    mondexentry SPECIES_SNORLAX,  "What sounds like its cry may actually be\nits snores or the rumblings of its\nhungry belly." 
...
mondata SPECIES_ZAPDOS, "Zapdos"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_ZAPDOS,  "This legendary bird Pokémon causes\nsavage thunderstorms by flapping its\nglittering wings." 
...
mondata SPECIES_MOLTRES, "Moltres"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MOLTRES,  "This legendary Pokémon scatters embers\nwith every flap of its wings. It is a\nthrilling sight to behold." 
...
mondata SPECIES_DRATINI, "Dratini"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_DRATINI,  "It is born large to start with. It\nrepeatedly sheds its skin as it steadily\ngrows longer." 
...
mondata SPECIES_DRAGONAIR, "Dragonair"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_DRAGONAIR,  "They say that if it emits an aura from\nits whole body, the weather will begin\nto change instantly." 
...
mondata SPECIES_MEWTWO, "Mewtwo"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_MEWTWO,  "Because its battle abilities were raised\nto the ultimate level, it thinks only of\ndefeating its foes." 
...
mondata SPECIES_CHIKORITA, "Chikorita"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CHIKORITA,  "A sweet aroma gently wafts from the leaf\non its head. It is docile and loves to\nsoak up sunrays." 
...
mondata SPECIES_BAYLEEF, "Bayleef"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BAYLEEF,  "The scent of spices comes from around\nits neck. Somehow, sniffing it makes you\nwant to fight." 
...
mondata SPECIES_MEGANIUM, "Meganium"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_MEGANIUM,  "The aroma that rises from its petals\ncontains a substance that calms\naggressive feelings." 
...
mondata SPECIES_CYNDAQUIL, "Cyndaquil"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_CYNDAQUIL,  "It is timid, and always curls itself up\nin a ball. If attacked, it flares up its\nback for protection." 
...
mondata SPECIES_QUILAVA, "Quilava"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_QUILAVA,  "Be careful if it turns its back during\nbattle. It means that it will attack\nwith the fire on its back." 
...
mondata SPECIES_TYPHLOSION, "Typhlosion"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_TYPHLOSION,  "If its rage peaks, it becomes so hot\nthat anything that touches it will\ninstantly go up in flames." 
...
mondata SPECIES_TOTODILE, "Totodile"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_TOTODILE,  "Its powerful, well-developed jaws are\ncapable of crushing anything. Even its\nTrainer must be careful." 
...
mondata SPECIES_CROCONAW, "Croconaw"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CROCONAW,  "If it loses a fang, a new one grows back\nin its place. There are always 48 fangs\nlining its mouth." 
...
mondata SPECIES_HOOTHOOT, "Hoothoot"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_HOOTHOOT,  "It always stands on one foot. It changes\nfeet so fast, the movement can rarely be\nseen." 
...
mondata SPECIES_NOCTOWL, "Noctowl"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_NOCTOWL,  "Its eyes are specially adapted. They\nconcentrate even faint light and enable\nit to see in the dark." 
...
mondata SPECIES_LEDYBA, "Ledyba"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_LEDYBA,  "It is very timid. It will be afraid to\nmove if it is alone. But it will be\nactive if it is in a group." 
...
mondata SPECIES_LEDIAN, "Ledian"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_LEDIAN,  "When the stars flicker in the night sky,\nit flutters about, scattering a glowing\npowder." 
...
mondata SPECIES_SPINARAK, "Spinarak"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SPINARAK,  "It lies still in the same pose for days\nin its web, waiting for its unsuspecting\nprey to wander close." 
...
mondata SPECIES_ARIADOS, "Ariados"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_ARIADOS,  "It spins string not only from its rear\nbut also from its mouth. It’s hard to\ntell which end is which." 
...
mondata SPECIES_CROBAT, "Crobat"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_CROBAT,  "It flies so silently through the dark on\nits four wings that it may not be\nnoticed even when nearby." 
...
mondata SPECIES_LANTURN, "Lanturn"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_LANTURN,  "The light it emits is so bright that it\ncan illuminate the sea’s surface from a\ndepth of over three miles." 
...
mondata SPECIES_IGGLYBUFF, "Igglybuff"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_IGGLYBUFF,  "It has a very soft body. If it starts to\nroll, it will bounce all over and be\nimpossible to stop." 
...
mondata SPECIES_TOGEPI, "Togepi"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_TOGEPI,  "The shell seems to be filled with joy.\nIt is said that it will share good luck\nwhen treated kindly." 
...
mondata SPECIES_XATU, "Xatu"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_XATU,  "They say that it stays still and quiet\nbecause it is seeing both the past and\nfuture at the same time." 
...
mondata SPECIES_AMPHAROS, "Ampharos"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_AMPHAROS,  "The tail’s tip shines brightly and can\nbe seen from far away. It acts as a\nbeacon for lost people." 
...
mondata SPECIES_BELLOSSOM, "Bellossom"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BELLOSSOM,  "BELLOSSOM gather at times and seem to\ndance. They say that the dance is a\nritual to summon the sun." 
...
mondata SPECIES_MARILL, "Marill"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_MARILL,  "The tip of its tail, which contains oil\nthat is lighter than water, lets it swim\nwithout drowning." 
...
mondata SPECIES_AZUMARILL, "Azumarill"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_AZUMARILL,  "By keeping still and listening intently,\nit can tell what is in even wild,\nfast-moving rivers." 
...
mondata SPECIES_HOPPIP, "Hoppip"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_HOPPIP,  "To keep from being blown away by the\nwind, they gather in clusters. But they\ndo enjoy gentle breezes." 
...
mondata SPECIES_SKIPLOOM, "Skiploom"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SKIPLOOM,  "The bloom on top of its head opens and\ncloses as the temperature fluctuates up\nand down." 
...
mondata SPECIES_JUMPLUFF, "Jumpluff"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_JUMPLUFF,  "Once it catches the wind, it deftly\ncontrols its cotton-puff spores-- it can\neven float around the world." 
...
mondata SPECIES_AIPOM, "Aipom"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_AIPOM,  "Its tail is so powerful that it can use\nit to grab a tree branch and hold itself\nup in the air." 
...
mondata SPECIES_SUNKERN, "Sunkern"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_SUNKERN,  "It may plummet from the sky. If attacked\nby a SPEAROW, it will violently shake\nits leaves." 
...
mondata SPECIES_SUNFLORA, "Sunflora"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_SUNFLORA,  "It converts sunlight into energy. In the\ndarkness after sunset, it closes its\npetals and becomes still." 
...
mondata SPECIES_YANMA, "Yanma"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_YANMA,  "If it flaps its wings really fast, it\ncan generate shock waves that will\nshatter windows in the area." 
...
mondata SPECIES_WOOPER, "Wooper"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WOOPER,  "This Pokémon lives in cold water. It\nwill leave the water to search for food\nwhen it gets cold outside." 
...
mondata SPECIES_QUAGSIRE, "Quagsire"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_QUAGSIRE,  "This carefree Pokémon has an easy-going\nnature. While swimming, it always bumps\ninto boat hulls." 
...
mondata SPECIES_ESPEON, "Espeon"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_ESPEON,  "It uses the fine hair that covers its\nbody to sense air currents and predict\nits enemy’s actions." 
...
mondata SPECIES_UMBREON, "Umbreon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_UMBREON,  "When agitated, this Pokémon protects\nitself by spraying poisonous sweat from\nits pores." 
...
mondata SPECIES_MURKROW, "Murkrow"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_MURKROW,  "Feared and loathed by many, it is\nbelieved to bring misfortune to all\nthose who see it at night." 
...
mondata SPECIES_UNOWN, "Unown"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_UNOWN,  "Their shapes look like hieroglyphs on\nancient tablets. It is said that the two\nare somehow related." 
...
mondata SPECIES_WOBBUFFET, "Wobbuffet"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WOBBUFFET,  "It hates light and shock. If attacked,\nit inflates its body to build up its\ncounterstrike." 
...
mondata SPECIES_GIRAFARIG, "Girafarig"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_GIRAFARIG,  "Its tail has a small brain of its own.\nBeware! If you get close, it may react\nto your scent by biting." 
...
mondata SPECIES_PINECO, "Pineco"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_PINECO,  "It likes to make its shell thicker by\nadding layers of tree bark. The\nadditional weight doesn’t bother it." 
...
mondata SPECIES_FORRETRESS, "Forretress"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_FORRETRESS,  "Its entire body is shielded by a\nsteel-hard shell. What lurks inside this\nshell is a total mystery." 
...
mondata SPECIES_GLIGAR, "Gligar"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GLIGAR,  "It flies straight at its target’s face,\nthen clamps down on the startled victim\nto inject poison." 
...
mondata SPECIES_STEELIX, "Steelix"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_STEELIX,  "Its body has been compressed deep under\nthe ground. As a result, it is even\nharder than a diamond." 
...
mondata SPECIES_SNUBBULL, "Snubbull"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_SNUBBULL,  "Although it looks frightening, it is\nactually kind and affectionate. It is\nvery popular among women." 
...
mondata SPECIES_GRANBULL, "Granbull"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GRANBULL,  "It is actually timid and easily spooked.\nIf attacked, it flails about to fend off\nits attacker." 
...
mondata SPECIES_SCIZOR, "Scizor"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SCIZOR,  "It swings its eye-patterned pincers up\nto scare its foes. This makes it look\nlike it has three heads." 
...
mondata SPECIES_SHUCKLE, "Shuckle"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_SHUCKLE,  "The berries it stores in its vase-like\nshell decompose and become a gooey\nliquid." 
...
mondata SPECIES_HERACROSS, "Heracross"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_HERACROSS,  "This powerful Pokémon thrusts its prized\nhorn under its enemies’ bellies, then\nlifts and throws them." 
...
mondata SPECIES_URSARING, "Ursaring"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_URSARING,  "Although it is a good climber, it\nprefers to snap trees with its forelegs\nand eat fallen berries." 
...
mondata SPECIES_SLUGMA, "Slugma"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SLUGMA,  "It never sleeps. It has to keep moving\nbecause if it stopped, its magma body\nwould cool and harden." 
...
mondata SPECIES_MAGCARGO, "Magcargo"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_MAGCARGO,  "The shell on its back is just skin that\nhas cooled and hardened. It breaks\neasily with a slight touch." 
...
mondata SPECIES_SWINUB, "Swinub"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SWINUB,  "It rubs its snout on the ground to find\nand dig up food. It sometimes discovers\nhot springs." 
...
mondata SPECIES_PILOSWINE, "Piloswine"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PILOSWINE,  "Because the long hair all over its body\nobscures its sight, it just keeps\ncharging repeatedly." 
...
mondata SPECIES_CORSOLA, "Corsola"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_CORSOLA,  "It continuously sheds and grows. The tip\nof its head is prized as a treasure\nbecause of its beauty." 
...
mondata SPECIES_REMORAID, "Remoraid"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_REMORAID,  "It has superb accuracy. The water it\nshoots out can strike moving prey from\nmore than 300 feet away." 
...
mondata SPECIES_OCTILLERY, "Octillery"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_OCTILLERY,  "It traps foes with the suction cups on\nits tentacles, then smashes them with\nits rock-hard head." 
...
mondata SPECIES_DELIBIRD, "Delibird"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_DELIBIRD,  "It carries food all day long. There are\ntales about lost people who were saved\nby its stored food." 
...
mondata SPECIES_SKARMORY, "Skarmory"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_SKARMORY,  "Its sturdy wings look heavy, but they\nare actually hollow and light, allowing\nit to fly freely in the sky." 
...
mondata SPECIES_HOUNDOOM, "Houndoom"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_HOUNDOOM,  "If you are burned by the flames it\nshoots from its mouth, the pain will\nnever go away." 
...
mondata SPECIES_DONPHAN, "Donphan"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_DONPHAN,  "It has sharp, hard tusks and a rugged\nhide. Its tackle is strong enough to\nknock down a house." 
...
mondata SPECIES_PORYGON2, "Porygon2"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_PORYGON2,  "This upgraded version of PORYGON is\ndesigned for space exploration. It can’t\nfly, however." 
...
mondata SPECIES_STANTLER, "Stantler"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_STANTLER,  "The curved antlers subtly change the\nflow of air to create a strange space\nwhere reality is distorted." 
...
mondata SPECIES_SMEARGLE, "Smeargle"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SMEARGLE,  "A special fluid oozes from the tip of\nits tail. It paints the fluid everywhere\nto mark its territory." 
...
mondata SPECIES_TYROGUE, "Tyrogue"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_TYROGUE,  "It is always bursting with energy. To\nmake itself stronger, it keeps on\nfighting even if it loses." 
...
mondata SPECIES_SMOOCHUM, "Smoochum"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_SMOOCHUM,  "Its lips are the most sensitive part of\nits body. It always uses its lips first\nto examine things." 
...
mondata SPECIES_MAGBY, "Magby"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_MAGBY,  "Each and every time it inhales and\nexhales, hot embers dribble from its\nmouth and nostrils." 
...
mondata SPECIES_RAIKOU, "Raikou"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_RAIKOU,  "The rain clouds it carries let it fire\nthunderbolts at will. They say that it\ndescended with lightning." 
...
mondata SPECIES_ENTEI, "Entei"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ENTEI,  "Volcanoes erupt when it barks. Unable to\ncontain its sheer power, it races\nheadlong around the land." 
...
mondata SPECIES_SUICUNE, "Suicune"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SUICUNE,  "Said to be the embodiment of north\nwinds, it can instantly purify filthy,\nmurky water." 
...
mondata SPECIES_LARVITAR, "Larvitar"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_LARVITAR,  "It feeds on soil. After it has eaten a\nlarge mountain, it falls asleep so it\ncan grow." 
...
mondata SPECIES_PUPITAR, "Pupitar"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_PUPITAR,  "Its shell is as hard as sheet rock, and\nit is also very strong. Its thrashing\ncan topple a mountain." 
...
mondata SPECIES_TYRANITAR, "Tyranitar"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TYRANITAR,  "Its body can’t be harmed by any sort of\nattack, so it is very eager to make\nchallenges against enemies." 
...
mondata SPECIES_CELEBI, "Celebi"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CELEBI,  "This Pokémon wanders across time. Grass\nand trees flourish in the forests in\nwhich it has appeared." 
...
mondata SPECIES_TREECKO, "Treecko"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TREECKO,  "Small hooks on the bottom of its feet\ncatch on walls and ceilings. That is how\nit can hang from above." 
...
mondata SPECIES_GROVYLE, "Grovyle"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GROVYLE,  "It leaps from tree branch to tree branch\nquite swiftly. It shows astounding\nagility." 
...
mondata SPECIES_SCEPTILE, "Sceptile"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SCEPTILE,  "It agilely leaps about the jungle and\nuses the sharp leaves on its arms to\nstrike its prey." 
...
mondata SPECIES_TORCHIC, "Torchic"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_TORCHIC,  "Inside its body is a place where it\nkeeps a small flame. Hug it! It will be\nas warm as a hot-water bottle." 
...
mondata SPECIES_COMBUSKEN, "Combusken"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_COMBUSKEN,  "During a battle, the hot flame in its\nbody increases. Its kicks have\noutstanding destructive power." 
...
mondata SPECIES_BLAZIKEN, "Blaziken"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_BLAZIKEN,  "It can clear a 30-story building in a\nleap. Its fiery punches scorch its foes." 
...
mondata SPECIES_MUDKIP, "Mudkip"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_MUDKIP,  "Its power can crush boulders. It rests\nby covering itself with mud at the\nbottom of a river." 
...
mondata SPECIES_MARSHTOMP, "Marshtomp"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_MARSHTOMP,  "Living on muddy ground that provides\npoor footing has made its legs sturdy." 
...
mondata SPECIES_SWAMPERT, "Swampert"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SWAMPERT,  "Its arms are hard as rock. With one\nswing, it can break a boulder into\npieces." 
...
mondata SPECIES_MIGHTYENA, "Mightyena"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MIGHTYENA,  "It chases down prey in a pack of around\nten. They defeat foes with perfectly\ncoordinated teamwork." 
...
mondata SPECIES_ZIGZAGOON, "Zigzagoon"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ZIGZAGOON,  "It gets interested in everything, which\nis why it zigs and zags. It is good at\nfinding items." 
...
mondata SPECIES_LINOONE, "Linoone"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_LINOONE,  "When running in a straight line, it can\neasily top 60 miles an hour. It has a\ntough time with curved roads." 
...
mondata SPECIES_SILCOON, "Silcoon"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SILCOON,  "Having wrapped silk around the branches\nof a tree, it quiescently awaits\nevolution." 
...
mondata SPECIES_BEAUTIFLY, "Beautifly"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_BEAUTIFLY,  "Vibrantly patterned wings are its\nprominent feature. It sucks sweet flower\nnectar with its long mouth." 
...
mondata SPECIES_DUSTOX, "Dustox"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DUSTOX,  "It scatters its fine dust all over when\nit is attacked. It is a nocturnal\nPokémon." 
...
mondata SPECIES_LOTAD, "Lotad"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_LOTAD,  "Its leaf grew too large for it to live\non land. That is how it began to live\nfloating in the water." 
...
mondata SPECIES_LOMBRE, "Lombre"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_LOMBRE,  "It is nocturnal and becomes active at\nnightfall. It feeds on aquatic mosses\nthat grow in the riverbed." 
...
mondata SPECIES_SEEDOT, "Seedot"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SEEDOT,  "It attaches itself to a tree branch\nusing the top of its head. Strong winds\ncan sometimes make it fall." 
...
mondata SPECIES_NUZLEAF, "Nuzleaf"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_NUZLEAF,  "It lives deep in forests. With the leaf\non its head, it makes a flute whose song\nmakes listeners uneasy." 
...
mondata SPECIES_SHIFTRY, "Shiftry"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SHIFTRY,  "It lives quietly in the deep forest. It\nis said to create chilly winter winds\nwith the fans it holds." 
...
mondata SPECIES_TAILLOW, "Taillow"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_TAILLOW,  "When it gets cold, they migrate, flying\nover 180 miles a day. It hunts for tasty\nprey." 
...
mondata SPECIES_SWELLOW, "Swellow"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SWELLOW,  "It dives at a steep angle as soon as it\nspots its prey. It catches its prey with\nsharp claws." 
...
mondata SPECIES_WINGULL, "Wingull"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_WINGULL,  "It soars on updrafts without flapping\nits wings. It makes a nest on sheer\ncliffs at the sea’s edge." 
...
mondata SPECIES_PELIPPER, "Pelipper"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_PELIPPER,  "It protects its young in its beak. It\nbobs on waves, resting on them on days\nwhen the waters are calm." 
...
mondata SPECIES_RALTS, "Ralts"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_RALTS,  "The horns on its head provide a strong\npower that enables it to sense people’s\nemotions." 
...
mondata SPECIES_KIRLIA, "Kirlia"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_KIRLIA,  "It has a psychic power that enables it\nto distort the space around it and see\ninto the future." 
...
mondata SPECIES_GARDEVOIR, "Gardevoir"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_GARDEVOIR,  "It unleashes psychokinetic energy at\nfull power when protecting a Trainer it\nhas bonded closely with." 
...
mondata SPECIES_SURSKIT, "Surskit"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SURSKIT,  "It secretes a thick, sweet-scented syrup\nfrom the tip of its head. It lives on\nweed-choked ponds." 
...
mondata SPECIES_MASQUERAIN, "Masquerain"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_MASQUERAIN,  "It flaps its four wings to hover and fly\nfreely in any direction-- to and fro and\nsideways." 
...
mondata SPECIES_SHROOMISH, "Shroomish"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SHROOMISH,  "If it senses danger, it scatters spores\nfrom the top of its head to protect\nitself." 
...
mondata SPECIES_BRELOOM, "Breloom"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BRELOOM,  "It scatters poisonous spores and throws\npowerful punches while its foe is\nhampered by inhaled spores." 
...
mondata SPECIES_VIGOROTH, "Vigoroth"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_VIGOROTH,  "Its stress level rises if it cannot keep\nmoving constantly. Too much stress makes\nit feel sick." 
...
mondata SPECIES_SLAKING, "Slaking"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SLAKING,  "The world’s laziest Pokémon. It moves to\nanother spot when there’s no food left\nwithin its reach." 
...
mondata SPECIES_NINJASK, "Ninjask"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_NINJASK,  "Its cry leaves a lasting headache if\nheard for too long. It moves so quickly\nthat it is almost invisible." 
...
mondata SPECIES_SHEDINJA, "Shedinja"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SHEDINJA,  "A strange Pokémon--it flies without\nmoving its wings, has a hollow shell for\na body, and does not breathe." 
...
mondata SPECIES_WHISMUR, "Whismur"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_WHISMUR,  "If it senses danger, it scares the foe\nby crying out with the volume of a\njet-plane engine." 
...
mondata SPECIES_EXPLOUD, "Exploud"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_EXPLOUD,  "Its roar in battle shakes the ground\nlike a tremor--or like an earthquake has\nstruck." 
...
mondata SPECIES_MAKUHITA, "Makuhita"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MAKUHITA,  "It toughens up by slamming into thick\ntrees over and over. It gains a sturdy\nbody and dauntless spirit." 
...
mondata SPECIES_HARIYAMA, "Hariyama"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_HARIYAMA,  "It loves challenging others to tests of\nstrength. It has the power to stop a\ntrain with a slap." 
...
mondata SPECIES_AZURILL, "Azurill"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_AZURILL,  "Its tail is packed full of the nutrients\nit needs to grow." 
...
mondata SPECIES_NOSEPASS, "Nosepass"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_NOSEPASS,  "If two of these meet, they cannot get\ntoo close because their noses repel each\nother." 
...
mondata SPECIES_SABLEYE, "Sableye"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SABLEYE,  "It dwells in the darkness of caves. It\nuses its sharp claws to dig up gems to\nnourish itself." 
...
mondata SPECIES_MAWILE, "Mawile"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_MAWILE,  "It chomps with its gaping mouth. Its\nhuge jaws are actually steel horns that\nhave been transformed." 
...
mondata SPECIES_LAIRON, "Lairon"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_LAIRON,  "It loves iron ore. Groups of them fight\nfor territory by bashing one another\nwith their steel bodies." 
...
mondata SPECIES_AGGRON, "Aggron"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_AGGRON,  "You can tell its age by the length of\nits iron horns. It claims an entire\nmountain as its territory." 
...
mondata SPECIES_MEDICHAM, "Medicham"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_MEDICHAM,  "Through yoga training, it gained the\npsychic power to predict its foe’s next\nmove." 
...
mondata SPECIES_ELECTRIKE, "Electrike"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_ELECTRIKE,  "It stores electricity in its fur. It\ngives off sparks from all over its body\nin seasons when the air is dry." 
...
mondata SPECIES_PLUSLE, "Plusle"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_PLUSLE,  "It absorbs electricity from telephone\npoles. It shorts out its body to create\ncrackling noises." 
...
mondata SPECIES_MINUN, "Minun"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MINUN,  "Exposure to electricity from MINUN and\nPLUSLE promotes blood circulation and\nrelaxes muscles." 
...
mondata SPECIES_ROSELIA, "Roselia"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_ROSELIA,  "ROSELIA that drink nutritionally rich\nspringwater are said to reveal rare\ncoloration when they bloom." 
...
mondata SPECIES_GULPIN, "Gulpin"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GULPIN,  "It has a small heart and brain. Its\nstomach comprises most of its body, with\nenzymes to dissolve anything." 
...
mondata SPECIES_CARVANHA, "Carvanha"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CARVANHA,  "They form packs to attack boats and rip\nout their hulls to sink them. They live\nin rivers in the jungle." 
...
mondata SPECIES_WAILMER, "Wailmer"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WAILMER,  "It bounces playfully like a ball. The\nmore seawater it swallows, the higher it\nbounces." 
...
mondata SPECIES_NUMEL, "Numel"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_NUMEL,  "The flaming magma it stores in the hump\non its back is the source of its\ntremendous power." 
...
mondata SPECIES_CAMERUPT, "Camerupt"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CAMERUPT,  "It lives in the crater of a volcano. It\nis well known that the humps on its back\nerupt every 10 years." 
...
mondata SPECIES_TORKOAL, "Torkoal"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_TORKOAL,  "You find abandoned coal mines full of\nthem. They dig tirelessly in search of\ncoal." 
...
mondata SPECIES_SPOINK, "Spoink"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SPOINK,  "It bounces around on its tail to keep\nits heart pumping. It carries a pearl\nfrom CLAMPERL on its head." 
...
mondata SPECIES_TRAPINCH, "Trapinch"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_TRAPINCH,  "Its nest is a sloped, bowl-like pit in\nthe desert. Once something has fallen\nin, there is no escape." 
...
mondata SPECIES_FLYGON, "Flygon"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_FLYGON,  "It is nicknamed “The Desert Spirit”\nbecause the flapping of its wings sounds\nlike a woman singing." 
...
mondata SPECIES_CACNEA, "Cacnea"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CACNEA,  "It lives in arid locations. Its yellow\nflowers bloom once a year." 
...
mondata SPECIES_CACTURNE, "Cacturne"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CACTURNE,  "Packs of them follow travelers through\nthe desert until the travelers can no\nlonger move." 
...
mondata SPECIES_SWABLU, "Swablu"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SWABLU,  "Its wings bring cottony clouds to mind.\nIt grooms with springwater and loves to\nsit on heads." 
...
mondata SPECIES_ALTARIA, "Altaria"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ALTARIA,  "It flies gracefully through the sky. Its\nmelodic humming makes you feel like\nyou’re in a dream." 
...
mondata SPECIES_ZANGOOSE, "Zangoose"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_ZANGOOSE,  "Its fur would all stand on end if it\nsmelled a SEVIPER nearby. Its sharp\nclaws tear up its foes." 
...
mondata SPECIES_BARBOACH, "Barboach"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_BARBOACH,  "BARBOACH uses its whiskers to taste\nthings just as a person uses his or her\ntongue to taste things." 
...
mondata SPECIES_WHISCASH, "Whiscash"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WHISCASH,  "It claims a large swamp to itself. If a\nfoe comes near it, it sets off tremors\nby thrashing around." 
...
mondata SPECIES_CORPHISH, "Corphish"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CORPHISH,  "It was originally a Pokémon from afar\nthat escaped to the wild. It can adapt\nto the dirtiest river." 
...
mondata SPECIES_BALTOY, "Baltoy"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BALTOY,  "It moves while spinning around on its\nsingle foot. Some BALTOY have been seen\nspinning on their heads." 
...
mondata SPECIES_LILEEP, "Lileep"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_LILEEP,  "It disguises its tentacles as flowers to\nattract and catch prey. It became\nextinct in ancient times." 
...
mondata SPECIES_CRADILY, "Cradily"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CRADILY,  "It lives in warm seas. Its heavy body\nweighs it down so it won’t get washed\naway in rough weather." 
...
mondata SPECIES_ANORITH, "Anorith"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ANORITH,  "An ancestral Pokémon that lived in the\nocean. Over time, its eight feet\ntransformed into wings." 
...
mondata SPECIES_ARMALDO, "Armaldo"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ARMALDO,  "Its enormous, retractable claws can cut\nthrough most anything. Its entire body\nis clad in sturdy plates." 
...
mondata SPECIES_FEEBAS, "Feebas"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_FEEBAS,  "It is the shabbiest Pokémon of all. It\nforms in schools and lives at the bottom\nof rivers." 
...
mondata SPECIES_MILOTIC, "Milotic"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MILOTIC,  "It’s said that a glimpse of a MILOTIC\nand its beauty will calm any hostile\nemotions you’re feeling." 
...
mondata SPECIES_SHUPPET, "Shuppet"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SHUPPET,  "It uses its horn to feed on envy and\nmalice, or so it’s said. It’s very\nactive at night." 
...
mondata SPECIES_BANETTE, "Banette"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_BANETTE,  "This Pokémon developed from an abandoned\ndoll that amassed a grudge. It is seen\nin dark alleys." 
...
mondata SPECIES_DUSKULL, "Duskull"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_DUSKULL,  "If it finds bad children who won’t\nlisten to their parents, it will spirit\nthem away--or so it’s said." 
...
mondata SPECIES_DUSCLOPS, "Dusclops"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_DUSCLOPS,  "Anyone who dares peer into its body to\nsee its spectral ball of fire will have\ntheir spirit stolen away." 
...
mondata SPECIES_CHIMECHO, "Chimecho"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CHIMECHO,  "It uses the sucker on its head to hang\nfrom a tree or from eaves. It can\nproduce seven different tones." 
...
mondata SPECIES_ABSOL, "Absol"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_ABSOL,  "It has the ability to foretell natural\ndisasters. Its life span is over a\nhundred years." 
...
mondata SPECIES_WYNAUT, "Wynaut"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WYNAUT,  "It tends to move in a pack. Individuals\nsquash against one another to toughen\ntheir spirits." 
...
mondata SPECIES_SNORUNT, "Snorunt"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_SNORUNT,  "It’s said that if they are seen at\nmidnight, they’ll cause heavy snow. They\neat snow and ice to survive." 
...
mondata SPECIES_GLALIE, "Glalie"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_GLALIE,  "It can instantly freeze moisture in the\natmosphere. It uses this power to freeze\nits foes." 
...
mondata SPECIES_SEALEO, "Sealeo"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SEALEO,  "It has a very sensitive nose. It touches\nnew things with its nose to examine\nthem." 
...
mondata SPECIES_WALREIN, "Walrein"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WALREIN,  "It shatters drift ice with its strong\ntusks. Its thick layer of blubber repels\nenemy attacks." 
...
mondata SPECIES_CLAMPERL, "Clamperl"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CLAMPERL,  "When it evolves, it makes a mysterious\npearl that amplifies psychic powers when\nit’s held." 
...
mondata SPECIES_HUNTAIL, "Huntail"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_HUNTAIL,  "It lives deep in the pitch-dark sea. It\nattracts prey by moving its tail in\nmimicry of a small animal." 
...
mondata SPECIES_GOREBYSS, "Gorebyss"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_GOREBYSS,  "Its pink body becomes more vivid with\nthe rise of water temperatures in the\nspringtime." 
...
mondata SPECIES_RELICANTH, "Relicanth"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_RELICANTH,  "Discovered by chance during deep-sea\nexplorations, it has not changed since\nancient times." 
...
mondata SPECIES_LUVDISC, "Luvdisc"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_LUVDISC,  "Its heart-shaped body makes it popular.\nIn some places, you would give a LUVDISC\nto someone you love." 
...
mondata SPECIES_BAGON, "Bagon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BAGON,  "Its well-developed neck muscles and\nironlike head can smash boulders into\npieces." 
...
mondata SPECIES_SHELGON, "Shelgon"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SHELGON,  "It surrounds its body in an iron-hard\nshell to accumulate enough power to\nevolve." 
...
mondata SPECIES_SALAMENCE, "Salamence"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SALAMENCE,  "It’s uncontrollable if enraged. It flies\naround spouting flames and scorching\nfields and mountains." 
...
mondata SPECIES_BELDUM, "Beldum"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BELDUM,  "The magnetic force generated by its body\nrepels the ground’s natural magnetism,\nletting it float." 
...
mondata SPECIES_METAGROSS, "Metagross"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_METAGROSS,  "It folds its four legs when flying. Its\nfour brains are said to be superior to a\nsupercomputer." 
...
mondata SPECIES_REGIROCK, "Regirock"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_REGIROCK,  "The same rocks that form its body have\nbeen found in ground layers around the\nworld." 
...
mondata SPECIES_REGISTEEL, "Registeel"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_REGISTEEL,  "Its body is said to be harder than any\nkind of metal. A study has revealed that\nits body is hollow." 
...
mondata SPECIES_LATIAS, "Latias"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_LATIAS,  "It communicates using telepathy. Its\nbody is covered in down that refracts\nlight to make it invisible." 
...
mondata SPECIES_KYOGRE, "Kyogre"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_KYOGRE,  "A mythical Pokémon said to have swelled\nthe seas with rain and tidal waves. It\nbattled with GROUDON." 
...
mondata SPECIES_RAYQUAZA, "Rayquaza"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_RAYQUAZA,  "It flies in the ozone layer, way up high\nin the sky. Until recently, no one had\never seen it." 
...
mondata SPECIES_JIRACHI, "Jirachi"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_JIRACHI,  "Generations have believed that any wish\nwritten on a note on its head will come\ntrue when it awakens." 
...
mondata SPECIES_TURTWIG, "Turtwig"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TURTWIG,  "Photosynthesis occurs across its body\nunder the sun. The shell on its back is\nactually hardened soil." 
...
mondata SPECIES_GROTLE, "Grotle"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GROTLE,  "A GROTLE that lives in the forest is\nsaid to have its own secret springwater." 
...
mondata SPECIES_TORTERRA, "Torterra"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TORTERRA,  "Ancient people imagined that beneath the\nground, a gigantic TORTERRA dwelled." 
...
mondata SPECIES_CHIMCHAR, "Chimchar"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_CHIMCHAR,  "The gas made in its belly burns from its\nrear end. The fire burns weakly when it\nfeels sick." 
...
mondata SPECIES_MONFERNO, "Monferno"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MONFERNO,  "A bigger fire on its tail and a brighter\nblue pattern on its face means its rank\nin its pack is higher." 
...
mondata SPECIES_EMPOLEON, "Empoleon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_EMPOLEON,  "It avoids unnecessary disputes, but it\nwill decimate anything that threatens\nits pride." 
...
mondata SPECIES_STARLY, "Starly"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_STARLY,  "They flock around mountains and fields,\nchasing after bug Pokémon. Their singing\nis noisy and annoying." 
...
mondata SPECIES_STARAPTOR, "Staraptor"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_STARAPTOR,  "When STARAVIA evolve into STARAPTOR,\nthey leave the flock to live alone. They\nhave sturdy wings." 
...
mondata SPECIES_BIDOOF, "Bidoof"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BIDOOF,  "It lives in groups by the water. It\nchews up boulders and trees around its\nnest with its incisors." 
...
mondata SPECIES_BIBAREL, "Bibarel"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BIBAREL,  "It busily makes its nest with stacks of\nbranches and roots it has cut up with\nits sharp incisors." 
...
mondata SPECIES_KRICKETOT, "Kricketot"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_KRICKETOT,  "When its antennae hit each other, it\nsounds like the music of a xylophone." 
...
mondata SPECIES_KRICKETUNE, "Kricketune"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_KRICKETUNE,  "By allowing its cry to resonate in the\nhollow of its belly, it produces a\ncaptivating sound." 
...
mondata SPECIES_LUXIO, "Luxio"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_LUXIO,  "By gathering their tails together, they\ncollectively generate powerful\nelectricity from their claws." 
...
mondata SPECIES_LUXRAY, "Luxray"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_LUXRAY,  "LUXRAY’s ability to see through objects\ncomes in handy when it’s scouting for\ndanger." 
...
mondata SPECIES_BUDEW, "Budew"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BUDEW,  "When it feels the sun’s warm touch, it\nopens its bud to release pollen. It\nlives alongside clear pools." 
...
mondata SPECIES_ROSERADE, "Roserade"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_ROSERADE,  "Its sweet aroma attracts prey. Then it\nspews poison. The more toxic it is, the\nsweeter its aroma." 
...
mondata SPECIES_BASTIODON, "Bastiodon"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_BASTIODON,  "When attacked, they form a wall. Their\nrock-hard faces serve to protect them\nfrom the attacks." 
...
mondata SPECIES_BURMY, "Burmy"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BURMY,  "It covers itself with a cloak to shelter\nfrom the cold. When it’s hot, its cloak\nis thinner." 
...
mondata SPECIES_WORMADAM, "Wormadam"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_WORMADAM,  "It is said that a WORMADAM that evolves\non a cold day will have a thicker cloak." 
...
mondata SPECIES_MOTHIM, "Mothim"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MOTHIM,  "It flutters around at night and steals\nhoney from the COMBEE hive." 
...
mondata SPECIES_PACHIRISU, "Pachirisu"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_PACHIRISU,  "It’s one of the kinds of Pokémon with\nelectric cheek pouches. It shoots\ncharges from its tail." 
...
mondata SPECIES_BUIZEL, "Buizel"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BUIZEL,  "It inflates its flotation sac, keeping\nits face above water in order to watch\nfor prey movement." 
...
mondata SPECIES_FLOATZEL, "Floatzel"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_FLOATZEL,  "With its flotation sac inflated, it can\ncarry people on its back. It deflates\nthe sac before it dives." 
...
mondata SPECIES_CHERUBI, "Cherubi"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_CHERUBI,  "It evolves by sucking the energy out of\nthe small ball where it had been storing\nnutrients." 
...
mondata SPECIES_CHERRIM, "Cherrim"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_CHERRIM,  "During times of strong sunlight, its bud\nblooms, its petals open fully, and it\nbecomes very active." 
...
mondata SPECIES_SHELLOS, "Shellos"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SHELLOS,  "Its shape and coloration vary, depending\non its habitat." 
...
mondata SPECIES_GASTRODON, "Gastrodon"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GASTRODON,  "When its natural enemy attacks, it oozes\npurple fluid and escapes." 
...
mondata SPECIES_AMBIPOM, "Ambipom"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_AMBIPOM,  "They live on large trees. They are said\nto communicate by connecting their tails\nto those of others." 
...
mondata SPECIES_DRIFBLIM, "Drifblim"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_DRIFBLIM,  "It can generate and release gas within\nits body. That’s how it can control the\naltitude of its drift." 
...
mondata SPECIES_BUNEARY, "Buneary"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BUNEARY,  "You can tell how it feels by the way it\nrolls its ears. When it’s scared, both\nears are rolled up." 
...
mondata SPECIES_LOPUNNY, "Lopunny"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_LOPUNNY,  "It sheds its fur twice a year. Its\nwinter fur is soft and fluffy." 
...
mondata SPECIES_MISMAGIUS, "Mismagius"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_MISMAGIUS,  "Its cries sound like incantations to\ntorment the foe. It appears where you\nleast expect it." 
...
mondata SPECIES_GLAMEOW, "Glameow"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_GLAMEOW,  "When it’s happy, GLAMEOW demonstrates\nbeautiful movements of its tail, like a\ndancing ribbon." 
...
mondata SPECIES_PURUGLY, "Purugly"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_PURUGLY,  "It would claim another Pokémon’s nest as\nits own if it finds a nest sufficiently\ncomfortable." 
...
mondata SPECIES_CHINGLING, "Chingling"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_CHINGLING,  "It emits high-frequency cries that\npeople can’t hear. Once it starts, it\ncan cry for an awfully long time." 
...
mondata SPECIES_SKUNTANK, "Skuntank"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SKUNTANK,  "It attacks by spraying a repugnant fluid\nfrom its tail, but the stench dulls\nafter a few squirts." 
...
mondata SPECIES_BRONZOR, "Bronzor"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BRONZOR,  "Ancient people believed that the pattern\non BRONZOR’s back contained a mysterious\npower." 
...
mondata SPECIES_BRONZONG, "Bronzong"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BRONZONG,  "Ancient people believed that petitioning\nBRONZONG for rain was the way to make\ncrops grow." 
...
mondata SPECIES_SPIRITOMB, "Spiritomb"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SPIRITOMB,  "It was formed by uniting 108 spirits. It\nhas been bound to the Odd Keystone to\nkeep it from doing any mischief." 
...
mondata SPECIES_RIOLU, "Riolu"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_RIOLU,  "They communicate with one another using\ntheir auras. They are able to run all\nthrough the night." 
...
mondata SPECIES_DRAPION, "Drapion"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_DRAPION,  "It attacks people and Pokémon that cross\nthe desert. This has only furthered its\nbad reputation." 
...
mondata SPECIES_LUMINEON, "Lumineon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_LUMINEON,  "LUMINEON swimming in the darkness of the\ndeep sea look like stars shining in the\nnight sky." 
...
mondata SPECIES_LICKILICKY, "Lickilicky"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_LICKILICKY,  "Its saliva can decompose anything. It\nwraps its long tongue around things to\ncoat them with its sticky saliva." 
...
mondata SPECIES_ELECTIVIRE, "Electivire"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_ELECTIVIRE,  "As its electric charge amplifies, blue\nsparks begin to crackle between its\nhorns." 
...
mondata SPECIES_GALLADE, "Gallade"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_GALLADE,  "Because it can sense what its foe is\nthinking, its attacks burst out first,\nfast, and fierce." 
...
mondata SPECIES_FROSLASS, "Froslass"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FROSLASS,  "Legends in snowy regions say that a\nwoman who was lost on an icy mountain\nwas reborn as FROSLASS." 
...
mondata SPECIES_MESPRIT, "Mesprit"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MESPRIT,  "This Pokémon is said to have endowed the\nhuman heart with emotions, such as\nsorrow and joy." 
...
mondata SPECIES_REGIGIGAS, "Regigigas"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_REGIGIGAS,  "It is believed to have shaped REGIROCK,\nREGICE, and REGISTEEL out of clay, ice,\nand magma." 
...
mondata SPECIES_OSHAWOTT, "Oshawott"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_OSHAWOTT,  "This Pokémon from the Unova region uses\nthe shell on its belly as a weapon to\ncut down its foes. Thus, I've conferred\nupon this shell the name ”scalchop”." 
...
mondata SPECIES_DEWOTT, "Dewott"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_DEWOTT,  "Its exquisite double-scalchop technique\nis likely the result of daily training,\nand it can send even masters of the\nblade fleeing in defeat." 
...
mondata SPECIES_SAMUROTT, "Samurott"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SAMUROTT,  "Hard of heart and deft of blade, this\nrare form of Samurott is a product of\nthe Pokémon's evolution in the region of\nHisui. Its turbulent blows crash into\nfoes like ceaseless pounding waves." 
...
mondata SPECIES_LILLIPUP, "Lillipup"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_LILLIPUP,  "This Pokémon is far brighter than the\naverage child, and Lillipup won’t forget\nthe love it receives or any abuse it\nsuffers." 
...
mondata SPECIES_HERDIER, "Herdier"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_HERDIER,  "The black fur that covers this Pokémon’s\nbody is dense and springy. Even sharp\nfangs bounce right off." 
...
mondata SPECIES_STOUTLAND, "Stoutland"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_STOUTLAND,  "Stoutland is immensely proud of its\nimpressive moustache. It’s said that\nmoustache length is what determines\nsocial standing among this species." 
...
mondata SPECIES_PURRLOIN, "Purrloin"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_PURRLOIN,  "Opponents that get drawn in by its\nadorable behavior come away with\nstinging scratches from its claws and\nstinging pride from its laughter." 
...
mondata SPECIES_PANSAGE, "Pansage"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_PANSAGE,  "It’s good at finding berries and gathers\nthem from all over. It’s kind enough to\nshare them with friends." 
...
mondata SPECIES_PANSEAR, "Pansear"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_PANSEAR,  "This Pokémon lives in caves in\nvolcanoes. The fire within the tuft on\nits head can reach 600 degrees\nFahrenheit." 
...
mondata SPECIES_SIMISEAR, "Simisear"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SIMISEAR,  "When it gets excited, embers rise from\nits head and tail and it gets hot. For\nsome reason, it loves sweets." 
...
mondata SPECIES_MUNNA, "Munna"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MUNNA,  "It eats dreams and releases mist. The\nmist is pink when it’s eating a good\ndream, and black when it’s eating a\nnightmare." 
...
mondata SPECIES_MUSHARNA, "Musharna"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MUSHARNA,  "It drowses and dreams all the time. It’s\nbest to leave it be if it’s just woken\nup, as it’s a terrible grump when\nfreshly roused from sleep." 
...
mondata SPECIES_PIDOVE, "Pidove"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_PIDOVE,  "It’s forgetful and not very bright, but\nmany Trainers love it anyway for its\nfriendliness and sincerity." 
...
mondata SPECIES_TRANQUILL, "Tranquill"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_TRANQUILL,  "These bright Pokémon have acute\nmemories. Apparently delivery workers\noften choose them as their partners." 
...
mondata SPECIES_UNFEZANT, "Unfezant"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_UNFEZANT,  "This Pokémon is intelligent and\nintensely proud. People will sit up and\ntake notice if you become the Trainer of\none." 
...
mondata SPECIES_ZEBSTRIKA, "Zebstrika"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_ZEBSTRIKA,  "They have lightning-like movements. When\nZebstrika run at full speed, the sound\nof thunder reverberates." 
...
mondata SPECIES_ROGGENROLA, "Roggenrola"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ROGGENROLA,  "When it detects a noise, it starts to\nmove. The energy core inside it makes\nthis Pokémon slightly warm to the touch." 
...
mondata SPECIES_BOLDORE, "Boldore"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BOLDORE,  "It relies on sound in order to monitor\nwhat’s in its vicinity. When angered, it\nwill attack without ever changing the\ndirection it’s facing." 
...
mondata SPECIES_WOOBAT, "Woobat"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WOOBAT,  "It emits ultrasonic waves as it flutters\nabout, searching for its prey: bug\nPokémon." 
...
mondata SPECIES_DRILBUR, "Drilbur"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_DRILBUR,  "It’s a digger, using its claws to burrow\nthrough the ground. It causes damage to\nvegetable crops, so many farmers have\nlittle love for it." 
...
mondata SPECIES_AUDINO, "Audino"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_AUDINO,  "This Pokémon has a kind heart. By\ntouching with its feelers, Audino can\ngauge other creatures’ feelings and\nphysical conditions." 
...
mondata SPECIES_TIMBURR, "Timburr"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_TIMBURR,  "Timburr that have started carrying logs\nthat are about three times their size\nare nearly ready to evolve." 
...
mondata SPECIES_GURDURR, "Gurdurr"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_GURDURR,  "Gurdurr excels at demolition:\nconstruction is not its forte. In any\ncase, there’s skill in the way this\nPokémon wields its metal beam." 
...
mondata SPECIES_CONKELDURR, "Conkeldurr"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_CONKELDURR,  "When going all out, this Pokémon throws\naside its concrete pillars and leaps at\nopponents to pummel them with its fists." 
...
mondata SPECIES_PALPITOAD, "Palpitoad"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_PALPITOAD,  "On occasion, their cries are sublimely\npleasing to the ear. Palpitoad with\nlarger lumps on their bodies can sing\nwith a wider range of sounds." 
...
mondata SPECIES_THROH, "Throh"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_THROH,  "They train in groups of five. Any member\nthat can’t keep up will discard its belt\nand leave the group." 
...
mondata SPECIES_SAWK, "Sawk"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_SAWK,  "The karate chops of a Sawk that’s\ntrained itself to the limit can cleave\nthe ocean itself." 
...
mondata SPECIES_VENIPEDE, "Venipede"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_VENIPEDE,  "Its fangs are highly venomous. If this\nPokémon finds prey it thinks it can eat,\nit leaps for them without any thought of\nhow things might turn out." 
...
mondata SPECIES_WHIRLIPEDE, "Whirlipede"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_WHIRLIPEDE,  "Whirlipede protects itself with a sturdy\nshell and poisonous spikes while it\nstores up the energy it’ll need for\nevolution." 
...
mondata SPECIES_SCOLIPEDE, "Scolipede"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SCOLIPEDE,  "Scolipede engage in fierce territorial\nbattles with Centiskorch. At the end of\none of these battles, the victor makes a\nmeal of the loser." 
...
mondata SPECIES_COTTONEE, "Cottonee"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_COTTONEE,  "Weaving together the cotton of both\nCottonee and Eldegoss produces exquisite\ncloth that’s highly prized by many\nluxury brands." 
...
mondata SPECIES_WHIMSICOTT, "Whimsicott"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_WHIMSICOTT,  "As long as this Pokémon bathes in\nsunlight, its cotton keeps growing. If\ntoo much cotton fluff builds up,\nWhimsicott tears it off and scatters it." 
...
mondata SPECIES_PETILIL, "Petilil"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_PETILIL,  "The leaves on its head are highly valued\nfor medicinal purposes. Dry the leaves\nin the sun, boil them, and then drink\nthe bitter decoction for remarkably\neffective relief from fatigue." 
...
mondata SPECIES_LILLIGANT, "Lilligant"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_LILLIGANT,  "I suspect that its well-developed legs\nare the result of a life spent on\nmountains covered in deep snow. The\nscent it exudes from its flower crown\nheartens those in proximity." 
...
mondata SPECIES_BASCULIN, "Basculin"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_BASCULIN,  "Though it differs from other Basculin in\nseveral respects, including demeanor:\nthis one is gentle: I have categorized\nit as a regional form given the vast\narray of shared qualities." 
...
mondata SPECIES_KROKOROK, "Krokorok"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_KROKOROK,  "Although this Pokémon has specialized\neyes that allow it to see in the dark,\nKrokorok won’t move much at night: the\ndesert gets cold after sunset." 
...
mondata SPECIES_KROOKODILE, "Krookodile"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_KROOKODILE,  "While terribly aggressive, Krookodile\nalso has the patience to stay hidden\nunder sand for days, lying in wait for\nprey." 
...
mondata SPECIES_DARUMAKA, "Darumaka"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_DARUMAKA,  "This popular symbol of good fortune will\nnever fall over in its sleep, no matter\nhow it’s pushed or pulled." 
...
mondata SPECIES_MARACTUS, "Maractus"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_MARACTUS,  "Once each year, this Pokémon scatters\nits seeds. They’re jam-packed with\nnutrients, making them a precious food\nsource out in the desert." 
...
mondata SPECIES_DWEBBLE, "Dwebble"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_DWEBBLE,  "It first tries to find a rock to live\nin, but if there are no suitable rocks\nto be found, Dwebble may move in to the\nports of a Hippowdon." 
...
mondata SPECIES_CRUSTLE, "Crustle"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CRUSTLE,  "Its thick claws are its greatest\nweapons. They’re mighty enough to crack\nRhyperior’s carapace." 
...
mondata SPECIES_SCRAGGY, "Scraggy"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_SCRAGGY,  "It protects itself with its durable\nskin. It’s thought that this Pokémon\nwill evolve once its skin has completely\nstretched out." 
...
mondata SPECIES_SCRAFTY, "Scrafty"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SCRAFTY,  "While mostly known for having the\ntemperament of an aggressive ruffian,\nthis Pokémon takes very good care of its\nfamily, friends, and territory." 
...
mondata SPECIES_SIGILYPH, "Sigilyph"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SIGILYPH,  "A discovery was made in the desert where\nSigilyph fly. The ruins of what may have\nbeen an ancient city were found beneath\nthe sands." 
...
mondata SPECIES_YAMASK, "Yamask"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_YAMASK,  "The spirit of a person from a bygone age\nbecame this Pokémon. It rambles through\nruins, searching for someone who knows\nits face." 
...
mondata SPECIES_TIRTOUGA, "Tirtouga"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_TIRTOUGA,  "Tirtouga is considered to be the\nancestor of many turtle Pokémon. It was\nrestored to life from a fossil." 
...
mondata SPECIES_CARRACOSTA, "Carracosta"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CARRACOSTA,  "This Pokémon emerges from the water in\nsearch of prey despite the fact that it\nmoves more slowly on land." 
...
mondata SPECIES_ARCHEN, "Archen"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_ARCHEN,  "Archen is said to be the ancestor of\nbird Pokémon. It lived in treetops,\neating berries and bug Pokémon." 
...
mondata SPECIES_TRUBBISH, "Trubbish"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TRUBBISH,  "This Pokémon was born from a bag stuffed\nwith trash. Galarian Weezing relish the\nfumes belched by Trubbish." 
...
mondata SPECIES_GARBODOR, "Garbodor"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GARBODOR,  "The toxic liquid it launches from its\nright arm is so virulent that it can\nkill a weakened creature instantly." 
...
mondata SPECIES_ZORUA, "Zorua"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ZORUA,  "A once-departed soul, returned to life\nin Hisui. Derives power from resentment,\nwhich rises as energy atop its head and\ntakes on the forms of foes. In this way,\nZorua vents lingering malice." 
...
mondata SPECIES_ZOROARK, "Zoroark"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ZOROARK,  "With its disheveled white fur, it looks\nlike an embodiment of death. Heedless of\nits own safety, Zoroark attacks its\nnemeses with a bitter energy so intense,\nit lacerates Zoroark's own body." 
...
mondata SPECIES_MINCCINO, "Minccino"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MINCCINO,  "They pet each other with their tails as\na form of greeting. Of the two, the one\nwhose tail is fluffier is a bit more\nboastful." 
...
mondata SPECIES_CINCCINO, "Cinccino"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_CINCCINO,  "A special oil that seeps through their\nfur helps them avoid attacks. The oil\nfetches a high price at market." 
...
mondata SPECIES_GOTHITA, "Gothita"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GOTHITA,  "Even when nobody seems to be around,\nGothita can still be heard making a\nmuted cry. Many believe it’s speaking to\nsomething only it can see." 
...
mondata SPECIES_GOTHORITA, "Gothorita"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GOTHORITA,  "On nights when the stars shine, this\nPokémon’s psychic power is at its\nstrongest. It’s unknown just what link\nGothorita has to the greater universe." 
...
mondata SPECIES_SOLOSIS, "Solosis"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SOLOSIS,  "Many say that the special liquid\ncovering this Pokémon’s body would allow\nit to survive in the vacuum of space." 
...
mondata SPECIES_DUOSION, "Duosion"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DUOSION,  "Its brain has split into two, and the\ntwo halves rarely think alike. Its\nactions are utterly unpredictable." 
...
mondata SPECIES_REUNICLUS, "Reuniclus"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_REUNICLUS,  "It’s said that drinking the liquid\nsurrounding Reuniclus grants wisdom.\nProblem is, the liquid is highly toxic\nto anything besides Reuniclus itself." 
...
mondata SPECIES_VANILLITE, "Vanillite"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_VANILLITE,  "Supposedly, this Pokémon was born from\nan icicle. It spews out freezing air at\n-58 degrees Fahrenheit to make itself\nmore comfortable." 
...
mondata SPECIES_VANILLISH, "Vanillish"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_VANILLISH,  "It blasts enemies with cold air reaching\n-148 degrees Fahrenheit, freezing them\nsolid. But it spares their lives\nafterward: it’s a kind Pokémon." 
...
mondata SPECIES_VANILLUXE, "Vanilluxe"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_VANILLUXE,  "People believe this Pokémon formed when\ntwo Vanillish stuck together. Its body\ntemperature is roughly 21 degrees\nFahrenheit." 
...
mondata SPECIES_KARRABLAST, "Karrablast"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_KARRABLAST,  "It spits a liquid from its mouth to melt\nthrough Shelmet’s shell. Karrablast\ndoesn’t eat the shell: it eats only the\ncontents." 
...
mondata SPECIES_FOONGUS, "Foongus"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FOONGUS,  "The spores released from this Pokémon’s\nhands are highly poisonous, but when\nthoroughly dried, the spores can be used\nas stomach medicine." 
...
mondata SPECIES_AMOONGUSS, "Amoonguss"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_AMOONGUSS,  "Amoonguss generally doesn’t move much.\nIt tends to stand still near Poké Balls\nthat have been dropped on the ground." 
...
mondata SPECIES_FRILLISH, "Frillish"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FRILLISH,  "Legend has it that the residents of a\nsunken ancient city changed into these\nPokémon." 
...
mondata SPECIES_JELLICENT, "Jellicent"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_JELLICENT,  "Whenever a full moon hangs in the night\nsky, schools of Jellicent gather near\nthe surface of the sea, waiting for\ntheir prey to appear." 
...
mondata SPECIES_ALOMOMOLA, "Alomomola"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_ALOMOMOLA,  "The reason it helps Pokémon in a\nweakened condition is that any Pokémon\ncoming after them may also attack\nAlomomola." 
...
mondata SPECIES_JOLTIK, "Joltik"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_JOLTIK,  "Joltik latch on to other Pokémon and\nsuck out static electricity. They’re\noften found sticking to Yamper’s\nhindquarters." 
...
mondata SPECIES_GALVANTULA, "Galvantula"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_GALVANTULA,  "It lays traps of electrified threads\nnear the nests of bird Pokémon, aiming\nto snare chicks that are not yet good at\nflying." 
...
mondata SPECIES_FERROSEED, "Ferroseed"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_FERROSEED,  "Mossy caves are their preferred\ndwellings. Enzymes contained in mosses\nhelp Ferroseed’s spikes grow big and\nstrong." 
...
mondata SPECIES_FERROTHORN, "Ferrothorn"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_FERROTHORN,  "Its spikes are harder than steel. This\nPokémon crawls across rock walls by\nstabbing the spikes on its feelers into\nthe stone." 
...
mondata SPECIES_KLANG, "Klang"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_KLANG,  "Many companies in the Galar region\nchoose Klang as their logo. This Pokémon\nis considered the symbol of industrial\ntechnology." 
...
mondata SPECIES_EELEKTRIK, "Eelektrik"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_EELEKTRIK,  "These Pokémon have a big appetite. When\nthey spot their prey, they attack it and\nparalyze it with electricity." 
...
mondata SPECIES_BEHEEYEM, "Beheeyem"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BEHEEYEM,  "Sometimes found drifting above wheat\nfields, this Pokémon can control the\nmemories of its opponents." 
...
mondata SPECIES_LITWICK, "Litwick"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_LITWICK,  "The younger the life this Pokémon\nabsorbs, the brighter and eerier the\nflame on its head burns." 
...
mondata SPECIES_LAMPENT, "Lampent"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_LAMPENT,  "It lurks in cities, pretending to be a\nlamp. Once it finds someone whose death\nis near, it will trail quietly after\nthem." 
...
mondata SPECIES_CHANDELURE, "Chandelure"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_CHANDELURE,  "In homes illuminated by Chandelure\ninstead of lights, funerals were a\nconstant occurrence: or so it’s said." 
...
mondata SPECIES_AXEW, "Axew"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_AXEW,  "They play with each other by knocking\ntheir large tusks together. Their tusks\nbreak sometimes, but they grow back so\nquickly that it isn’t a concern." 
...
mondata SPECIES_FRAXURE, "Fraxure"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_FRAXURE,  "Its skin is as hard as a suit of armor.\nFraxure’s favorite strategy is to tackle\nits opponents, stabbing them with its\ntusks at the same time." 
...
mondata SPECIES_HAXORUS, "Haxorus"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_HAXORUS,  "While usually kindhearted, it can be\nterrifying if angered. Tusks that can\nslice through steel beams are how\nHaxorus deals with its adversaries." 
...
mondata SPECIES_CUBCHOO, "Cubchoo"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_CUBCHOO,  "It sniffles before performing a move,\nusing its frosty snot to provide an icy\nelement to any move that needs it." 
...
mondata SPECIES_BEARTIC, "Beartic"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_BEARTIC,  "It swims energetically through frigid\nseas. When it gets tired, it freezes the\nseawater with its breath so it can rest\non the ice." 
...
mondata SPECIES_CRYOGONAL, "Cryogonal"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CRYOGONAL,  "When the weather gets hot, these Pokémon\nturn into water vapor. Cryogonal are\nalmost never seen during summer." 
...
mondata SPECIES_SHELMET, "Shelmet"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SHELMET,  "It has a strange physiology that\nresponds to electricity. When together\nwith Karrablast, Shelmet evolves for\nsome reason." 
...
mondata SPECIES_ACCELGOR, "Accelgor"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_ACCELGOR,  "Discarding its shell made it nimble. To\nkeep itself from dehydrating, it wraps\nits body in bands of membrane." 
...
mondata SPECIES_MIENFOO, "Mienfoo"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MIENFOO,  "Though small, Mienfoo’s temperament is\nfierce. Any creature that approaches\nMienfoo carelessly will be greeted with\na flurry of graceful attacks." 
...
mondata SPECIES_MIENSHAO, "Mienshao"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_MIENSHAO,  "Delivered at blinding speeds, kicks from\nthis Pokémon can shatter massive\nboulders into tiny pieces." 
...
mondata SPECIES_GOLETT, "Golett"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GOLETT,  "This Pokémon was created from clay. It\nreceived orders from its master many\nthousands of years ago, and it still\nfollows those orders to this day." 
...
mondata SPECIES_GOLURK, "Golurk"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GOLURK,  "There’s a theory that inside Golurk is a\nperpetual motion machine that produces\nlimitless energy, but this belief hasn’t\nbeen proven." 
...
mondata SPECIES_PAWNIARD, "Pawniard"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_PAWNIARD,  "A pack of these Pokémon forms to serve a\nBisharp boss. Each Pawniard trains\ndiligently, dreaming of one day taking\nthe lead." 
...
mondata SPECIES_BISHARP, "Bisharp"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_BISHARP,  "Violent conflicts erupt between Bisharp\nand Fraxure over places where sharpening\nstones can be found." 
...
mondata SPECIES_BOUFFALANT, "Bouffalant"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BOUFFALANT,  "These Pokémon live in herds of about 20\nindividuals. Bouffalant that betray the\nherd will lose the hair on their heads\nfor some reason." 
...
mondata SPECIES_RUFFLET, "Rufflet"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_RUFFLET,  "Its chick-like looks belie its\nhotheadedness. It challenges its parents\nat every opportunity, desperate to prove\nits strength." 
...
mondata SPECIES_BRAVIARY, "Braviary"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_BRAVIARY,  "Screaming a bloodcurdling battle cry,\nthis huge and ferocious bird Pokémon\ngoes out on the hunt. It blasts lakes\nwith shock waves, then scoops up any\nprey that float to the water's surface." 
...
mondata SPECIES_VULLABY, "Vullaby"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_VULLABY,  "Vullaby grow quickly. Bones that have\ngotten too small for older Vullaby to\nwear often get passed down to younger\nones in the nest." 
...
mondata SPECIES_MANDIBUZZ, "Mandibuzz"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MANDIBUZZ,  "They adorn themselves with bones. There\nseem to be fashion trends among them, as\ndifferent bones come into and fall out\nof popularity." 
...
mondata SPECIES_DURANT, "Durant"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_DURANT,  "With their large mandibles, these\nPokémon can crunch their way through\nrock. They work together to protect\ntheir eggs from Sandaconda." 
...
mondata SPECIES_DEINO, "Deino"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_DEINO,  "Because it can’t see, this Pokémon is\nconstantly biting at everything it\ntouches, trying to keep track of its\nsurroundings." 
...
mondata SPECIES_ZWEILOUS, "Zweilous"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ZWEILOUS,  "Their two heads will fight each other\nover a single piece of food. Zweilous\nare covered in scars even without\nbattling others." 
...
mondata SPECIES_HYDREIGON, "Hydreigon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_HYDREIGON,  "The three heads take turns sinking their\nteeth into the opponent. Their attacks\nwon’t slow until their target goes down." 
...
mondata SPECIES_LARVESTA, "Larvesta"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_LARVESTA,  "Larvesta’s body is warm all over. It\nspouts fire from the tips of its horns\nto intimidate predators and scare prey." 
...
mondata SPECIES_VOLCARONA, "Volcarona"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_VOLCARONA,  "This Pokémon emerges from a cocoon\nformed of raging flames. Ancient murals\ndepict Volcarona as a deity of fire." 
...
mondata SPECIES_TERRAKION, "Terrakion"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_TERRAKION,  "In Unovan legend, Terrakion battled\nagainst humans in an effort to protect\nother Pokémon." 
...
mondata SPECIES_VIRIZION, "Virizion"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_VIRIZION,  "It darts around opponents with a flurry\nof quick movements, slicing them up with\nits horns." 
...
mondata SPECIES_TORNADUS, "Tornadus"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_TORNADUS,  "This storm-stirring Pokémon is said to\ncause the seasons to turn by whipping up\nthe air. I suspect its humanlike form to\nbe a false one." 
...
mondata SPECIES_THUNDURUS, "Thundurus"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_THUNDURUS,  "They say this wielder of electricity has\nwaged war with its nemesis, Tornadus,\nsince time immemorial. The lightning\nbolts it hurls pierce the very earth and\nenrich the soil." 
...
mondata SPECIES_RESHIRAM, "Reshiram"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_RESHIRAM,  "According to myth, if people ignore\ntruth and let themselves become consumed\nby greed, Reshiram will arrive to burn\ntheir kingdoms down." 
...
mondata SPECIES_ZEKROM, "Zekrom"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_ZEKROM,  "Mythology tells us that if people lose\nthe righteousness in their hearts, their\nkingdoms will be razed by Zekrom’s\nlightning." 
...
mondata SPECIES_LANDORUS, "Landorus"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_LANDORUS,  "When the incarnations of wind and of\nlightning clash, Landorus arrives to\nquell the conflict. After the tempests\nand thunderbolts abate, the land is sure\nto be blessed with bountiful harvests." 
...
mondata SPECIES_KYUREM, "Kyurem"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_KYUREM,  "It appears that this Pokémon uses its\npowers over ice to freeze its own body\nin order to stabilize its cellular\nstructure." 
...
mondata SPECIES_KELDEO, "Keldeo"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_KELDEO,  "They say that Keldeo must survive harsh\nbattles and fully develop the horn on\nits forehead before this Pokémon’s true\npower will awaken." 
...
mondata SPECIES_GENESECT, "Genesect"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GENESECT,  "This Pokémon existed 300 million years\nago. Team Plasma altered it and attached\na cannon to its back." 
...
mondata SPECIES_FENNEKIN, "Fennekin"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_FENNEKIN,  "As it walks, it munches on a twig in\nplace of a snack. It intimidates\nopponents by puffing hot air out of its\nears." 
...
mondata SPECIES_DELPHOX, "Delphox"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_DELPHOX,  "Using psychic power, it generates a\nfiery vortex of 5,400 degrees\nFahrenheit, incinerating foes swept into\nthis whirl of flame." 
...
mondata SPECIES_FROAKIE, "Froakie"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_FROAKIE,  "It protects its skin by covering its\nbody in delicate bubbles. Beneath its\nhappy-go-lucky air, it keeps a watchful\neye on its surroundings." 
...
mondata SPECIES_BUNNELBY, "Bunnelby"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BUNNELBY,  "It’s very sensitive to danger. The sound\nof Corviknight’s flapping will have\nBunnelby digging a hole to hide\nunderground in moments." 
...
mondata SPECIES_DIGGERSBY, "Diggersby"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DIGGERSBY,  "The fur on its belly retains heat\nexceptionally well. People used to make\nheavy winter clothing from fur shed by\nthis Pokémon." 
...
mondata SPECIES_FLETCHLING, "Fletchling"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_FLETCHLING,  "When this Pokémon gets excited, its body\ntemperature increases sharply. If you\ntouch a Fletchling with bare hands, you\nmight get burned." 
...
mondata SPECIES_FLETCHINDER, "Flechinder"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_FLETCHINDER,  "Fletchinder are exceedingly territorial\nand aggressive. These Pokémon fight\namong themselves over feeding grounds." 
...
mondata SPECIES_TALONFLAME, "Talonflame"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_TALONFLAME,  "Talonflame dives toward prey at speeds\nof up to 310 mph and assaults them with\npowerful kicks, giving the prey no\nchance to escape." 
...
mondata SPECIES_SPEWPA, "Spewpa"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SPEWPA,  "The beaks of bird Pokémon can’t begin to\nscratch its stalwart body. To defend\nitself, it spews powder." 
...
mondata SPECIES_PYROAR, "Pyroar"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PYROAR,  "The temperature of its breath is over\n10,000 degrees Fahrenheit, but Pyroar\ndoesn’t use it on its prey. This Pokémon\nprefers to eat raw meat." 
...
mondata SPECIES_FLABEBE, "Flabébé"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FLABEBE,  "Flabébé wears a crown made from pollen\nit’s collected from its flower. The\ncrown has hidden healing properties." 
...
mondata SPECIES_FLOETTE, "Floette"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FLOETTE,  "It gives its own power to flowers,\npouring its heart into caring for them.\nFloette never forgives anyone who messes\nup a flower bed." 
...
mondata SPECIES_FLORGES, "Florges"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FLORGES,  "Its life can span several hundred years.\nIt’s said to devote its entire life to\nprotecting gardens." 
...
mondata SPECIES_PANCHAM, "Pancham"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_PANCHAM,  "Wanting to make sure it’s taken\nseriously, Pancham’s always giving\nothers a glare. But if it’s not\nfocusing, it ends up smiling." 
...
mondata SPECIES_FURFROU, "Furfrou"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FURFROU,  "Left alone, its fur will grow longer and\nlonger, but it will only allow someone\nit trusts to cut it." 
...
mondata SPECIES_ESPURR, "Espurr"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_ESPURR,  "There’s enough psychic power in Espurr\nto send a wrestler flying, but because\nthis power can’t be controlled, Espurr\nfinds it troublesome." 
...
mondata SPECIES_AEGISLASH, "Aegislash"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_AEGISLASH,  "Its potent spectral powers allow it to\nmanipulate others. It once used its\npowers to force people and Pokémon to\nbuild a kingdom to its liking." 
...
mondata SPECIES_SPRITZEE, "Spritzee"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_SPRITZEE,  "The scent its body gives off enraptures\nthose who smell it. Noble ladies had no\nshortage of love for Spritzee." 
...
mondata SPECIES_AROMATISSE, "Aromatisse"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_AROMATISSE,  "The scents Aromatisse can produce range\nfrom sweet smells that bolster allies to\nfoul smells that sap an opponent’s will\nto fight." 
...
mondata SPECIES_SWIRLIX, "Swirlix"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SWIRLIX,  "The sweet smell of cotton candy perfumes\nSwirlix’s fluffy fur. This Pokémon spits\nout sticky string to tangle up its\nenemies." 
...
mondata SPECIES_SLURPUFF, "Slurpuff"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SLURPUFF,  "Slurpuff’s fur contains a lot of air,\nmaking it soft to the touch and lighter\nthan it looks." 
...
mondata SPECIES_BINACLE, "Binacle"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BINACLE,  "If the two don’t work well together,\nboth their offense and defense fall\napart. Without good teamwork, they won’t\nsurvive." 
...
mondata SPECIES_BARBARACLE, "Barbaracle"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BARBARACLE,  "Having an eye on each palm allows it to\nkeep watch in all directions. In a\npinch, its limbs start to act on their\nown to ensure the enemy’s defeat." 
...
mondata SPECIES_SKRELP, "Skrelp"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SKRELP,  "Skrelp looks like a piece of rotten\nseaweed, so it can blend in with seaweed\ndrifting on the ocean and avoid being\ndetected by enemies." 
...
mondata SPECIES_DRAGALGE, "Dragalge"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DRAGALGE,  "Dragalge generates dragon energy by\nsticking the plume on its head out above\nthe ocean’s surface and bathing it in\nsunlight." 
...
mondata SPECIES_CLAUNCHER, "Clauncher"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CLAUNCHER,  "By detonating gas that accumulates in\nits right claw, this Pokémon launches\nwater like a bullet. This is how\nClauncher defeats its enemies." 
...
mondata SPECIES_CLAWITZER, "Clawitzer"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CLAWITZER,  "Clawitzer’s right arm is a cannon that\nlaunches projectiles made of seawater.\nShots from a Clawitzer’s cannon arm can\nsink a tanker." 
...
mondata SPECIES_HELIOPTILE, "Helioptile"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_HELIOPTILE,  "The sun powers this Pokémon’s\nelectricity generation. Interruption of\nthat process stresses Helioptile to the\npoint of weakness." 
...
mondata SPECIES_HELIOLISK, "Heliolisk"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_HELIOLISK,  "One Heliolisk basking in the sun with\nits frill outspread is all it would take\nto produce enough electricity to power a\ncity." 
...
mondata SPECIES_TYRUNT, "Tyrunt"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_TYRUNT,  "This Pokémon is selfish and likes to be\npampered. It can also inflict grievous\nwounds on its Trainer just by playing\naround." 
...
mondata SPECIES_SYLVEON, "Sylveon"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_SYLVEON,  "It emits a soothing aura from its\nribbon-shaped organs. It wraps these\nappendages around quarrelers to\ninstantly restore calm to the situation." 
...
mondata SPECIES_HAWLUCHA, "Hawlucha"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_HAWLUCHA,  "It always strikes a pose before going\nfor its finishing move. Sometimes\nopponents take advantage of that time to\ncounterattack." 
...
mondata SPECIES_DEDENNE, "Dedenne"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_DEDENNE,  "Since Dedenne can’t generate much\nelectricity on its own, it steals\nelectricity from outlets or other\nelectric Pokémon." 
...
mondata SPECIES_CARBINK, "Carbink"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_CARBINK,  "It’s said that somewhere in the world,\nthere’s a mineral vein housing a large\npack of slumbering Carbink. It’s also\nsaid that this pack has a queen." 
...
mondata SPECIES_GOOMY, "Goomy"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GOOMY,  "Goomy hides away in the shade of trees,\nwhere it's nice and humid. If the slime\ncoating its body dries out, the Pokémon\ninstantly becomes lethargic." 
...
mondata SPECIES_SLIGGOO, "Sliggoo"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SLIGGOO,  "A creature given to melancholy. I\nsuspect its metallic shell developed as\na result of the mucus on its skin\nreacting with the iron in Hisui's water." 
...
mondata SPECIES_GOODRA, "Goodra"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_GOODRA,  "Able to freely control the hardness of\nits metallic shell. It loathes solitude\nand is extremely clingy: it will fume\nand run riot if those dearest to it ever\nleave its side." 
...
mondata SPECIES_KLEFKI, "Klefki"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_KLEFKI,  "Klefki sucks in metal ions with the horn\ntopping its head. It seems this Pokémon\nloves keys so much that its head needed\nto look like one, too." 
...
mondata SPECIES_PHANTUMP, "Phantump"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PHANTUMP,  "With a voice like a human child’s, it\ncries out to lure adults deep into the\nforest, getting them lost among the\ntrees." 
...
mondata SPECIES_TREVENANT, "Trevenant"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_TREVENANT,  "Small roots that extend from the tips of\nthis Pokémon’s feet can tie into the\ntrees of the forest and give Trevenant\ncontrol over them." 
...
mondata SPECIES_PUMPKABOO, "Pumpkaboo"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PUMPKABOO,  "The light that streams out from the\nholes in the pumpkin can hypnotize and\ncontrol the people and Pokémon that see\nit." 
...
mondata SPECIES_GOURGEIST, "Gourgeist"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_GOURGEIST,  "In the darkness of a new-moon night,\nGourgeist will come knocking. Whoever\nanswers the door will be swept off to\nthe afterlife." 
...
mondata SPECIES_BERGMITE, "Bergmite"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BERGMITE,  "Lives on mountains blanketed in\nperennial snow. It freezes water vapor\nin the air to make the ice helmet that\nit dons for defense." 
...
mondata SPECIES_AVALUGG, "Avalugg"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_AVALUGG,  "The armor of ice covering its lower jaw\nputs steel to shame and can shatter\nrocks with ease. This Pokémon barrels\nalong steep mountain paths, cleaving\nthrough the deep snow." 
...
mondata SPECIES_NOIBAT, "Noibat"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_NOIBAT,  "No wavelength of sound is beyond\nNoibat’s ability to produce. The\nultrasonic waves it generates can\novercome much larger Pokémon." 
...
mondata SPECIES_NOIVERN, "Noivern"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_NOIVERN,  "Flying through the darkness, it weakens\nenemies with ultrasonic waves that could\ncrush stone. Its fangs finish the fight." 
...
mondata SPECIES_DIANCIE, "Diancie"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_DIANCIE,  "It can instantly create many diamonds by\ncompressing the carbon in the air\nbetween its hands." 
...
mondata SPECIES_HOOPA, "Hoopa"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_HOOPA,  "It is said to be able to seize anything\nit desires with its six rings and six\nhuge arms. With its power sealed, it is\ntransformed into a much smaller form." 
...
mondata SPECIES_ROWLET, "Rowlett"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ROWLET,  "Flies noiselessly on delicate wings. It\nhas mastered the art of deftly launching\ndagger-sharp feathers from those same\nwings." 
...
mondata SPECIES_DARTRIX, "Dartrix"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DARTRIX,  "Regularly basks in sunlight to gather\npower: presumably due to the frigid\nclimate. Nonetheless, the edges of the\nblade quills set into its wings are keen\nas ever." 
...
mondata SPECIES_DECIDUEYE, "Decidueye"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_DECIDUEYE,  "The air stored inside the rachises of\nDecidueye's feathers insulates the\nPokémon against Hisui's extreme cold.\nThis is firm proof that evolution can be\ninfluenced by environment." 
...
mondata SPECIES_LITTEN, "Litten"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_LITTEN,  "Trying to pet Litten before it trusts\nyou will result in a nasty scratch from\nits sharp claws. Be careful." 
...
mondata SPECIES_INCINEROAR, "Incineroar"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_INCINEROAR,  "Incineroar’s rough and aggressive\nbehavior is its most notable trait, but\nthe way it helps out small Pokémon shows\nthat it has a kind side as well." 
...
mondata SPECIES_POPPLIO, "Popplio"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_POPPLIO,  "If Popplio want to create big, powerful\nballoons, they must be persistent. It\ntakes daily practice for these Pokémon\nto develop their skills." 
...
mondata SPECIES_BRIONNE, "Brionne"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BRIONNE,  "On nights when the sea is calm, Brionne\ndance with one another to the singing of\nthe Primarina that’s leading them." 
...
mondata SPECIES_TRUMBEAK, "Trumbeak"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_TRUMBEAK,  "From its mouth, it fires the seeds of\nberries it has eaten. The scattered\nseeds give rise to new plants." 
...
mondata SPECIES_YUNGOOS, "Yungoos"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_YUNGOOS,  "Although it will eat anything, it\nprefers fresh living things, so it\nmarches down streets in search of prey." 
...
mondata SPECIES_GRUBBIN, "Grubbin"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_GRUBBIN,  "It uses its big jaws to dig nests into\nthe forest floor, and it loves to feed\non sweet tree sap." 
...
mondata SPECIES_CHARJABUG, "Charjabug"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CHARJABUG,  "Its digestive processes convert the\nleaves it eats into electricity. An\nelectric sac in its belly stores the\nelectricity for later use." 
...
mondata SPECIES_VIKAVOLT, "Vikavolt"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_VIKAVOLT,  "If it carries a Charjabug to use as a\nspare battery, a flying Vikavolt can\nrapidly fire high-powered beams of\nelectricity." 
...
mondata SPECIES_CRABRAWLER, "Crabrawler"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_CRABRAWLER,  "Crabrawler has been known to mistake\nExeggutor for a coconut tree and climb\nit. The enraged Exeggutor shakes it off\nand stomps it." 
...
mondata SPECIES_CRABOMINABLE, "Crabomnabl"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_CRABOMINABLE,  "Before it stops to think, it just starts\npummeling. There are records of its\nturning back avalanches with a flurry of\npunches." 
...
mondata SPECIES_ORICORIO, "Oricorio"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_ORICORIO,  "This Oricorio has drunk red nectar. If\nits Trainer gives the wrong order, this\npassionate Pokémon becomes fiercely\nangry." 
...
mondata SPECIES_CUTIEFLY, "Cutiefly"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_CUTIEFLY,  "An opponent’s aura can tell Cutiefly\nwhat that opponent’s next move will be.\nThen Cutiefly can glide around the\nattack and strike back." 
...
mondata SPECIES_ROCKRUFF, "Rockruff"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ROCKRUFF,  "This Pokémon intimidates opponents by\nstriking the ground with the rocks on\nits neck. The moment an opponent\nflinches, Rockruff attacks." 
...
mondata SPECIES_LYCANROC, "Lycanroc"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_LYCANROC,  "With swift movements, this Pokémon\ngradually backs its prey into a corner.\nLycanroc’s fangs are always aimed toward\nopponents’ weak spots." 
...
mondata SPECIES_MAREANIE, "Mareanie"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_MAREANIE,  "Unlike their Alolan counterparts, the\nMareanie of the Galar region have not\nyet figured out that the branches of\nCorsola are delicious." 
...
mondata SPECIES_TOXAPEX, "Toxapex"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_TOXAPEX,  "Within the poison sac in its body is a\npoison so toxic that Pokémon as large as\nWailord will still be suffering three\ndays after it first takes effect." 
...
mondata SPECIES_MUDBRAY, "Mudbray"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MUDBRAY,  "It eats dirt to create mud and smears\nthis mud all over its feet, giving them\nthe grip needed to walk on rough terrain\nwithout slipping." 
...
mondata SPECIES_MUDSDALE, "Mudsdale"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MUDSDALE,  "Mudsdale has so much stamina that it\ncould carry over 10 tons across the\nGalar region without rest or sleep." 
...
mondata SPECIES_DEWPIDER, "Dewpider"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DEWPIDER,  "Dewpider normally lives underwater. When\nit comes onto land in search of food, it\ntakes water with it in the form of a\nbubble on its head." 
...
mondata SPECIES_FOMANTIS, "Fomantis"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_FOMANTIS,  "During the day, Fomantis basks in\nsunlight and sleeps peacefully. It wakes\nand moves around at night." 
...
mondata SPECIES_LURANTIS, "Lurantis"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_LURANTIS,  "The petals on this Pokémon’s arms are\nthin and super sharp, and they can fire\nlaser beams if Lurantis gathers light\nfirst." 
...
mondata SPECIES_SHIINOTIC, "Shiinotic"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SHIINOTIC,  "If you see a light deep in a forest at\nnight, don’t go near. Shiinotic will\nmake you fall fast asleep." 
...
mondata SPECIES_SALAZZLE, "Salazzle"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SALAZZLE,  "The winner of competitions between\nSalazzle is decided by which one has the\nmost male Salandit with it." 
...
mondata SPECIES_STUFFUL, "Stufful"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_STUFFUL,  "The way it protects itself by flailing\nits arms may be an adorable sight, but\nstay well away. This is flailing that\ncan snap thick tree trunks." 
...
mondata SPECIES_STEENEE, "Steenee"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_STEENEE,  "Any Corvisquire that pecks at this\nPokémon will be greeted with a smack\nfrom its sepals followed by a sharp\nkick." 
...
mondata SPECIES_TSAREENA, "Tsareena"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_TSAREENA,  "A kick from the hardened tips of this\nPokémon’s legs leaves a wound in the\nopponent’s body and soul that will never\nheal." 
...
mondata SPECIES_COMFEY, "Comfey"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_COMFEY,  "These Pokémon smell very nice. All\nComfey wear different flowers, so each\nof these Pokémon has its own individual\nscent." 
...
mondata SPECIES_ORANGURU, "Oranguru"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_ORANGURU,  "It knows the forest inside and out. If\nit comes across a wounded Pokémon,\nOranguru will gather medicinal herbs to\ntreat it." 
...
mondata SPECIES_PASSIMIAN, "Passimian"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_PASSIMIAN,  "Passimian live in groups of about 20,\nwith each member performing an assigned\nrole. Through cooperation, the group\nsurvives." 
...
mondata SPECIES_GOLISOPOD, "Golisopod"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_GOLISOPOD,  "They live in sunken ships or in holes in\nthe seabed. When Golisopod and Grapploct\nbattle, the loser becomes the winner’s\nmeal." 
...
mondata SPECIES_SANDYGAST, "Sandygast"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SANDYGAST,  "Sandygast mainly inhabits beaches. It\ntakes control of anyone who puts their\nhand into its mouth, forcing them to\nmake its body bigger." 
...
mondata SPECIES_PALOSSAND, "Palossand"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_PALOSSAND,  "This Pokémon lives on beaches, but it\nhates water. Palossand can’t maintain\nits castle-like shape if it gets\ndrenched by a heavy rain." 
...
mondata SPECIES_PYUKUMUKU, "Pyukumuku"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_PYUKUMUKU,  "It lives in warm, shallow waters. If it\nencounters a foe, it will spit out its\ninternal organs as a means to punch\nthem." 
...
mondata SPECIES_MINIOR, "Minior"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_MINIOR,  "Although its outer shell is uncommonly\ndurable, the shock of falling to the\nground smashes the shell to smithereens." 
...
mondata SPECIES_KOMALA, "Komala"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_KOMALA,  "It remains asleep from birth to death as\na result of the sedative properties of\nthe leaves that form its diet." 
...
mondata SPECIES_TURTONATOR, "Turtonator"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_TURTONATOR,  "Eating sulfur in its volcanic habitat is\nwhat causes explosive compounds to\ndevelop in its shell. Its droppings are\nalso dangerously explosive." 
...
mondata SPECIES_TOGEDEMARU, "Togedemaru"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_TOGEDEMARU,  "When it’s in trouble, it curls up into a\nball, makes its fur spikes stand on end,\nand then discharges electricity\nindiscriminately." 
...
mondata SPECIES_BRUXISH, "Bruxish"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_BRUXISH,  "Its skin is thick enough to fend off\nMareanie’s spikes. With its robust\nteeth, Bruxish crunches up the spikes\nand eats them." 
...
mondata SPECIES_JANGMO_O, "Jangmo-o"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_JANGMO_O,  "Jangmo-o strikes its scales to\ncommunicate with others of its kind. Its\nscales are actually fur that’s become as\nhard as metal." 
...
mondata SPECIES_HAKAMO_O, "Hakamo-o"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_HAKAMO_O,  "Before attacking its enemies, it clashes\nits scales together and roars. Its sharp\nclaws shred the opposition." 
...
mondata SPECIES_KOMMO_O, "Kommo-o"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_KOMMO_O,  "Certain ruins have paintings of ancient\nwarriors wearing armor made of Kommo-o\nscales." 
...
mondata SPECIES_TAPU_LELE, "Tapu Lele"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_TAPU_LELE,  "Although called a guardian deity, Tapu\nLele is devoid of guilt about its cruel\ndisposition and can be described as\nnature incarnate." 
...
mondata SPECIES_COSMOG, "Cosmog"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_COSMOG,  "Cosmog is very curious but not very\ncautious, often placing itself in\ndanger. If things start to look dicey,\nit teleports away." 
...
mondata SPECIES_COSMOEM, "Cosmoem"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_COSMOEM,  "It sucks in dust from the air at an\nastounding rate, frantically building up\nenergy within its core as preparation\nfor evolution." 
...
mondata SPECIES_LUNALA, "Lunala"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_LUNALA,  "It steals the light from its\nsurroundings and then becomes the full\nmoon, showering its own light across the\nnight sky." 
...
mondata SPECIES_XURKITREE, "Xurkitree"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_XURKITREE,  "They’ve been dubbed Ultra Beasts. Some\nof them stand unmoving, like trees, with\ntheir arms and legs stuck into the\nground." 
...
mondata SPECIES_CELESTEELA, "Celesteela"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CELESTEELA,  "Although it’s alien to this world and a\ndanger here, it’s apparently a common\norganism in the world where it normally\nlives." 
...
mondata SPECIES_KARTANA, "Kartana"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_KARTANA,  "Although it’s alien to this world and a\ndanger here, it’s apparently a common\norganism in the world where it normally\nlives." 
...
mondata SPECIES_NECROZMA, "Necrozma"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_NECROZMA,  "It needs light to survive, and it goes\non a rampage seeking it out. Its laser\nbeams will cut anything to pieces." 
...
mondata SPECIES_MAGEARNA, "Magearna"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MAGEARNA,  "Built roughly 500 years ago by a\nscientist, the part called the\nSoul-Heart is the actual life-form." 
...
mondata SPECIES_MARSHADOW, "Marshadow"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MARSHADOW,  "This Pokémon can conceal itself in any\nshadow, so it went undiscovered for a\nlong time." 
...
mondata SPECIES_POIPOLE, "Poipole"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_POIPOLE,  "An Ultra Beast that lives in a different\nworld, it cackles wildly as it sprays\nits opponents with poison from the\nneedles on its head." 
...
mondata SPECIES_NAGANADEL, "Naganadel"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_NAGANADEL,  "One kind of Ultra Beast, it fires a\nglowing, venomous liquid from its\nneedles. This liquid is also immensely\nadhesive." 
...
mondata SPECIES_BLACEPHALON, "Blacefalon"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_BLACEPHALON,  "A UB that appeared from an Ultra\nWormhole, it causes explosions, then\ntakes advantage of opponents’ surprise\nto rob them of their vitality." 
...
mondata SPECIES_ZERAORA, "Zeraora"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_ZERAORA,  "Electricity sparks from the pads on its\nlimbs. Wherever Zeraora runs, lightning\nflashes and thunder echoes." 
...
mondata SPECIES_MELTAN, "Meltan"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MELTAN,  "They live as a group, but when the time\ncomes, one strong Meltan will absorb all\nthe others and evolve." 
...
mondata SPECIES_MELMETAL, "Melmetal"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_MELMETAL,  "Centrifugal force is behind the punches\nof Melmetal’s heavy hex-nut arms.\nMelmetal is said to deliver the\nstrongest punches of all Pokémon." 
...
mondata SPECIES_THWACKEY, "Thwackey"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_THWACKEY,  "When it’s drumming out rapid beats in\nbattle, it gets so caught up in the\nrhythm that it won’t even notice that\nit’s already knocked out its opponent." 
...
mondata SPECIES_RILLABOOM, "Rillaboom"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_RILLABOOM,  "The one with the best drumming\ntechniques becomes the boss of the\ntroop. It has a gentle disposition and\nvalues harmony among its group." 
...
mondata SPECIES_SCORBUNNY, "Scorbunny"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_SCORBUNNY,  "It has special pads on the backs of its\nfeet, and one on its nose. Once it’s\nraring to fight, these pads radiate\ntremendous heat." 
...
mondata SPECIES_CINDERACE, "Cinderace"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_CINDERACE,  "It’s skilled at both offense and\ndefense, and it gets pumped up when\ncheered on. But if it starts\nshowboating, it could put itself in a\ntough spot." 
...
mondata SPECIES_INTELEON, "Inteleon"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_INTELEON,  "Its nictitating membranes let it pick\nout foes’ weak points so it can\nprecisely blast them with water that\nshoots from its fingertips at Mach 3." 
...
mondata SPECIES_SKWOVET, "Skwovet"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_SKWOVET,  "It eats berries nonstop: a habit that\nhas made it more resilient than it\nlooks. It’ll show up on farms, searching\nfor yet more berries." 
...
mondata SPECIES_ROOKIDEE, "Rookidee"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ROOKIDEE,  "Jumping nimbly about, this small-bodied\nPokémon takes advantage of even the\nslightest opportunity to disorient\nlarger opponents." 
...
mondata SPECIES_CORVISQUIRE, "Corvisquire"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_CORVISQUIRE,  "The lessons of many harsh battles have\ntaught it how to accurately judge an\nopponent’s strength." 
...
mondata SPECIES_CORVIKNIGHT, "Corviknite"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_CORVIKNIGHT,  "With their great intellect and flying\nskills, these Pokémon very successfully\nact as the Galar region’s airborne taxi\nservice." 
...
mondata SPECIES_BLIPBUG, "Blipbug"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_BLIPBUG,  "Often found in gardens, this Pokémon has\nhairs on its body that it uses to assess\nits surroundings." 
...
mondata SPECIES_DOTTLER, "Dottler"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_DOTTLER,  "As it grows inside its shell, it uses\nits psychic abilities to monitor the\noutside world and prepare for evolution." 
...
mondata SPECIES_ORBEETLE, "Orbeetle"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_ORBEETLE,  "It emits psychic energy to observe and\nstudy what’s around it: and what’s\naround it can include things over six\nmiles away." 
...
mondata SPECIES_GOSSIFLEUR, "Gossifleur"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_GOSSIFLEUR,  "It whirls around in the wind while\nsinging a joyous song. This delightful\ndisplay has charmed many into raising\nthis Pokémon." 
...
mondata SPECIES_ELDEGOSS, "Eldegoss"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_ELDEGOSS,  "The cotton on the head of this Pokémon\ncan be spun into a glossy, gorgeous\nyarn: a Galar regional specialty." 
...
mondata SPECIES_WOOLOO, "Wooloo"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_WOOLOO,  "If its fleece grows too long, Wooloo\nwon’t be able to move. Cloth made with\nthe wool of this Pokémon is surprisingly\nstrong." 
...
mondata SPECIES_CHEWTLE, "Chewtle"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CHEWTLE,  "It starts off battles by attacking with\nits rock-hard horn, but as soon as the\nopponent flinches, this Pokémon bites\ndown and never lets go." 
...
mondata SPECIES_BOLTUND, "Boltund"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_BOLTUND,  "It sends electricity through its legs to\nboost their strength. Running at top\nspeed, it easily breaks 50 mph." 
...
mondata SPECIES_ROLYCOLY, "Rolycoly"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_ROLYCOLY,  "It can race around like a unicycle, even\non rough, rocky terrain. Burning coal\nsustains it." 
...
mondata SPECIES_CARKOL, "Carkol"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_CARKOL,  "By rapidly rolling its legs, it can\ntravel at over 18 mph. The temperature\nof the flames it breathes exceeds 1,800\ndegrees Fahrenheit." 
...
mondata SPECIES_COALOSSAL, "Coalossal"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_COALOSSAL,  "While it’s engaged in battle, its\nmountain of coal will burn bright red,\nsending off sparks that scorch the\nsurrounding area." 
...
mondata SPECIES_APPLIN, "Applin"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_APPLIN,  "As soon as it’s born, it burrows into an\napple. Not only does the apple serve as\nits food source, but the flavor of the\nfruit determines its evolution." 
...
mondata SPECIES_FLAPPLE, "Flapple"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_FLAPPLE,  "It flies on wings of apple skin and\nspits a powerful acid. It can also\nchange its shape into that of an apple." 
...
mondata SPECIES_APPLETUN, "Appletun"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_APPLETUN,  "Its body is covered in sweet nectar, and\nthe skin on its back is especially\nyummy. Children used to have it as a\nsnack." 
...
mondata SPECIES_SANDACONDA, "Sandaconda"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_SANDACONDA,  "Its unique style of coiling allows it to\nblast sand out of its sand sac more\nefficiently." 
...
mondata SPECIES_ARROKUDA, "Arrokuda"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_ARROKUDA,  "After it’s eaten its fill, its movements\nbecome extremely sluggish. That’s when\nCramorant swallows it up." 
...
mondata SPECIES_BARRASKEWDA, "Baraskewda"
    ...
    runchance 0
    colorflip BODY_COLOR_BROWN, 0
    mondexentry SPECIES_BARRASKEWDA,  "It spins its tail fins to propel itself,\nsurging forward at speeds of over 100\nknots before ramming prey and spearing\ninto them." 
...
mondata SPECIES_TOXEL, "Toxel"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_TOXEL,  "It manipulates the chemical makeup of\nits poison to produce electricity. The\nvoltage is weak, but it can cause a\ntingling paralysis." 
...
mondata SPECIES_SIZZLIPEDE, "Sizzlipede"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_SIZZLIPEDE,  "It wraps prey up with its heated body,\ncooking them in its coils. Once they’re\nwell-done, it will voraciously nibble\nthem down to the last morsel." 
...
mondata SPECIES_CENTISKORCH, "Centskorch"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_CENTISKORCH,  "While its burning body is already\ndangerous on its own, this excessively\nhostile Pokémon also has large and very\nsharp fangs." 
...
mondata SPECIES_SINISTEA, "Sinistea"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_SINISTEA,  "The teacup in which this Pokémon makes\nits home is a famous piece of antique\ntableware. Many forgeries are in\ncirculation." 
...
mondata SPECIES_POLTEAGEIST, "Poltegeist"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_POLTEAGEIST,  "Leaving leftover black tea unattended is\nasking for this Pokémon to come along\nand pour itself into it, turning the tea\ninto a new Polteageist." 
...
mondata SPECIES_HATTREM, "Hattrem"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_HATTREM,  "Using the braids on its head, it pummels\nfoes to get them to quiet down. One blow\nfrom those braids would knock out a\nprofessional boxer." 
...
mondata SPECIES_HATTERENE, "Hatterene"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_HATTERENE,  "If you’re too loud around it, you risk\nbeing torn apart by the claws on its\ntentacle. This Pokémon is also known as\nthe Forest Witch." 
...
mondata SPECIES_IMPIDIMP, "Impidimp"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_IMPIDIMP,  "It sneaks into people’s homes, stealing\nthings and feasting on the negative\nenergy of the frustrated occupants." 
...
mondata SPECIES_MORGREM, "Morgrem"
    ...
    runchance 0
    colorflip BODY_COLOR_PINK, 0
    mondexentry SPECIES_MORGREM,  "With sly cunning, it tries to lure\npeople into the woods. Some believe it\nto have the power to make crops grow." 
...
mondata SPECIES_MILCERY, "Milcery"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_MILCERY,  "They say that any patisserie visited by\nMilcery is guaranteed success and good\nfortune." 
...
mondata SPECIES_PINCURCHIN, "Pincurchin"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_PINCURCHIN,  "It stores electricity in each spine.\nEven if one gets broken off, it still\ncontinues to emit electricity for at\nleast three hours." 
...
mondata SPECIES_FROSMOTH, "Frosmoth"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_FROSMOTH,  "It shows no mercy to any who desecrate\nfields and mountains. It will fly around\non its icy wings, causing a blizzard to\nchase offenders away." 
...
mondata SPECIES_STONJOURNER, "Stonjorner"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_STONJOURNER,  "Once a year, on a specific date and at a\nspecific time, they gather out of\nnowhere and form up in a circle." 
...
mondata SPECIES_EISCUE, "Eiscue"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_EISCUE,  "This Pokémon keeps its heat-sensitive\nhead cool with ice. It fishes for its\nfood, dangling its single hair into the\nsea to lure in prey." 
...
mondata SPECIES_INDEEDEE, "Indeedee"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_INDEEDEE,  "Through its horns, it can pick up on the\nemotions of creatures around it.\nPositive emotions are the source of its\nstrength." 
...
mondata SPECIES_MORPEKO, "Morpeko"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_MORPEKO,  "It carries electrically roasted seeds\nwith it as if they’re precious\ntreasures. No matter how much it eats,\nit always gets hungry again in short\norder." 
...
mondata SPECIES_CUFANT, "Cufant"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_CUFANT,  "If a job requires serious strength, this\nPokémon will excel at it. Its copper\nbody tarnishes in the rain, turning a\nvibrant green color." 
...
mondata SPECIES_DRACOZOLT, "Dracozolt"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DRACOZOLT,  "The powerful muscles in its tail\ngenerate its electricity. Compared to\nits lower body, its upper half is\nentirely too small." 
...
mondata SPECIES_ARCTOZOLT, "Arctozolt"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ARCTOZOLT,  "This Pokémon lived on prehistoric\nseashores and was able to preserve food\nwith the ice on its body. It went\nextinct because it moved so slowly." 
...
mondata SPECIES_DRACOVISH, "Dracovish"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DRACOVISH,  "Its mighty legs are capable of running\nat speeds exceeding 40 mph, but this\nPokémon can’t breathe unless it’s\nunderwater." 
...
mondata SPECIES_DURALUDON, "Duraludon"
    ...
    runchance 0
    colorflip BODY_COLOR_WHITE, 0
    mondexentry SPECIES_DURALUDON,  "The special metal that composes its body\nis very light, so this Pokémon has\nconsiderable agility. It lives in caves\nbecause it dislikes the rain." 
...
mondata SPECIES_DREEPY, "Dreepy"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DREEPY,  "If this weak Pokémon is by itself, a\nmere child could defeat it. But if\nDreepy has friends to help it train, it\ncan evolve and become much stronger." 
...
mondata SPECIES_DRAKLOAK, "Drakloak"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_DRAKLOAK,  "Without a Dreepy to place on its head\nand care for, it gets so uneasy it’ll\ntry to substitute any Pokémon it finds\nfor the missing Dreepy." 
...
mondata SPECIES_ZACIAN, "Zacian"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_ZACIAN,  "This Pokémon has slumbered for many\nyears. Some say it’s Zamazenta’s elder\nsister: others say the two Pokémon are\nrivals." 
...
mondata SPECIES_ZAMAZENTA, "Zamazenta"
    ...
    runchance 0
    colorflip BODY_COLOR_RED, 0
    mondexentry SPECIES_ZAMAZENTA,  "This Pokémon slept for aeons while in\nthe form of a statue. It was asleep for\nso long, people forgot that it ever\nexisted." 
...
mondata SPECIES_ETERNATUS, "Eternatus"
    ...
    runchance 0
    colorflip BODY_COLOR_PURPLE, 0
    mondexentry SPECIES_ETERNATUS,  "It was inside a meteorite that fell\n20,000 years ago. There seems to be a\nconnection between this Pokémon and the\nDynamax phenomenon." 
...
mondata SPECIES_KUBFU, "Kubfu"
    ...
    runchance 0
    colorflip BODY_COLOR_GRAY, 0
    mondexentry SPECIES_KUBFU,  "If Kubfu pulls the long white hair on\nits head, its fighting spirit heightens\nand power wells up from the depths of\nits belly." 
...
mondata SPECIES_ZARUDE, "Zarude"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_ZARUDE,  "Once the vines on Zarude’s body tear\noff, they become nutrients in the soil.\nThis helps the plants of the forest\ngrow." 
...
mondata SPECIES_REGIELEKI, "Regieleki"
    ...
    runchance 0
    colorflip BODY_COLOR_YELLOW, 0
    mondexentry SPECIES_REGIELEKI,  "Its entire body is made up of a single\norgan that generates electrical energy.\nRegieleki is capable of creating all\nGalar’s electricity." 
...
mondata SPECIES_SPECTRIER, "Spectrier"
    ...
    runchance 0
    colorflip BODY_COLOR_BLACK, 0
    mondexentry SPECIES_SPECTRIER,  "As it dashes through the night,\nSpectrier absorbs the life-force of\nsleeping creatures. It craves silence\nand solitude." 
...
mondata SPECIES_CALYREX, "Calyrex"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_CALYREX,  "Calyrex is known in legend as a king\nthat ruled over Galar in ancient times.\nIt has the power to cause hearts to mend\nand plants to spring forth." 
...
mondata SPECIES_WALKING_WAKE, "Walk Wake"
    ...
    runchance 0
    colorflip BODY_COLOR_BLUE, 0
    mondexentry SPECIES_WALKING_WAKE,  "This seems to be the Iron Serpent\nmentioned in an old book. The Iron\nSerpent is said to have turned the land\nto ash with its lightning." 
...
mondata SPECIES_IRON_LEAVES, "Iron Leaf"
    ...
    runchance 0
    colorflip BODY_COLOR_GREEN, 0
    mondexentry SPECIES_IRON_LEAVES,  "This seems to be the Iron Serpent\nmentioned in an old book. The Iron\nSerpent is said to have turned the land\nto ash with its lightning." 
