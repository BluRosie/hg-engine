...
python3 tools/narcpy.py extract base/data/a/0/2/7 -o a027
python3 tools/narcpy.py extract base/data/a/0/5/7 -o a057
python3 tools/narcpy.py extract base/data/a/1/3/1 -o a131
