...
# msgenc encodes these itself instead of looking them up in charmap.txt, so they are legal in a text archive despite having no charmap entry
MSGENC_BUILTIN_COMMANDS = {"TRNAME"}
...
def load_charmap(path):
    ...
    valid_commands.update(MSGENC_BUILTIN_COMMANDS)
