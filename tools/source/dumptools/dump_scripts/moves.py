    ...
    for idx, move in enumerate(moves_narc[:-1]):
        ...
        lines.extend(
            [
                ...
                "        },",
                "        .data = {",
                f"            .effect = {MOVE_EFFECTS['MOVE'][move['effect']]},",
                f"            .split = {MOVE_MACROS['SPLIT'][move['category']]},",
                f"            .power = {move['power']},",
                f"            .type = {CONSTANTS['TYPE'][move['type']]},",
                ...
                "        },",
                "        .contest = {",
                f"            .appeal = {MOVE_MACROS['APPEAL'][move['appeal']]},",
                f"            .contestType = {MOVE_MACROS['CONTEST'][move['contest_type']]},",
                "        },",
