...
#define REG_G3X_DISP3DCNT_FIELD(pri, go, ro, fog_shift, fme, fmod, eme, aae, abe, ate, ths, tme) \
    (u16)(                                                                                       \
        ((u32)(pri) << REG_G3X_DISP3DCNT_PRI_SHIFT) | ((u32)(go) << REG_G3X_DISP3DCNT_GO_SHIFT) | ((u32)(ro) << REG_G3X_DISP3DCNT_RO_SHIFT) | ((u32)(fog_shift) << REG_G3X_DISP3DCNT_FOG_SHIFT_SHIFT) | ((u32)(fme) << REG_G3X_DISP3DCNT_FME_SHIFT) | ((u32)(fmod) << REG_G3X_DISP3DCNT_FMOD_SHIFT) | ((u32)(eme) << REG_G3X_DISP3DCNT_EME_SHIFT) | ((u32)(aae) << REG_G3X_DISP3DCNT_AAE_SHIFT) | ((u32)(abe) << REG_G3X_DISP3DCNT_ABE_SHIFT) | ((u32)(ate) << REG_G3X_DISP3DCNT_ATE_SHIFT) | ((u32)(ths) << REG_G3X_DISP3DCNT_THS_SHIFT) | ((u32)(tme) << REG_G3X_DISP3DCNT_TME_SHIFT))
#endif
