...
void *LONG_CALL GfGfxLoader_GetCharData(u32 narcId, s32 memberNo, BOOL isCompressed, void **charData, u32 heapId);
BOOL LONG_CALL SpriteSystem_LoadCharResObjAtEndWithHardwareMappingType(void *spriteSystem, void *spriteManager, int narcId, int fileId, BOOL compressed, int vramType, int resourceId);
