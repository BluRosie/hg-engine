...
#define ITEMPOCKET_ITEMS_GEN_5          ITEMPOCKET_ITEMS
#define ITEMPOCKET_MEDICINE_GEN_5       ITEMPOCKET_MEDICINE
#define ITEMPOCKET_TMHMS_GEN_5          ITEMPOCKET_TMHMS
#define ITEMPOCKET_BERRIES_GEN_5        ITEMPOCKET_BERRIES
#define ITEMPOCKET_KEYITEMS_GEN_5       ITEMPOCKET_KEYITEMS
#define ITEMPOCKET_FREESPACE_GEN_5      ITEMPOCKET_ITEMS

// Gen 6 Pockets

#define ITEMPOCKET_ITEMS_GEN_6          ITEMPOCKET_ITEMS
#define ITEMPOCKET_MEDICINE_GEN_6       ITEMPOCKET_MEDICINE
#define ITEMPOCKET_TMHMS_GEN_6          ITEMPOCKET_TMHMS
#define ITEMPOCKET_BERRIES_GEN_6        ITEMPOCKET_BERRIES
#define ITEMPOCKET_KEYITEMS_GEN_6       ITEMPOCKET_KEYITEMS

// Gen 7 Pockets

#define ITEMPOCKET_ROTOMPOWERS_GEN_7    ITEMPOCKET_MEDICINE
#define ITEMPOCKET_MEDICINE_GEN_7       ITEMPOCKET_MEDICINE
#define ITEMPOCKET_ITEMS_GEN_7          ITEMPOCKET_ITEMS
#define ITEMPOCKET_TMS_GEN_7            ITEMPOCKET_TMHMS
#define ITEMPOCKET_BERRIES_GEN_7        ITEMPOCKET_BERRIES
#define ITEMPOCKET_KEYITEMS_GEN_7       ITEMPOCKET_KEYITEMS
#define ITEMPOCKET_FREESPACE_GEN_7      ITEMPOCKET_ITEMS
#define ITEMPOCKET_ZCRYSTALS_GEN_7      ITEMPOCKET_ITEMS

// Gen 8 Pockets

#define ITEMPOCKET_MEDICINE_GEN_8       ITEMPOCKET_MEDICINE
#define ITEMPOCKET_POKEBALLS_GEN_8      ITEMPOCKET_POKEBALLS
#define ITEMPOCKET_BATTLEITEMS_GEN_8    ITEMPOCKET_ITEMS
#define ITEMPOCKET_BERRIES_GEN_8        ITEMPOCKET_BERRIES
#define ITEMPOCKET_OTHERITEMS_GEN_8     ITEMPOCKET_ITEMS
#define ITEMPOCKET_TMS_GEN_8            ITEMPOCKET_TMHMS
#define ITEMPOCKET_TREASURES_GEN_8      ITEMPOCKET_ITEMS
#define ITEMPOCKET_INGREDIENTS_GEN_8    ITEMPOCKET_ITEMS
#define ITEMPOCKET_KEYITEMS_GEN_8       ITEMPOCKET_KEYITEMS
#define ITEMPOCKET_EVERYDAYITEMS_PLA    ITEMPOCKET_ITEMS
#define ITEMPOCKET_KEYITEMS_PLA         ITEMPOCKET_KEYITEMS

// Gen 9 Pockets

#define ITEMPOCKET_MEDICINE_GEN_9       ITEMPOCKET_MEDICINE
#define ITEMPOCKET_POKEBALLS_GEN_9      ITEMPOCKET_POKEBALLS
#define ITEMPOCKET_BATTLEITEMS_GEN_9    ITEMPOCKET_ITEMS
#define ITEMPOCKET_BERRIES_GEN_9        ITEMPOCKET_BERRIES
#define ITEMPOCKET_OTHERITEMS_GEN_9     ITEMPOCKET_ITEMS
#define ITEMPOCKET_TMS_GEN_9            ITEMPOCKET_TMHMS
#define ITEMPOCKET_TMMATERIALS_GEN_9    ITEMPOCKET_ITEMS
#define ITEMPOCKET_TREASURES_GEN_9      ITEMPOCKET_ITEMS
#define ITEMPOCKET_PICNICITEMS_GEN_9    ITEMPOCKET_ITEMS
#define ITEMPOCKET_KEYITEMS_GEN_9       ITEMPOCKET_KEYITEMS
