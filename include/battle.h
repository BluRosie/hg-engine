...
struct BattlePokemon
{
    ...
    /* 0x64 */ u32 exp; //68                 /**< Total experience points. */
    /* 0x68 */ u32 personal_rnd;             /**< Personality ID. */
    /* 0x6C */ u32 condition;                /**< Current non-volatile status conditions (see STATUS constants). */
    /* 0x70 */ u32 condition2;               /**< (Most) current volatile status conditions (see STATUS2 constants). */
    /* 0x74 */ u32 id_no;                    /**< OT ID. */
    /* 0x78 */ u16 item;                     /**< Current held item. */
    /* 0x7a */ u16 ability;                  /**< Ability index-- moved from 0x27. */
    /* 0x7c */ u8 hit_count;
    /* 0x7d */ u8 message_flag;
    /* 0x7e */ u8 sex : 4;                   /**< Sex for battle purposes (Rivalry, Infatutate, etc.) */
               u8 oyasex : 4;                /**< OT sex. */
    /* 0x7f */ u8 get_ball;                  /**< Ball that the Pokémon was caught in. */
    /* 0x80 */ u32 effect_of_moves;          /**< Move effect trackers (see MOVE_EFFECT constants). */ // moveEffectFlags
