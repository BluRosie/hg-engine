...
BOOL LONG_CALL BattleBuffer_GetNext(struct BattleStruct *sp, int client_no);
void LONG_CALL BattleController_EmitShowMonList(void *bw, struct BattleStruct *sp, int client_no, int force_switch, int selected_mon, int blocked_mon);
void LONG_CALL BattleController_EmitShowWaitMessage(void *bw, int client_no);
void LONG_CALL ov12_0223BDDC(void *bw, int client_no, int selected_mon);
