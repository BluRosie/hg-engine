...
#define MAX_BASE_SUBSCRIPT_NUM 504
...
#define ADD_STATUS_EFF_BOOST_STATS_ATTACK_UP_MAX     (193)
#define ADD_STATUS_EFF_BOOST_STATS_SPEED_UP_6        (194)
#define ADD_STATUS_EFF_ADD_TYPE_GRASS                (195)
#define ADD_STATUS_EFF_ADD_TYPE_GHOST                (196)
#define ADD_STATUS_EFF_CHANGE_TARGET_TO_PSYCHIC_TYPE (197)
#define ADD_STATUS_EFF_AURORA_VEIL                   (198)
#define ADD_STATUS_EFF_STRENGTH_SAP                  (199)
#define ADD_STATUS_EFF_HEAL_PULSE                    (200)
#define ADD_STATUS_EFF_POLLEN_PUFF_HEAL              (201)
#define ADD_STATUS_EFF_COACHING                      (202)
#define ADD_STATUS_EFF_LIFE_DEW                      (203)
#define ADD_STATUS_EFF_ENTRAINMENT                   (204)
#define ADD_STATUS_EFF_HOWL                          (205)
#define ADD_STATUS_EFF_DECORATE                      (206)
#define ADD_STATUS_EFF_PARTING_SHOT                  (207)
#define ADD_STATUS_EFF_CLEAR_SMOG                    (208)
#define ADD_STATUS_EFF_FLAME_BURST_HIT               (209)
#define ADD_STATUS_EFF_ION_DELUGE                    (210)
#define ADD_STATUS_EFF_REMOVE_USER_FIRE_TYPE         (211)
#define ADD_STATUS_EFF_REMOVE_USER_ELECTRIC_TYPE     (212)
#define ADD_STATUS_EFF_STUFF_CHEEKS                  (213)
#define ADD_STATUS_EFF_POWDER                        (214)
#define ADD_STATUS_EFF_LASER_FOCUS                   (215)
