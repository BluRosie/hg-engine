...
#define SUB_SEQ_SAFETY_GOGGLES                        (380)
#define SUB_SEQ_FORCE_SWITCH_FAIL_DYNAMAX             (381)
#define SUB_SEQ_FORCE_SWITCH_FAIL_SUCTION_CUPS        (382)
#define SUB_SEQ_FORCE_SWITCH_FAIL_INGRAIN             (383)
#define SUB_SEQ_CANT_USE_MOVE                         (384)
#define SUB_SEQ_CANT_USE_MOVE_HOOPA_CONFINED          (385)
#define SUB_SEQ_CANT_USE_MOVE_DYNAMAX_TARGET          (386)
#define SUB_SEQ_RESTORE_HP_FULL_FAIL                  (387)
#define SUB_SEQ_STAYED_AWAKE                          (388)
#define SUB_SEQ_ELECTRIC_TERRAIN_PROTECTION           (389)
#define SUB_SEQ_MISTY_TERRAIN_PROTECTION              (390)
#define SUB_SEQ_STATS_NOT_LOWERED                     (391)
#define SUB_SEQ_ATTACK_NOT_LOWERED                    (392)
#define SUB_SEQ_DEFENSE_NOT_LOWERED                   (393)
#define SUB_SEQ_ACCURACY_NOT_LOWERED                  (394)
#define SUB_SEQ_FLOWER_VEIL_FAIL                      (395)
#define SUB_SEQ_SUBSTITUTE_FAIL                       (396)
