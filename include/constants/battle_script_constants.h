...
//#define ?                                       (224) // seems to just update the hp bar if hp recovered is nonzero
//#define ?                                       (225) // null subseq
...
// #define ?                                       (259) // clear status2 0x1000 and set 0x200 server status
