...
#define SUB_SEQ_HEAL_STATUS                           (MAX_BASE_SUBSCRIPT_NUM + 1)
#define SUB_SEQ_UNUSED_1                              (MAX_BASE_SUBSCRIPT_NUM + 2)
#define SUB_SEQ_HEAL_USER_AND_ALLY                    (MAX_BASE_SUBSCRIPT_NUM + 3)
#define SUB_SEQ_ATK_UP_CHARGE_TURN_SOLAR_BLADE        (MAX_BASE_SUBSCRIPT_NUM + 4)
#define SUB_SEQ_SP_ATK_UP_CHARGE_TURN_SOLAR_BEAM      (MAX_BASE_SUBSCRIPT_NUM + 5)
#define SUB_SEQ_POWER_HERB_SOLAR_BLADE                (MAX_BASE_SUBSCRIPT_NUM + 6)
#define SUB_SEQ_ATK_UP_SUN_SKIP                       (MAX_BASE_SUBSCRIPT_NUM + 7)
