...
#define IS_ITEM_ARCEUS_PLATE(item) ((item >= ITEM_FLAME_PLATE && item <= ITEM_IRON_PLATE) || (item == ITEM_EXPANSION_START))
...
#define ITEM_MAX_MEGA_STONES  (ITEM_DIANCITE + 1)

//Item expansion
#define ITEM_EXPANSION_START    (ITEM_MAX_MEGA_STONES)

//Generation V
#define ITEM_PIXIE_PLATE        (ITEM_EXPANSION_START + 0)
#define ITEM_ABSORB_BULB        (ITEM_EXPANSION_START + 1)
#define ITEM_AIR_BALLOON        (ITEM_EXPANSION_START + 2)
#define ITEM_BALM_MUSHROOM      (ITEM_EXPANSION_START + 3)
#define ITEM_BIG_NUGGET         (ITEM_EXPANSION_START + 4)
#define ITEM_BINDING_BAND       (ITEM_EXPANSION_START + 5)
#define ITEM_CASTELIACONE       (ITEM_EXPANSION_START + 6)
#define ITEM_CELL_BATTERY       (ITEM_EXPANSION_START + 7)
#define ITEM_COMET_SHARD        (ITEM_EXPANSION_START + 8)
#define ITEM_DREAM_BALL         (ITEM_EXPANSION_START + 9)
#define ITEM_EJECT_BUTTON       (ITEM_EXPANSION_START + 10)
#define ITEM_EVIOLITE           (ITEM_EXPANSION_START + 11)
#define ITEM_FLOAT_STONE        (ITEM_EXPANSION_START + 12)
#define ITEM_PEARL_STRING       (ITEM_EXPANSION_START + 13)
#define ITEM_PRISM_SCALE        (ITEM_EXPANSION_START + 14)
#define ITEM_RED_CARD           (ITEM_EXPANSION_START + 15)
#define ITEM_RING_TARGET        (ITEM_EXPANSION_START + 16)
#define ITEM_ROCKY_HELMET       (ITEM_EXPANSION_START + 17)
#define ITEM_SWEET_HEART        (ITEM_EXPANSION_START + 18)

//Generation VI
#define ITEM_ABILITY_CAPSULE    (ITEM_EXPANSION_START + 19)
#define ITEM_ASSAULT_VEST       (ITEM_EXPANSION_START + 20)
#define ITEM_LUMINOUS_MOSS      (ITEM_EXPANSION_START + 21)
#define ITEM_LUMIOSE_GALETTE    (ITEM_EXPANSION_START + 22)
#define ITEM_SACHET             (ITEM_EXPANSION_START + 23)
#define ITEM_SAFETY_GOGGLES     (ITEM_EXPANSION_START + 24)
#define ITEM_SHALOUR_SABLE      (ITEM_EXPANSION_START + 25)
#define ITEM_SNOWBALL           (ITEM_EXPANSION_START + 26)
#define ITEM_WEAKNESS_POLICY    (ITEM_EXPANSION_START + 27)
#define ITEM_WHIPPED_DREAM      (ITEM_EXPANSION_START + 28)

//Generation VII
#define ITEM_ADRENALINE_ORB     (ITEM_EXPANSION_START + 29)
#define ITEM_BEAST_BALL         (ITEM_EXPANSION_START + 30)
#define ITEM_BIG_MALASADA       (ITEM_EXPANSION_START + 31)
#define ITEM_BOTTLE_CAP         (ITEM_EXPANSION_START + 32)
#define ITEM_GOLD_BOTTLE_CAP    (ITEM_EXPANSION_START + 33)
#define ITEM_ELECTRIC_SEED      (ITEM_EXPANSION_START + 34)
#define ITEM_GRASSY_SEED        (ITEM_EXPANSION_START + 35)
#define ITEM_MISTY_SEED         (ITEM_EXPANSION_START + 36)
#define ITEM_PSYCHIC_SEED       (ITEM_EXPANSION_START + 37)
#define ITEM_ICE_STONE          (ITEM_EXPANSION_START + 38)
#define ITEM_PROTECTIVE_PADS    (ITEM_EXPANSION_START + 39)
#define ITEM_TERRAIN_EXTENDER   (ITEM_EXPANSION_START + 40)

//Generation VIII
#define ITEM_ABILITY_PATCH      (ITEM_EXPANSION_START + 41)
#define ITEM_BLACK_AUGURITE     (ITEM_EXPANSION_START + 42)
#define ITEM_BERRY_SWEET        (ITEM_EXPANSION_START + 43)
#define ITEM_CLOVER_SWEET       (ITEM_EXPANSION_START + 44)
#define ITEM_FLOWER_SWEET       (ITEM_EXPANSION_START + 45)
#define ITEM_LOVE_SWEET         (ITEM_EXPANSION_START + 46)
#define ITEM_RIBBON_SWEET       (ITEM_EXPANSION_START + 47)
#define ITEM_STAR_SWEET         (ITEM_EXPANSION_START + 48)
#define ITEM_STRAWBERRY_SWEET   (ITEM_EXPANSION_START + 49)
#define ITEM_BLUNDER_POLICY     (ITEM_EXPANSION_START + 50)
#define ITEM_CHIPPED_POT        (ITEM_EXPANSION_START + 51)
#define ITEM_CRACKED_POT        (ITEM_EXPANSION_START + 52)
#define ITEM_EJECT_PACK         (ITEM_EXPANSION_START + 53)
#define ITEM_EXP_CANDY_S        (ITEM_EXPANSION_START + 54)
#define ITEM_EXP_CANDY_M        (ITEM_EXPANSION_START + 55)
#define ITEM_EXP_CANDY_L        (ITEM_EXPANSION_START + 56)
#define ITEM_EXP_CANDY_XS       (ITEM_EXPANSION_START + 57)
#define ITEM_EXP_CANDY_XL       (ITEM_EXPANSION_START + 58)
#define ITEM_GALARICA_CUFF      (ITEM_EXPANSION_START + 59)
#define ITEM_GALARICA_TWIG      (ITEM_EXPANSION_START + 60)
#define ITEM_GALARICA_WREATH    (ITEM_EXPANSION_START + 61)
#define ITEM_HEAVY_DUTY_BOOTS   (ITEM_EXPANSION_START + 62)
#define ITEM_LINKING_CORD       (ITEM_EXPANSION_START + 63)
#define ITEM_MOOMOO_CHEESE      (ITEM_EXPANSION_START + 64)
#define ITEM_PEAT_BLOCK         (ITEM_EXPANSION_START + 65)
#define ITEM_ROOM_SERVICE       (ITEM_EXPANSION_START + 66)
#define ITEM_RUSTED_SHIELD      (ITEM_EXPANSION_START + 67)
#define ITEM_RUSTED_SWORD       (ITEM_EXPANSION_START + 68)
#define ITEM_SWEET_APPLE        (ITEM_EXPANSION_START + 69)
#define ITEM_TART_APPLE         (ITEM_EXPANSION_START + 70)
#define ITEM_THROAT_SPRAY       (ITEM_EXPANSION_START + 71)
#define ITEM_UTILITY_UMBRELLA   (ITEM_EXPANSION_START + 72)

//Generation IX
#define ITEM_ABILITY_SHIELD     (ITEM_EXPANSION_START + 73)
#define ITEM_AUSPICIOUS_ARMOR   (ITEM_EXPANSION_START + 74)
#define ITEM_BOOSTER_ENERGY     (ITEM_EXPANSION_START + 75)
#define ITEM_CLEAR_AMULET       (ITEM_EXPANSION_START + 76)
#define ITEM_COVERT_CLOAK       (ITEM_EXPANSION_START + 77)
#define ITEM_GIMMIGHOUL_COIN    (ITEM_EXPANSION_START + 78)
#define ITEM_LEADERS_CREST      (ITEM_EXPANSION_START + 79)
#define ITEM_LOADED_DICE        (ITEM_EXPANSION_START + 80)
#define ITEM_MALICIOUS_ARMOR    (ITEM_EXPANSION_START + 81)
#define ITEM_MIRROR_HERB        (ITEM_EXPANSION_START + 82)
#define ITEM_PUNCHING_GLOVE     (ITEM_EXPANSION_START + 83)

//Berries
#define ITEM_ROSELI_BERRY       (ITEM_EXPANSION_START + 84)
#define ITEM_KEE_BERRY          (ITEM_EXPANSION_START + 85)
#define ITEM_MARANGA_BERRY      (ITEM_EXPANSION_START + 86)

//Drives
#define ITEM_BURN_DRIVE         (ITEM_EXPANSION_START + 87)
#define ITEM_CHILL_DRIVE        (ITEM_EXPANSION_START + 88)
#define ITEM_DOUSE_DRIVE        (ITEM_EXPANSION_START + 89)
#define ITEM_SHOCK_DRIVE        (ITEM_EXPANSION_START + 90)

#define IS_ITEM_GENESECT_DRIVE(item) (item >= ITEM_BURN_DRIVE && item <= ITEM_SHOCK_DRIVE)

//Fossils
#define ITEM_COVER_FOSSIL       (ITEM_EXPANSION_START + 91)
#define ITEM_PLUME_FOSSIL       (ITEM_EXPANSION_START + 92)
#define ITEM_JAW_FOSSIL         (ITEM_EXPANSION_START + 93)
#define ITEM_SAIL_FOSSIL        (ITEM_EXPANSION_START + 94)
#define ITEM_FOSSILIZED_BIRD    (ITEM_EXPANSION_START + 95)
#define ITEM_FOSSILIZED_DINO    (ITEM_EXPANSION_START + 96)
#define ITEM_FOSSILIZED_DRAKE   (ITEM_EXPANSION_START + 97)
#define ITEM_FOSSILIZED_FISH    (ITEM_EXPANSION_START + 98)

//Gems
#define ITEM_NORMAL_GEM         (ITEM_EXPANSION_START + 99)
#define ITEM_FIGHTING_GEM       (ITEM_EXPANSION_START + 100)
#define ITEM_FLYING_GEM         (ITEM_EXPANSION_START + 101)
#define ITEM_POISON_GEM         (ITEM_EXPANSION_START + 102)
#define ITEM_GROUND_GEM         (ITEM_EXPANSION_START + 103)
#define ITEM_ROCK_GEM           (ITEM_EXPANSION_START + 104)
#define ITEM_BUG_GEM            (ITEM_EXPANSION_START + 105)
#define ITEM_GHOST_GEM          (ITEM_EXPANSION_START + 106)
#define ITEM_STEEL_GEM          (ITEM_EXPANSION_START + 107)
#define ITEM_FIRE_GEM           (ITEM_EXPANSION_START + 108)
#define ITEM_WATER_GEM          (ITEM_EXPANSION_START + 109)
#define ITEM_GRASS_GEM          (ITEM_EXPANSION_START + 110)
#define ITEM_ELECTRIC_GEM       (ITEM_EXPANSION_START + 111)
#define ITEM_PSYCHIC_GEM        (ITEM_EXPANSION_START + 112)
#define ITEM_ICE_GEM            (ITEM_EXPANSION_START + 113)
#define ITEM_DRAGON_GEM         (ITEM_EXPANSION_START + 114)
#define ITEM_DARK_GEM           (ITEM_EXPANSION_START + 115)
#define ITEM_FAIRY_GEM          (ITEM_EXPANSION_START + 116)

//Memories
#define IS_ITEM_MEMORY(item) (item >= ITEM_FIGHTING_MEMORY && item <= ITEM_FAIRY_MEMORY)

#define ITEM_FIGHTING_MEMORY    (ITEM_EXPANSION_START + 117)
#define ITEM_FLYING_MEMORY      (ITEM_EXPANSION_START + 118)
#define ITEM_POISON_MEMORY      (ITEM_EXPANSION_START + 119)
#define ITEM_GROUND_MEMORY      (ITEM_EXPANSION_START + 120)
#define ITEM_ROCK_MEMORY        (ITEM_EXPANSION_START + 121)
#define ITEM_BUG_MEMORY         (ITEM_EXPANSION_START + 122)
#define ITEM_GHOST_MEMORY       (ITEM_EXPANSION_START + 123)
#define ITEM_STEEL_MEMORY       (ITEM_EXPANSION_START + 124)
#define ITEM_FIRE_MEMORY        (ITEM_EXPANSION_START + 125)
#define ITEM_WATER_MEMORY       (ITEM_EXPANSION_START + 126)
#define ITEM_GRASS_MEMORY       (ITEM_EXPANSION_START + 127)
#define ITEM_ELECTRIC_MEMORY    (ITEM_EXPANSION_START + 128)
#define ITEM_PSYCHIC_MEMORY     (ITEM_EXPANSION_START + 129)
#define ITEM_ICE_MEMORY         (ITEM_EXPANSION_START + 130)
#define ITEM_DRAGON_MEMORY      (ITEM_EXPANSION_START + 131)
#define ITEM_DARK_MEMORY        (ITEM_EXPANSION_START + 132)
#define ITEM_FAIRY_MEMORY       (ITEM_EXPANSION_START + 133)

//Nectars
#define ITEM_RED_NECTAR         (ITEM_EXPANSION_START + 134)
#define ITEM_YELLOW_NECTAR      (ITEM_EXPANSION_START + 135)
#define ITEM_PINK_NECTAR        (ITEM_EXPANSION_START + 136)
#define ITEM_PURPLE_NECTAR      (ITEM_EXPANSION_START + 137)

//Plates
#define ITEM_BLANK_PLATE        (ITEM_EXPANSION_START + 138)
#define ITEM_LEGEND_PLATE       (ITEM_EXPANSION_START + 139)

//Relic Items
#define ITEM_RELIC_COPPER       (ITEM_EXPANSION_START + 140)
#define ITEM_RELIC_SILVER       (ITEM_EXPANSION_START + 141)
#define ITEM_RELIC_GOLD         (ITEM_EXPANSION_START + 142)
#define ITEM_RELIC_VASE         (ITEM_EXPANSION_START + 143)
#define ITEM_RELIC_BAND         (ITEM_EXPANSION_START + 144)
#define ITEM_RELIC_STATUE       (ITEM_EXPANSION_START + 145)
#define ITEM_RELIC_CROWN        (ITEM_EXPANSION_START + 146)

//Wings
#define ITEM_HEALTH_FEATHER     (ITEM_EXPANSION_START + 147)
#define ITEM_MUSCLE_FEATHER     (ITEM_EXPANSION_START + 148)
#define ITEM_RESIST_FEATHER     (ITEM_EXPANSION_START + 149)
#define ITEM_GENIUS_FEATHER     (ITEM_EXPANSION_START + 150)
#define ITEM_CLEVER_FEATHER     (ITEM_EXPANSION_START + 151)
#define ITEM_SWIFT_FEATHER      (ITEM_EXPANSION_START + 152)
#define ITEM_PRETTY_FEATHER     (ITEM_EXPANSION_START + 153)

//Key Items
#define ITEM_DNA_SPLICERS       (ITEM_EXPANSION_START + 154)
#define ITEM_REVEAL_GLASS       (ITEM_EXPANSION_START + 155)
#define ITEM_PRISON_BOTTLE      (ITEM_EXPANSION_START + 156)
#define ITEM_CATCHING_CHARM     (ITEM_EXPANSION_START + 157)
#define ITEM_EXP_CHARM          (ITEM_EXPANSION_START + 158)
#define ITEM_OVAL_CHARM         (ITEM_EXPANSION_START + 159)
#define ITEM_SHINY_CHARM        (ITEM_EXPANSION_START + 160)
#define ITEM_N_SOLARIZER        (ITEM_EXPANSION_START + 161)
#define ITEM_N_LUNARIZER        (ITEM_EXPANSION_START + 162)
#define ITEM_POKEMON_BOX_LINK   (ITEM_EXPANSION_START + 163)
#define ITEM_ZYGARDE_CUBE       (ITEM_EXPANSION_START + 164)
#define ITEM_SUN_FLUTE          (ITEM_EXPANSION_START + 165)
#define ITEM_MOON_FLUTE         (ITEM_EXPANSION_START + 166)
#define ITEM_LIGHT_STONE        (ITEM_EXPANSION_START + 167)
#define ITEM_DARK_STONE         (ITEM_EXPANSION_START + 168)
#define ITEM_ICEROOT_CARROT     (ITEM_EXPANSION_START + 169)
#define ITEM_SHADEROOT_CARROT   (ITEM_EXPANSION_START + 170)
#define ITEM_REINS_OF_UNITY     (ITEM_EXPANSION_START + 171)
#define ITEM_WOODEN_CROWN       (ITEM_EXPANSION_START + 172)
#define ITEM_ROTOM_CATALOG      (ITEM_EXPANSION_START + 173)
#define ITEM_ADAMANT_CRYSTAL    (ITEM_EXPANSION_START + 174)
#define ITEM_LUSTROUS_GLOBE     (ITEM_EXPANSION_START + 175)
#define ITEM_GRISEOUS_CORE      (ITEM_EXPANSION_START + 176)
#define ITEM_SCROLL_OF_DARKNESS (ITEM_EXPANSION_START + 177)
#define ITEM_SCROLL_OF_WATERS   (ITEM_EXPANSION_START + 178)
#define ITEM_MEGA_RING          (ITEM_EXPANSION_START + 179)

//Lets Go Pikachu
#define ITEM_AUTOGRAPH          (ITEM_EXPANSION_START + 180)
#define ITEM_GOLD_TEETH         (ITEM_EXPANSION_START + 181)
#define ITEM_KEY_STONE          (ITEM_EXPANSION_START + 182)
#define ITEM_LIFT_KEY           (ITEM_EXPANSION_START + 183)
#define ITEM_PEWTER_CRUNCHIES   (ITEM_EXPANSION_START + 184)
#define ITEM_SYLPH_SCOPE        (ITEM_EXPANSION_START + 185)
#define ITEM_TEA                (ITEM_EXPANSION_START + 186)

//Mints
#define IS_ITEM_NATURE_MINT(item) (item >= ITEM_LONELY_MINT && item <= ITEM_SERIOUS_MINT)

#define ITEM_LONELY_MINT        (ITEM_EXPANSION_START + 187)
#define ITEM_ADAMANT_MINT       (ITEM_EXPANSION_START + 188)
#define ITEM_NAUGHTY_MINT       (ITEM_EXPANSION_START + 189)
#define ITEM_BRAVE_MINT         (ITEM_EXPANSION_START + 190)
#define ITEM_BOLD_MINT          (ITEM_EXPANSION_START + 191)
#define ITEM_IMPISH_MINT        (ITEM_EXPANSION_START + 192)
#define ITEM_LAX_MINT           (ITEM_EXPANSION_START + 193)
#define ITEM_RELAXED_MINT       (ITEM_EXPANSION_START + 194)
#define ITEM_MODEST_MINT        (ITEM_EXPANSION_START + 195)
#define ITEM_MILD_MINT          (ITEM_EXPANSION_START + 196)
#define ITEM_RASH_MINT          (ITEM_EXPANSION_START + 197)
#define ITEM_QUIET_MINT         (ITEM_EXPANSION_START + 198)
#define ITEM_CALM_MINT          (ITEM_EXPANSION_START + 199)
#define ITEM_GENTLE_MINT        (ITEM_EXPANSION_START + 200)
#define ITEM_CAREFUL_MINT       (ITEM_EXPANSION_START + 201)
#define ITEM_SASSY_MINT         (ITEM_EXPANSION_START + 202)
#define ITEM_TIMID_MINT         (ITEM_EXPANSION_START + 203)
#define ITEM_HASTY_MINT         (ITEM_EXPANSION_START + 204)
#define ITEM_JOLLY_MINT         (ITEM_EXPANSION_START + 205)
#define ITEM_NAIVE_MINT         (ITEM_EXPANSION_START + 206)
#define ITEM_SERIOUS_MINT       (ITEM_EXPANSION_START + 207)

//Gen IX DLC
#define ITEM_FAIRY_FEATHER      (ITEM_EXPANSION_START + 208)
#define ITEM_SYRUPY_APPLE       (ITEM_EXPANSION_START + 209)
#define ITEM_UNREMARKABLE_TEACUP (ITEM_EXPANSION_START + 210)
#define ITEM_MASTERPIECE_TEACUP (ITEM_EXPANSION_START + 211)
#define ITEM_CORNERSTONE_MASK   (ITEM_EXPANSION_START + 212)
#define ITEM_WELLSPRING_MASK    (ITEM_EXPANSION_START + 213)
#define ITEM_HEARTHFLAME_MASK   (ITEM_EXPANSION_START + 214)
#define ITEM_METAL_ALLOY        (ITEM_EXPANSION_START + 215)
...
#define NUM_MEGA_STONES (ITEM_EXPANSION_START - ITEM_MAX_MEGA_STONES) // includes the pixie plate
