...
#define NUM_MEGA_STONES 47

#define ITEM_MAX_MEGA_STONES  (ITEM_DIANCITE)

//Item expansion
#define ITEM_EXPANSION_START    (ITEM_DIANCITE + 1)

//Generation V
#define ITEM_PIXIE_PLATE        (ITEM_EXPANSION_START)
...
#define ITEM_CUSTOM_START (ITEM_NUM_MAX+1)

/*
 * // define new items here:
 * #define ITEM_NEW_ITEM (ITEM_CUSTOM_START)
 * #define ITEM_NEW_ITEM_2 (ITEM_CUSTOM_START+1)
 */
...
// pixie plate + megas
#define NUM_BAG_ITEMS        165+33+NUM_MEGA_STONES
