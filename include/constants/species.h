...
#define SPECIES_MINIOR_METEOR_ORANGE (SPECIES_BATTLE_FORM_START + 15)
#define SPECIES_MINIOR_METEOR_YELLOW (SPECIES_BATTLE_FORM_START + 16)
#define SPECIES_MINIOR_METEOR_GREEN (SPECIES_BATTLE_FORM_START + 17)
#define SPECIES_MINIOR_METEOR_BLUE (SPECIES_BATTLE_FORM_START + 18)
#define SPECIES_MINIOR_METEOR_INDIGO (SPECIES_BATTLE_FORM_START + 19)
#define SPECIES_MINIOR_METEOR_VIOLET (SPECIES_BATTLE_FORM_START + 20)
#define SPECIES_MINIOR_CORE_RED (SPECIES_BATTLE_FORM_START + 21)
#define SPECIES_MINIOR_CORE_ORANGE (SPECIES_BATTLE_FORM_START + 22)
#define SPECIES_MINIOR_CORE_YELLOW (SPECIES_BATTLE_FORM_START + 23)
#define SPECIES_MINIOR_CORE_GREEN (SPECIES_BATTLE_FORM_START + 24)
#define SPECIES_MINIOR_CORE_BLUE (SPECIES_BATTLE_FORM_START + 25)
#define SPECIES_MINIOR_CORE_INDIGO (SPECIES_BATTLE_FORM_START + 26)
#define SPECIES_MINIOR_CORE_VIOLET (SPECIES_BATTLE_FORM_START + 27)
#define SPECIES_MIMIKYU_BUSTED (SPECIES_BATTLE_FORM_START + 28)
#define SPECIES_NECROZMA_DUSK_MANE (SPECIES_BATTLE_FORM_START + 29)
#define SPECIES_NECROZMA_DAWN_WINGS (SPECIES_BATTLE_FORM_START + 30)
#define SPECIES_NECROZMA_ULTRA_DUSK_MANE (SPECIES_BATTLE_FORM_START + 31)
#define SPECIES_NECROZMA_ULTRA_DAWN_WINGS (SPECIES_BATTLE_FORM_START + 32)
#define SPECIES_CRAMORANT_GULPING (SPECIES_BATTLE_FORM_START + 33)
#define SPECIES_CRAMORANT_GORGING (SPECIES_BATTLE_FORM_START + 34)
#define SPECIES_EISCUE_NOICE_FACE (SPECIES_BATTLE_FORM_START + 35)
#define SPECIES_MORPEKO_HANGRY (SPECIES_BATTLE_FORM_START + 36)
#define SPECIES_ZACIAN_CROWNED (SPECIES_BATTLE_FORM_START + 37)
#define SPECIES_ZAMAZENTA_CROWNED (SPECIES_BATTLE_FORM_START + 38)
