...
#define SPECIES_OVERKWIL 954
#define SPECIES_ENAMORUS 955

#define MAX_MON_NUM (SPECIES_CALYREX) //TODO swap to ENAMORUS

//mega
#define SPECIES_MEGA_START (MAX_MON_NUM+1) // 949
...
//primals
#define SPECIES_PRIMAL_START (MAX_MEGA_NUM + 1) // 997
...
//alolans
#define SPECIES_ALOLAN_REGIONAL_START (MAX_PRIMAL_NUM + 1) // 999
...
//galarians
#define SPECIES_GALARIAN_REGIONAL_START (MAX_ALOLAN_REGIONAL_NUM + 1) // 1017
...
//misc forms
#define SPECIES_MISC_FORM_START (MAX_GALARIAN_REGIONAL_NUM + 1) // 1036
...
//#define SPECIES_DIALGA_ORIGIN TODO redo numbering
//#define SPECIES_PALKIA_ORIGIN TODO redo numbering

#define SPECIES_BASCULIN_BLUE_STRIPED (SPECIES_MISC_FORM_START + 20)
//#define SPECIES_BASCULIN_WHITE_STRIPED TODO redo numbering

#define SPECIES_DARMANITAN_ZEN_MODE (SPECIES_MISC_FORM_START + 21)
#define SPECIES_DARMANITAN_ZEN_MODE_GALARIAN (SPECIES_MISC_FORM_START + 22)

#define SPECIES_DEERLING_SUMMER (SPECIES_MISC_FORM_START + 23)
#define SPECIES_DEERLING_AUTUMN (SPECIES_MISC_FORM_START + 24)
#define SPECIES_DEERLING_WINTER (SPECIES_MISC_FORM_START + 25)

#define SPECIES_SAWSBUCK_SUMMER (SPECIES_MISC_FORM_START + 26)
#define SPECIES_SAWSBUCK_AUTUMN (SPECIES_MISC_FORM_START + 27)
#define SPECIES_SAWSBUCK_WINTER (SPECIES_MISC_FORM_START + 28)

#define SPECIES_TORNADUS_THERIAN (SPECIES_MISC_FORM_START + 29)
#define SPECIES_THUNDURUS_THERIAN (SPECIES_MISC_FORM_START + 30)
#define SPECIES_LANDORUS_THERIAN (SPECIES_MISC_FORM_START + 31)

#define SPECIES_KYUREM_WHITE (SPECIES_MISC_FORM_START + 32)
#define SPECIES_KYUREM_BLACK (SPECIES_MISC_FORM_START + 33)

#define SPECIES_KELDEO_RESOLUTE (SPECIES_MISC_FORM_START + 34)
#define SPECIES_MELOETTA_PIROUETTE (SPECIES_MISC_FORM_START + 35)

#define SPECIES_GENESECT_DOUSE_DRIVE (SPECIES_MISC_FORM_START + 36)
#define SPECIES_GENESECT_SHOCK_DRIVE (SPECIES_MISC_FORM_START + 37)
#define SPECIES_GENESECT_BURN_DRIVE (SPECIES_MISC_FORM_START + 38)
#define SPECIES_GENESECT_CHILL_DRIVE (SPECIES_MISC_FORM_START + 39)

#define SPECIES_GRENINJA_BATTLE_BOND (SPECIES_MISC_FORM_START + 40)
#define SPECIES_GRENINJA_ASH (SPECIES_MISC_FORM_START + 41)

#define SPECIES_VIVILLON_POLAR (SPECIES_MISC_FORM_START + 42)
#define SPECIES_VIVILLON_TUNDRA (SPECIES_MISC_FORM_START + 43)
#define SPECIES_VIVILLON_CONTINENTAL (SPECIES_MISC_FORM_START + 44)
#define SPECIES_VIVILLON_GARDEN (SPECIES_MISC_FORM_START + 45)
#define SPECIES_VIVILLON_ELEGANT (SPECIES_MISC_FORM_START + 46)
#define SPECIES_VIVILLON_MEADOW (SPECIES_MISC_FORM_START + 47)
#define SPECIES_VIVILLON_MODERN (SPECIES_MISC_FORM_START + 48)
#define SPECIES_VIVILLON_MARINE (SPECIES_MISC_FORM_START + 49)
#define SPECIES_VIVILLON_ARCHIPELAGO (SPECIES_MISC_FORM_START + 50)
#define SPECIES_VIVILLON_HIGH_PLAINS (SPECIES_MISC_FORM_START + 51)
#define SPECIES_VIVILLON_SANDSTORM (SPECIES_MISC_FORM_START + 52)
#define SPECIES_VIVILLON_RIVER (SPECIES_MISC_FORM_START + 53)
#define SPECIES_VIVILLON_MONSOON (SPECIES_MISC_FORM_START + 54)
#define SPECIES_VIVILLON_SAVANNA (SPECIES_MISC_FORM_START + 55)
#define SPECIES_VIVILLON_SUN (SPECIES_MISC_FORM_START + 56)
#define SPECIES_VIVILLON_OCEAN (SPECIES_MISC_FORM_START + 57)
#define SPECIES_VIVILLON_JUNGLE (SPECIES_MISC_FORM_START + 58)
#define SPECIES_VIVILLON_FANCY (SPECIES_MISC_FORM_START + 59)
#define SPECIES_VIVILLON_POKE_BALL (SPECIES_MISC_FORM_START + 60)

#define SPECIES_FLABEBE_YELLOW_FLOWER (SPECIES_MISC_FORM_START + 61)
#define SPECIES_FLABEBE_ORANGE_FLOWER (SPECIES_MISC_FORM_START + 62)
#define SPECIES_FLABEBE_BLUE_FLOWER (SPECIES_MISC_FORM_START + 63)
#define SPECIES_FLABEBE_WHITE_FLOWER (SPECIES_MISC_FORM_START + 64)

#define SPECIES_FLOETTE_YELLOW_FLOWER (SPECIES_MISC_FORM_START + 65)
#define SPECIES_FLOETTE_ORANGE_FLOWER (SPECIES_MISC_FORM_START + 66)
#define SPECIES_FLOETTE_BLUE_FLOWER (SPECIES_MISC_FORM_START + 67)
#define SPECIES_FLOETTE_WHITE_FLOWER (SPECIES_MISC_FORM_START + 68)
#define SPECIES_FLOETTE_ETERNAL_FLOWER (SPECIES_MISC_FORM_START + 69)

#define SPECIES_FLORGES_YELLOW_FLOWER (SPECIES_MISC_FORM_START + 70)
#define SPECIES_FLORGES_ORANGE_FLOWER (SPECIES_MISC_FORM_START + 71)
#define SPECIES_FLORGES_BLUE_FLOWER (SPECIES_MISC_FORM_START + 72)
#define SPECIES_FLORGES_WHITE_FLOWER (SPECIES_MISC_FORM_START + 73)

#define SPECIES_FURFROU_HEART (SPECIES_MISC_FORM_START + 74)
#define SPECIES_FURFROU_STAR (SPECIES_MISC_FORM_START + 75)
#define SPECIES_FURFROU_DIAMOND (SPECIES_MISC_FORM_START + 76)
#define SPECIES_FURFROU_DEBUTANTE (SPECIES_MISC_FORM_START + 77)
#define SPECIES_FURFROU_MATRON (SPECIES_MISC_FORM_START + 78)
#define SPECIES_FURFROU_DANDY (SPECIES_MISC_FORM_START + 79)
#define SPECIES_FURFROU_LA_REINE (SPECIES_MISC_FORM_START + 80)
#define SPECIES_FURFROU_KABUKI (SPECIES_MISC_FORM_START + 81)
#define SPECIES_FURFROU_PHARAOH (SPECIES_MISC_FORM_START + 82)

#define SPECIES_AEGISLASH_BLADE (SPECIES_MISC_FORM_START + 83)

#define SPECIES_PUMPKABOO_SMALL (SPECIES_MISC_FORM_START + 84)
#define SPECIES_PUMPKABOO_LARGE (SPECIES_MISC_FORM_START + 85)
#define SPECIES_PUMPKABOO_SUPER (SPECIES_MISC_FORM_START + 86)

#define SPECIES_GOURGEIST_SMALL (SPECIES_MISC_FORM_START + 87)
#define SPECIES_GOURGEIST_LARGE (SPECIES_MISC_FORM_START + 88)
#define SPECIES_GOURGEIST_SUPER (SPECIES_MISC_FORM_START + 89)

#define SPECIES_XERNEAS_ACTIVE (SPECIES_MISC_FORM_START + 90)

#define SPECIES_ZYGARDE_10 (SPECIES_MISC_FORM_START + 91)
#define SPECIES_ZYGARDE_10_POWER_CONSTRUCT (SPECIES_MISC_FORM_START + 92)
#define SPECIES_ZYGARDE_50_POWER_CONSTRUCT (SPECIES_MISC_FORM_START + 93)
#define SPECIES_ZYGARDE_10_COMPLETE (SPECIES_MISC_FORM_START + 94)
#define SPECIES_ZYGARDE_50_COMPLETE (SPECIES_MISC_FORM_START + 95)

#define SPECIES_HOOPA_UNBOUND (SPECIES_MISC_FORM_START + 96)

#define SPECIES_ORICORIO_POM_POM (SPECIES_MISC_FORM_START + 97)
#define SPECIES_ORICORIO_PAU (SPECIES_MISC_FORM_START + 98)
#define SPECIES_ORICORIO_SENSU (SPECIES_MISC_FORM_START + 99)

#define SPECIES_ROCKRUFF_OWN_TEMPO (SPECIES_MISC_FORM_START + 100)
#define SPECIES_LYCANROC_MIDNIGHT (SPECIES_MISC_FORM_START + 101)
#define SPECIES_LYCANROC_DUSK (SPECIES_MISC_FORM_START + 102)

#define SPECIES_WISHIWASHI_SCHOOL (SPECIES_MISC_FORM_START + 103)

#define SPECIES_MINIOR_METEOR_ORANGE (SPECIES_MISC_FORM_START + 104)
#define SPECIES_MINIOR_METEOR_YELLOW (SPECIES_MISC_FORM_START + 105)
#define SPECIES_MINIOR_METEOR_GREEN (SPECIES_MISC_FORM_START + 106)
#define SPECIES_MINIOR_METEOR_BLUE (SPECIES_MISC_FORM_START + 107)
#define SPECIES_MINIOR_METEOR_INDIGO (SPECIES_MISC_FORM_START + 108)
#define SPECIES_MINIOR_METEOR_VIOLET (SPECIES_MISC_FORM_START + 109)
#define SPECIES_MINIOR_CORE_RED (SPECIES_MISC_FORM_START + 110)
#define SPECIES_MINIOR_CORE_ORANGE (SPECIES_MISC_FORM_START + 111)
#define SPECIES_MINIOR_CORE_YELLOW (SPECIES_MISC_FORM_START + 112)
#define SPECIES_MINIOR_CORE_GREEN (SPECIES_MISC_FORM_START + 113)
#define SPECIES_MINIOR_CORE_BLUE (SPECIES_MISC_FORM_START + 114)
#define SPECIES_MINIOR_CORE_INDIGO (SPECIES_MISC_FORM_START + 115)
#define SPECIES_MINIOR_CORE_VIOLET (SPECIES_MISC_FORM_START + 116)

#define SPECIES_MIMIKYU_BUSTED (SPECIES_MISC_FORM_START + 117)

#define SPECIES_NECROZMA_DUSK_MANE (SPECIES_MISC_FORM_START + 118)
#define SPECIES_NECROZMA_DAWN_WINGS (SPECIES_MISC_FORM_START + 119)
#define SPECIES_NECROZMA_ULTRA_DUSK_MANE (SPECIES_MISC_FORM_START + 120)
#define SPECIES_NECROZMA_ULTRA_DAWN_WINGS (SPECIES_MISC_FORM_START + 121)

#define SPECIES_MAGEARNA_ORIGINAL (SPECIES_MISC_FORM_START + 122)

#define SPECIES_CRAMORANT_GULPING (SPECIES_MISC_FORM_START + 123)
#define SPECIES_CRAMORANT_GORGING (SPECIES_MISC_FORM_START + 124)

#define SPECIES_TOXTRICITY_LOW_KEY (SPECIES_MISC_FORM_START + 125)

#define SPECIES_SINISTEA_ANTIQUE (SPECIES_MISC_FORM_START + 126)
#define SPECIES_POLTEAGEIST_ANTIQUE (SPECIES_MISC_FORM_START + 127)

#define SPECIES_ALCREMIE_RUBY_CREAM (SPECIES_MISC_FORM_START + 128)
#define SPECIES_ALCREMIE_MATCHA_CREAM (SPECIES_MISC_FORM_START + 129)
#define SPECIES_ALCREMIE_MINT_CREAM (SPECIES_MISC_FORM_START + 130)
#define SPECIES_ALCREMIE_LEMON_CREAM (SPECIES_MISC_FORM_START + 131)
#define SPECIES_ALCREMIE_SALTED_CREAM (SPECIES_MISC_FORM_START + 132)
#define SPECIES_ALCREMIE_RUBY_SWIRL (SPECIES_MISC_FORM_START + 133)
#define SPECIES_ALCREMIE_CARAMEL_SWIRL (SPECIES_MISC_FORM_START + 134)
#define SPECIES_ALCREMIE_RAINBOW_SWIRL (SPECIES_MISC_FORM_START + 135)

#define SPECIES_EISCUE_NOICE_FACE (SPECIES_MISC_FORM_START + 136)
#define SPECIES_MORPEKO_HANGRY (SPECIES_MISC_FORM_START + 137)

#define SPECIES_ZACIAN_CROWNED (SPECIES_MISC_FORM_START + 138)
#define SPECIES_ZAMAZENTA_CROWNED (SPECIES_MISC_FORM_START + 139)

#define SPECIES_ETERNATUS_ETERNAMAX (SPECIES_MISC_FORM_START + 140)
#define SPECIES_URSHIFU_RAPID_STRIKE (SPECIES_MISC_FORM_START + 141)
#define SPECIES_ZARUDE_DADA (SPECIES_MISC_FORM_START + 142)

#define SPECIES_CALYREX_ICE_RIDER (SPECIES_MISC_FORM_START + 143)
#define SPECIES_CALYREX_SHADOW_RIDER (SPECIES_MISC_FORM_START + 144)

//#define SPECIES_ENAMORUS_THERIAN TODO redo numbering

#define MAX_MISC_FORM_NUM (SPECIES_CALYREX_SHADOW_RIDER) //TODO change to SPECIES_ENAMORUS_THERIAN

//hisuians
#define SPECIES_HISUIAN_REGIONAL_START (MAX_MISC_FORM_NUM + 1)
...
#define SPECIES_GOODRA_HISUIAN (SPECIES_HISUIAN_REGIONAL_START + 12)
#define SPECIES_AVALUGG_HISUIAN (SPECIES_HISUIAN_REGIONAL_START + 13)
#define SPECIES_DECIDUEYE_HISUIAN (SPECIES_HISUIAN_REGIONAL_START + 14)
