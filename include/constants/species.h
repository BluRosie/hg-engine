...
#define SPECIES_PIKACHU_PH_D (SPECIES_COSMETIC_FORM_START + 4)
#define SPECIES_PIKACHU_LIBRE (SPECIES_COSMETIC_FORM_START + 5)
#define SPECIES_PIKACHU_ORIGINAL_CAP (SPECIES_COSMETIC_FORM_START + 6)
#define SPECIES_PIKACHU_HOENN_CAP (SPECIES_COSMETIC_FORM_START + 7)
#define SPECIES_PIKACHU_SINNOH_CAP (SPECIES_COSMETIC_FORM_START + 8)
#define SPECIES_PIKACHU_UNOVA_CAP (SPECIES_COSMETIC_FORM_START + 9)
#define SPECIES_PIKACHU_KALOS_CAP (SPECIES_COSMETIC_FORM_START + 10)
#define SPECIES_PIKACHU_ALOLA_CAP (SPECIES_COSMETIC_FORM_START + 11)
#define SPECIES_PIKACHU_PARTNER_CAP (SPECIES_COSMETIC_FORM_START + 12)
#define SPECIES_PIKACHU_WORLD_CAP (SPECIES_COSMETIC_FORM_START + 13)
...
#define SPECIES_KYUREM_WHITE (SPECIES_COSMETIC_FORM_START + 24)
#define SPECIES_KYUREM_BLACK (SPECIES_COSMETIC_FORM_START + 25)
...
#define SPECIES_GRENINJA_BATTLE_BOND (SPECIES_COSMETIC_FORM_START + 31)
#define SPECIES_VIVILLON_ARCHIPELAGO (SPECIES_COSMETIC_FORM_START + 32)
#define SPECIES_VIVILLON_CONTINENTAL (SPECIES_COSMETIC_FORM_START + 33)
#define SPECIES_VIVILLON_ELEGANT (SPECIES_COSMETIC_FORM_START + 34)
#define SPECIES_VIVILLON_GARDEN (SPECIES_COSMETIC_FORM_START + 35)
#define SPECIES_VIVILLON_HIGH_PLAINS (SPECIES_COSMETIC_FORM_START + 36)
#define SPECIES_VIVILLON_ICY_SNOW (SPECIES_COSMETIC_FORM_START + 37)
#define SPECIES_VIVILLON_JUNGLE (SPECIES_COSMETIC_FORM_START + 38)
#define SPECIES_VIVILLON_MARINE (SPECIES_COSMETIC_FORM_START + 39)
#define SPECIES_VIVILLON_MODERN (SPECIES_COSMETIC_FORM_START + 40)
#define SPECIES_VIVILLON_MONSOON (SPECIES_COSMETIC_FORM_START + 41)
#define SPECIES_VIVILLON_OCEAN (SPECIES_COSMETIC_FORM_START + 42)
#define SPECIES_VIVILLON_POLAR (SPECIES_COSMETIC_FORM_START + 43)
#define SPECIES_VIVILLON_RIVER (SPECIES_COSMETIC_FORM_START + 44)
#define SPECIES_VIVILLON_SANDSTORM (SPECIES_COSMETIC_FORM_START + 45)
#define SPECIES_VIVILLON_SAVANNA (SPECIES_COSMETIC_FORM_START + 46)
#define SPECIES_VIVILLON_SUN (SPECIES_COSMETIC_FORM_START + 47)
#define SPECIES_VIVILLON_TUNDRA (SPECIES_COSMETIC_FORM_START + 48)
#define SPECIES_VIVILLON_POKE_BALL (SPECIES_COSMETIC_FORM_START + 49)
#define SPECIES_VIVILLON_FANCY (SPECIES_COSMETIC_FORM_START + 50)
#define SPECIES_FLABEBE_RED (SPECIES_COSMETIC_FORM_START + 51)
#define SPECIES_FLABEBE_YELLOW (SPECIES_COSMETIC_FORM_START + 52)
#define SPECIES_FLABEBE_ORANGE (SPECIES_COSMETIC_FORM_START + 53)
#define SPECIES_FLABEBE_BLUE (SPECIES_COSMETIC_FORM_START + 54)
#define SPECIES_FLABEBE_WHITE (SPECIES_COSMETIC_FORM_START + 55)
#define SPECIES_FLOETTE_RED (SPECIES_COSMETIC_FORM_START + 56)
#define SPECIES_FLOETTE_YELLOW (SPECIES_COSMETIC_FORM_START + 57)
#define SPECIES_FLOETTE_ORANGE (SPECIES_COSMETIC_FORM_START + 58)
#define SPECIES_FLOETTE_BLUE (SPECIES_COSMETIC_FORM_START + 59)
#define SPECIES_FLOETTE_WHITE (SPECIES_COSMETIC_FORM_START + 60)
#define SPECIES_FLOETTE_ETERNAL (SPECIES_COSMETIC_FORM_START + 61)
#define SPECIES_FLORGES_RED (SPECIES_COSMETIC_FORM_START + 62)
#define SPECIES_FLORGES_YELLOW (SPECIES_COSMETIC_FORM_START + 63)
#define SPECIES_FLORGES_ORANGE (SPECIES_COSMETIC_FORM_START + 64)
#define SPECIES_FLORGES_BLUE (SPECIES_COSMETIC_FORM_START + 65)
#define SPECIES_FLORGES_WHITE (SPECIES_COSMETIC_FORM_START + 66)
#define SPECIES_FURFROU_HEART (SPECIES_COSMETIC_FORM_START + 67)
#define SPECIES_FURFROU_STAR (SPECIES_COSMETIC_FORM_START + 68)
#define SPECIES_FURFROU_DIAMOND (SPECIES_COSMETIC_FORM_START + 69)
#define SPECIES_FURFROU_DEBUTANTE (SPECIES_COSMETIC_FORM_START + 70)
#define SPECIES_FURFROU_MATRON (SPECIES_COSMETIC_FORM_START + 71)
#define SPECIES_FURFROU_DANDY (SPECIES_COSMETIC_FORM_START + 72)
#define SPECIES_FURFROU_LA_REINE (SPECIES_COSMETIC_FORM_START + 73)
#define SPECIES_FURFROU_KABUKI (SPECIES_COSMETIC_FORM_START + 74)
#define SPECIES_FURFROU_PHARAOH (SPECIES_COSMETIC_FORM_START + 75)
#define SPECIES_PUMPKABOO_SMALL (SPECIES_COSMETIC_FORM_START + 76)
#define SPECIES_PUMPKABOO_LARGE (SPECIES_COSMETIC_FORM_START + 77)
#define SPECIES_PUMPKABOO_SUPER (SPECIES_COSMETIC_FORM_START + 78)
#define SPECIES_GOURGEIST_SMALL (SPECIES_COSMETIC_FORM_START + 79)
#define SPECIES_GOURGEIST_LARGE (SPECIES_COSMETIC_FORM_START + 80)
#define SPECIES_GOURGEIST_SUPER (SPECIES_COSMETIC_FORM_START + 81)
#define SPECIES_HOOPA_UNBOUND (SPECIES_COSMETIC_FORM_START + 82)
#define SPECIES_ORICORIO_POM_POM (SPECIES_COSMETIC_FORM_START + 83)
#define SPECIES_ORICORIO_PAU (SPECIES_COSMETIC_FORM_START + 84)
#define SPECIES_ORICORIO_SENSU (SPECIES_COSMETIC_FORM_START + 85)
#define SPECIES_ROCKRUFF_DUSK (SPECIES_COSMETIC_FORM_START + 86)
#define SPECIES_LYCANROC_MIDNIGHT (SPECIES_COSMETIC_FORM_START + 87)
#define SPECIES_LYCANROC_DUSK (SPECIES_COSMETIC_FORM_START + 88)
#define SPECIES_MAGEARNA_ORIGINAL (SPECIES_COSMETIC_FORM_START + 89)
#define SPECIES_TOXTRICITY_LOW_KEY (SPECIES_COSMETIC_FORM_START + 90)
#define SPECIES_SINISTEA_ANTIQUE (SPECIES_COSMETIC_FORM_START + 91)
#define SPECIES_POLTEAGEIST_ANTIQUE (SPECIES_COSMETIC_FORM_START + 92)
#define SPECIES_ALCREMIE_RUBY_CREAM (SPECIES_COSMETIC_FORM_START + 93)
#define SPECIES_ALCREMIE_MATCHA_CREAM (SPECIES_COSMETIC_FORM_START + 94)
#define SPECIES_ALCREMIE_MINT_CREAM (SPECIES_COSMETIC_FORM_START + 95)
#define SPECIES_ALCREMIE_LEMON_CREAM (SPECIES_COSMETIC_FORM_START + 96)
#define SPECIES_ALCREMIE_SALTED_CREAM (SPECIES_COSMETIC_FORM_START + 97)
#define SPECIES_ALCREMIE_RUBY_SWIRL (SPECIES_COSMETIC_FORM_START + 98)
#define SPECIES_ALCREMIE_CARAMEL_SWIRL (SPECIES_COSMETIC_FORM_START + 99)
#define SPECIES_ALCREMIE_RAINBOW_SWIRL (SPECIES_COSMETIC_FORM_START + 100)
#define SPECIES_URSHIFU_RAPID_STRIKE (SPECIES_COSMETIC_FORM_START + 101)
#define SPECIES_ZARUDE_DADA (SPECIES_COSMETIC_FORM_START + 102)
#define SPECIES_CALYREX_ICE_RIDER (SPECIES_COSMETIC_FORM_START + 103)
#define SPECIES_CALYREX_SHADOW_RIDER (SPECIES_COSMETIC_FORM_START + 104)
...
#define SPECIES_DARMANITAN_ZEN_MODE_GALARIAN (SPECIES_BATTLE_FORM_START + 7)
...
#define SPECIES_ZYGARDE_COMPLETE (SPECIES_BATTLE_FORM_START + 13)
#define SPECIES_WISHIWASHI_SCHOOL (SPECIES_BATTLE_FORM_START + 14)
#define SPECIES_MINIOR_METEOR_RED (SPECIES_BATTLE_FORM_START + 15)
#define SPECIES_MINIOR_METEOR_ORANGE (SPECIES_BATTLE_FORM_START + 16)
#define SPECIES_MINIOR_METEOR_YELLOW (SPECIES_BATTLE_FORM_START + 17)
#define SPECIES_MINIOR_METEOR_GREEN (SPECIES_BATTLE_FORM_START + 18)
#define SPECIES_MINIOR_METEOR_BLUE (SPECIES_BATTLE_FORM_START + 19)
#define SPECIES_MINIOR_METEOR_INDIGO (SPECIES_BATTLE_FORM_START + 20)
#define SPECIES_MINIOR_METEOR_VIOLET (SPECIES_BATTLE_FORM_START + 21)
