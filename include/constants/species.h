...
#define SPECIES_ZYGARDE_COMPLETE           (SPECIES_MISC_FORM_START + 97)

#define SPECIES_HOOPA_UNBOUND (SPECIES_MISC_FORM_START + 98)

#define SPECIES_ORICORIO_POM_POM (SPECIES_MISC_FORM_START + 99)
#define SPECIES_ORICORIO_PAU     (SPECIES_MISC_FORM_START + 100)
#define SPECIES_ORICORIO_SENSU   (SPECIES_MISC_FORM_START + 101)

#define SPECIES_ROCKRUFF_OWN_TEMPO (SPECIES_MISC_FORM_START + 102)
#define SPECIES_LYCANROC_MIDNIGHT  (SPECIES_MISC_FORM_START + 103)
#define SPECIES_LYCANROC_DUSK      (SPECIES_MISC_FORM_START + 104)

#define SPECIES_WISHIWASHI_SCHOOL (SPECIES_MISC_FORM_START + 105)

#define SPECIES_MINIOR_METEOR_ORANGE (SPECIES_MISC_FORM_START + 106)
#define SPECIES_MINIOR_METEOR_YELLOW (SPECIES_MISC_FORM_START + 107)
#define SPECIES_MINIOR_METEOR_GREEN  (SPECIES_MISC_FORM_START + 108)
#define SPECIES_MINIOR_METEOR_BLUE   (SPECIES_MISC_FORM_START + 109)
#define SPECIES_MINIOR_METEOR_INDIGO (SPECIES_MISC_FORM_START + 110)
#define SPECIES_MINIOR_METEOR_VIOLET (SPECIES_MISC_FORM_START + 111)
#define SPECIES_MINIOR_CORE_RED      (SPECIES_MISC_FORM_START + 112)
#define SPECIES_MINIOR_CORE_ORANGE   (SPECIES_MISC_FORM_START + 113)
#define SPECIES_MINIOR_CORE_YELLOW   (SPECIES_MISC_FORM_START + 114)
#define SPECIES_MINIOR_CORE_GREEN    (SPECIES_MISC_FORM_START + 115)
#define SPECIES_MINIOR_CORE_BLUE     (SPECIES_MISC_FORM_START + 116)
#define SPECIES_MINIOR_CORE_INDIGO   (SPECIES_MISC_FORM_START + 117)
#define SPECIES_MINIOR_CORE_VIOLET   (SPECIES_MISC_FORM_START + 118)

#define SPECIES_MIMIKYU_BUSTED (SPECIES_MISC_FORM_START + 119)

#define SPECIES_NECROZMA_DUSK_MANE        (SPECIES_MISC_FORM_START + 120)
#define SPECIES_NECROZMA_DAWN_WINGS       (SPECIES_MISC_FORM_START + 121)
#define SPECIES_NECROZMA_ULTRA_DUSK_MANE  (SPECIES_MISC_FORM_START + 122)
#define SPECIES_NECROZMA_ULTRA_DAWN_WINGS (SPECIES_MISC_FORM_START + 123)

#define SPECIES_MAGEARNA_ORIGINAL (SPECIES_MISC_FORM_START + 124)

#define SPECIES_PIKACHU_PARTNER (SPECIES_MISC_FORM_START + 125)
#define SPECIES_EEVEE_PARTNER   (SPECIES_MISC_FORM_START + 126)

#define SPECIES_CRAMORANT_GULPING (SPECIES_MISC_FORM_START + 127)
#define SPECIES_CRAMORANT_GORGING (SPECIES_MISC_FORM_START + 128)

#define SPECIES_TOXTRICITY_LOW_KEY (SPECIES_MISC_FORM_START + 129)

#define SPECIES_SINISTEA_ANTIQUE    (SPECIES_MISC_FORM_START + 130)
#define SPECIES_POLTEAGEIST_ANTIQUE (SPECIES_MISC_FORM_START + 131)

#define SPECIES_ALCREMIE_RUBY_CREAM    (SPECIES_MISC_FORM_START + 132)
#define SPECIES_ALCREMIE_MATCHA_CREAM  (SPECIES_MISC_FORM_START + 133)
#define SPECIES_ALCREMIE_MINT_CREAM    (SPECIES_MISC_FORM_START + 134)
#define SPECIES_ALCREMIE_LEMON_CREAM   (SPECIES_MISC_FORM_START + 135)
#define SPECIES_ALCREMIE_SALTED_CREAM  (SPECIES_MISC_FORM_START + 136)
#define SPECIES_ALCREMIE_RUBY_SWIRL    (SPECIES_MISC_FORM_START + 137)
#define SPECIES_ALCREMIE_CARAMEL_SWIRL (SPECIES_MISC_FORM_START + 138)
#define SPECIES_ALCREMIE_RAINBOW_SWIRL (SPECIES_MISC_FORM_START + 139)

#define SPECIES_EISCUE_NOICE_FACE (SPECIES_MISC_FORM_START + 140)
#define SPECIES_MORPEKO_HANGRY    (SPECIES_MISC_FORM_START + 141)

#define SPECIES_ZACIAN_CROWNED    (SPECIES_MISC_FORM_START + 142)
#define SPECIES_ZAMAZENTA_CROWNED (SPECIES_MISC_FORM_START + 143)

#define SPECIES_ETERNATUS_ETERNAMAX  (SPECIES_MISC_FORM_START + 144)
#define SPECIES_URSHIFU_RAPID_STRIKE (SPECIES_MISC_FORM_START + 145)
#define SPECIES_ZARUDE_DADA          (SPECIES_MISC_FORM_START + 146)

#define SPECIES_CALYREX_ICE_RIDER    (SPECIES_MISC_FORM_START + 147)
#define SPECIES_CALYREX_SHADOW_RIDER (SPECIES_MISC_FORM_START + 148)

#define SPECIES_ENAMORUS_THERIAN (SPECIES_MISC_FORM_START + 149)

#define MAX_MISC_FORM_NUM (SPECIES_ENAMORUS_THERIAN)

// hisuian
#define SPECIES_HISUIAN_REGIONAL_START (MAX_MISC_FORM_NUM + 1) // 1325
...
#define SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1346
...
#define SPECIES_PALDEAN_FORMS_START (MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM + 1) // 1353
...
#define SPECIES_KORAIDON_LIMITED_BUILD            (SPECIES_PALDEAN_FORMS_START + 14)
#define SPECIES_KORAIDON_SPRINTING_BUILD          (SPECIES_PALDEAN_FORMS_START + 15)
#define SPECIES_KORAIDON_SWIMMING_BUILD           (SPECIES_PALDEAN_FORMS_START + 16)
#define SPECIES_KORAIDON_GLIDING_BUILD            (SPECIES_PALDEAN_FORMS_START + 17)
#define SPECIES_MIRAIDON_LOW_POWER_MODE           (SPECIES_PALDEAN_FORMS_START + 18)
#define SPECIES_MIRAIDON_DRIVE_MODE               (SPECIES_PALDEAN_FORMS_START + 19)
#define SPECIES_MIRAIDON_AQUATIC_MODE             (SPECIES_PALDEAN_FORMS_START + 20)
#define SPECIES_MIRAIDON_GLIDE_MODE               (SPECIES_PALDEAN_FORMS_START + 21)
#define SPECIES_POLTCHAGEIST_MASTERPIECE          (SPECIES_PALDEAN_FORMS_START + 22)
#define SPECIES_SINISTCHA_MASTERPIECE             (SPECIES_PALDEAN_FORMS_START + 23)
#define SPECIES_OGERPON_WELLSPRING_MASK           (SPECIES_PALDEAN_FORMS_START + 24)
#define SPECIES_OGERPON_HEARTHFLAME_MASK          (SPECIES_PALDEAN_FORMS_START + 25)
#define SPECIES_OGERPON_CORNERSTONE_MASK          (SPECIES_PALDEAN_FORMS_START + 26)
#define SPECIES_OGERPON_TEAL_MASK_TERASTAL        (SPECIES_PALDEAN_FORMS_START + 27)
#define SPECIES_OGERPON_WELLSPRING_MASK_TERASTAL  (SPECIES_PALDEAN_FORMS_START + 28)
#define SPECIES_OGERPON_HEARTHFLAME_MASK_TERASTAL (SPECIES_PALDEAN_FORMS_START + 29)
#define SPECIES_OGERPON_CORNERSTONE_MASK_TERASTAL (SPECIES_PALDEAN_FORMS_START + 30)
#define SPECIES_URSALUNA_BLOODMOON                (SPECIES_PALDEAN_FORMS_START + 31)
#define SPECIES_TERAPAGOS_TERASTAL                (SPECIES_PALDEAN_FORMS_START + 32)
#define SPECIES_TERAPAGOS_STELLAR                 (SPECIES_PALDEAN_FORMS_START + 33)

#define MAX_SPECIES_PALDEAN_FORM_NUM (SPECIES_TERAPAGOS_STELLAR)

#define SPECIES_GIGANTAMAX_FORMS_START (MAX_SPECIES_PALDEAN_FORM_NUM + 1) // 1348
...
#define SPECIES_PLZA_MEGAS_START (MAX_SPECIES_GIGANTAMAX_FORMS_NUM + 1) // 1422
