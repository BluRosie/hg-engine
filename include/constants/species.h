...
#define SPECIES_VIVILLON 716
#define SPECIES_LITLEO 717
#define SPECIES_PYROAR 718
#define SPECIES_FLABEBE 719
#define SPECIES_FLOETTE 720
#define SPECIES_FLORGES 721
...
#define SPECIES_MARSHADOW 851
#define SPECIES_POIPOLE 852
#define SPECIES_NAGANADEL 853
#define SPECIES_STAKATAKA 854
#define SPECIES_BLACEPHALON 855
#define SPECIES_ZERAORA 856
#define SPECIES_MELTAN 857
#define SPECIES_MELMETAL 858
#define SPECIES_GROOKEY 859
#define SPECIES_THWACKEY 860
#define SPECIES_RILLABOOM 861
#define SPECIES_SCORBUNNY 862
#define SPECIES_RABOOT 863
#define SPECIES_CINDERACE 864
#define SPECIES_SOBBLE 865
#define SPECIES_DRIZZILE 866
#define SPECIES_INTELEON 867
#define SPECIES_SKWOVET 868
#define SPECIES_GREEDENT 869
#define SPECIES_ROOKIDEE 870
#define SPECIES_CORVISQUIRE 871
#define SPECIES_CORVIKNIGHT 872
#define SPECIES_BLIPBUG 873
#define SPECIES_DOTTLER 874
#define SPECIES_ORBEETLE 875
#define SPECIES_NICKIT 876
#define SPECIES_THIEVUL 877
#define SPECIES_GOSSIFLEUR 878
#define SPECIES_ELDEGOSS 879
#define SPECIES_WOOLOO 880
#define SPECIES_DUBWOOL 881
#define SPECIES_CHEWTLE 882
#define SPECIES_DREDNAW 883
#define SPECIES_YAMPER 884
#define SPECIES_BOLTUND 885
#define SPECIES_ROLYCOLY 886
#define SPECIES_CARKOL 887
#define SPECIES_COALOSSAL 888
#define SPECIES_APPLIN 889
#define SPECIES_FLAPPLE 890
#define SPECIES_APPLETUN 891
#define SPECIES_SILICOBRA 892
#define SPECIES_SANDACONDA 893
#define SPECIES_CRAMORANT 894
#define SPECIES_ARROKUDA 895
#define SPECIES_BARRASKEWDA 896
#define SPECIES_TOXEL 897
#define SPECIES_TOXTRICITY 898
#define SPECIES_SIZZLIPEDE 899
#define SPECIES_CENTISKORCH 900
#define SPECIES_CLOBBOPUS 901
#define SPECIES_GRAPPLOCT 902
#define SPECIES_SINISTEA 903
#define SPECIES_POLTEAGEIST 904
#define SPECIES_HATENNA 905
#define SPECIES_HATTREM 906
#define SPECIES_HATTERENE 907
#define SPECIES_IMPIDIMP 908
#define SPECIES_MORGREM 909
#define SPECIES_GRIMMSNARL 910
#define SPECIES_OBSTAGOON 911
#define SPECIES_PERRSERKER 912
#define SPECIES_CURSOLA 913
#define SPECIES_SIRFETCHD 914
#define SPECIES_MR_RIME 915
#define SPECIES_RUNERIGUS 916
#define SPECIES_MILCERY 917
#define SPECIES_ALCREMIE 918
#define SPECIES_FALINKS 919
#define SPECIES_PINCURCHIN 920
#define SPECIES_SNOM 921
#define SPECIES_FROSMOTH 922
#define SPECIES_STONJOURNER 923
#define SPECIES_EISCUE 924
#define SPECIES_INDEEDEE 925
#define SPECIES_MORPEKO 926
#define SPECIES_CUFANT 927
#define SPECIES_COPPERAJAH 928
#define SPECIES_DRACOZOLT 929
#define SPECIES_ARCTOZOLT 930
#define SPECIES_DRACOVISH 931
#define SPECIES_ARCTOVISH 932
#define SPECIES_DURALUDON 933
#define SPECIES_DREEPY 934
#define SPECIES_DRAKLOAK 935
#define SPECIES_DRAGAPULT 936
#define SPECIES_ZACIAN 937
#define SPECIES_ZAMAZENTA 938
#define SPECIES_ETERNATUS 939
#define SPECIES_KUBFU 940
#define SPECIES_URSHIFU 941
#define SPECIES_ZARUDE 942
#define SPECIES_REGIELEKI 943
#define SPECIES_REGIDRAGO 944
#define SPECIES_GLASTRIER 945
...
//alolans
#define SPECIES_ALOLAN_REGIONAL_START (MAX_MEGA_NUM + 1)

#define SPECIES_ALOLAN_RATTATA (SPECIES_ALOLAN_REGIONAL_START)
#define SPECIES_ALOLAN_RATICATE (SPECIES_ALOLAN_REGIONAL_START + 1)
#define SPECIES_ALOLAN_RAICHU (SPECIES_ALOLAN_REGIONAL_START + 2)
#define SPECIES_ALOLAN_SANDSHREW (SPECIES_ALOLAN_REGIONAL_START + 3)
#define SPECIES_ALOLAN_SANDSLASH (SPECIES_ALOLAN_REGIONAL_START + 4)
#define SPECIES_ALOLAN_VULPIX (SPECIES_ALOLAN_REGIONAL_START + 5)
#define SPECIES_ALOLAN_NINETAILS (SPECIES_ALOLAN_REGIONAL_START + 6)
#define SPECIES_ALOLAN_DIGLETT (SPECIES_ALOLAN_REGIONAL_START + 7)
#define SPECIES_ALOLAN_DUGTRIO (SPECIES_ALOLAN_REGIONAL_START + 8)
#define SPECIES_ALOLAN_MEOWTH (SPECIES_ALOLAN_REGIONAL_START + 9)
#define SPECIES_ALOLAN_PERSIAN (SPECIES_ALOLAN_REGIONAL_START + 10)
#define SPECIES_ALOLAN_GEODUDE (SPECIES_ALOLAN_REGIONAL_START + 11)
#define SPECIES_ALOLAN_GRAVELER (SPECIES_ALOLAN_REGIONAL_START + 12)
#define SPECIES_ALOLAN_GOLEM (SPECIES_ALOLAN_REGIONAL_START + 13)
#define SPECIES_ALOLAN_GRIMER (SPECIES_ALOLAN_REGIONAL_START + 14)
#define SPECIES_ALOLAN_MUK (SPECIES_ALOLAN_REGIONAL_START + 15)
#define SPECIES_ALOLAN_EXEGGUTOR (SPECIES_ALOLAN_REGIONAL_START + 16)
#define SPECIES_ALOLAN_MAROWAK (SPECIES_ALOLAN_REGIONAL_START + 17)

#define MAX_ALOLAN_REGIONAL_NUM (SPECIES_ALOLAN_MAROWAK)


//galarians
#define SPECIES_GALARIAN_REGIONAL_START (MAX_ALOLAN_REGIONAL_NUM + 1)

#define SPECIES_GALARIAN_MEOWTH (SPECIES_GALARIAN_REGIONAL_START)
#define SPECIES_GALARIAN_PONYTA (SPECIES_GALARIAN_REGIONAL_START + 1)
#define SPECIES_GALARIAN_RAPIDASH (SPECIES_GALARIAN_REGIONAL_START + 2)
#define SPECIES_GALARIAN_SLOWPOKE (SPECIES_GALARIAN_REGIONAL_START + 3)
#define SPECIES_GALARIAN_SLOWBRO (SPECIES_GALARIAN_REGIONAL_START + 4)
#define SPECIES_GALARIAN_FARFETCHD (SPECIES_GALARIAN_REGIONAL_START + 5)
#define SPECIES_GALARIAN_WEEZING (SPECIES_GALARIAN_REGIONAL_START + 6)
#define SPECIES_GALARIAN_MR_MIME (SPECIES_GALARIAN_REGIONAL_START + 7)
#define SPECIES_GALARIAN_ARTICUNO (SPECIES_GALARIAN_REGIONAL_START + 8)
#define SPECIES_GALARIAN_ZAPDOS (SPECIES_GALARIAN_REGIONAL_START + 9)
#define SPECIES_GALARIAN_MOLTRES (SPECIES_GALARIAN_REGIONAL_START + 10)
#define SPECIES_GALARIAN_SLOWKING (SPECIES_GALARIAN_REGIONAL_START + 11)
#define SPECIES_GALARIAN_CORSOLA (SPECIES_GALARIAN_REGIONAL_START + 12)
#define SPECIES_GALARIAN_ZIGZAGOON (SPECIES_GALARIAN_REGIONAL_START + 13)
#define SPECIES_GALARIAN_LINOONE (SPECIES_GALARIAN_REGIONAL_START + 14)
#define SPECIES_GALARIAN_DARUMAKA (SPECIES_GALARIAN_REGIONAL_START + 15)
#define SPECIES_GALARIAN_DARMANITAN (SPECIES_GALARIAN_REGIONAL_START + 16)
#define SPECIES_GALARIAN_YAMASK (SPECIES_GALARIAN_REGIONAL_START + 17)
#define SPECIES_GALARIAN_STUNFISK (SPECIES_GALARIAN_REGIONAL_START + 18)

#define MAX_GALARIAN_REGIONAL_NUM (SPECIES_GALARIAN_STUNFISK)
...
//cosmetic forms
#define SPECIES_COSMETIC_FORM_START (MAX_HISUIAN_REGIONAL_NUM + 1)

#define SPECIES_PIKACHU_COSPLAY (SPECIES_COSMETIC_FORM_START)
#define SPECIES_PIKACHU_ROCK_STAR (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_BELLE (SPECIES_COSMETIC_FORM_START + 2)
#define SPECIES_PIKACHU_POP_STAR (SPECIES_COSMETIC_FORM_START + 3)
#define SPECIES_PIKACHU_PHD (SPECIES_COSMETIC_FORM_START + 4)
#define SPECIES_PIKACHU_LIBRE (SPECIES_COSMETIC_FORM_START + 5)
#define SPECIES_PIKACHU_CAP_ORIGINAL (SPECIES_COSMETIC_FORM_START + 6)
#define SPECIES_PIKACHU_CAP_HOENN (SPECIES_COSMETIC_FORM_START + 7)
#define SPECIES_PIKACHU_CAP_SINNOH (SPECIES_COSMETIC_FORM_START + 8)
#define SPECIES_PIKACHU_CAP_UNOVA (SPECIES_COSMETIC_FORM_START + 9)
#define SPECIES_PIKACHU_CAP_KALOS (SPECIES_COSMETIC_FORM_START + 10)
#define SPECIES_PIKACHU_CAP_ALOLA (SPECIES_COSMETIC_FORM_START + 11)
#define SPECIES_PIKACHU_CAP_PARTNER (SPECIES_COSMETIC_FORM_START + 12)
#define SPECIES_PIKACHU_CAP_WORLD (SPECIES_COSMETIC_FORM_START + 13)
#define SPECIES_BASCULIN_BLUE_STRIPE (SPECIES_COSMETIC_FORM_START + 14)
#define SPECIES_DEERLING_SUMMER (SPECIES_COSMETIC_FORM_START + 15)
#define SPECIES_DEERLING_AUTUMN (SPECIES_COSMETIC_FORM_START + 16)
#define SPECIES_DEERLING_WINTER (SPECIES_COSMETIC_FORM_START + 17)
#define SPECIES_SAWSBUCK_SUMMER (SPECIES_COSMETIC_FORM_START + 18)
#define SPECIES_SAWSBUCK_AUTUMN (SPECIES_COSMETIC_FORM_START + 19)
#define SPECIES_SAWSBUCK_WINTER (SPECIES_COSMETIC_FORM_START + 20)
#define SPECIES_TORNADUS_THERIAN (SPECIES_COSMETIC_FORM_START + 21)
#define SPECIES_THUNDURUS_THERIAN (SPECIES_COSMETIC_FORM_START + 22)
#define SPECIES_LANDORUS_THERIAN (SPECIES_COSMETIC_FORM_START + 23)
#define SPECIES_WHITE_KYUREM (SPECIES_COSMETIC_FORM_START + 24)
#define SPECIES_BLACK_KYUREM (SPECIES_COSMETIC_FORM_START + 25)
#define SPECIES_KELDEO_RESOLUTE (SPECIES_COSMETIC_FORM_START + 26)
#define SPECIES_GENESECT_SHOCK (SPECIES_COSMETIC_FORM_START + 27)
#define SPECIES_GENESECT_BURN (SPECIES_COSMETIC_FORM_START + 28)
#define SPECIES_GENESECT_CHILL (SPECIES_COSMETIC_FORM_START + 29)
#define SPECIES_GENESECT_DOUSE (SPECIES_COSMETIC_FORM_START + 30)
#define SPECIES_VIVILLON_ARCHIPELAGO (SPECIES_COSMETIC_FORM_START + 31)
#define SPECIES_VIVILLON_CONTINENTAL (SPECIES_COSMETIC_FORM_START + 32)
#define SPECIES_VIVILLON_ELEGANT (SPECIES_COSMETIC_FORM_START + 33)
#define SPECIES_VIVILLON_GARDEN (SPECIES_COSMETIC_FORM_START + 34)
#define SPECIES_VIVILLON_HIGH_PLAINS (SPECIES_COSMETIC_FORM_START + 35)
#define SPECIES_VIVILLON_ICY_SNOW (SPECIES_COSMETIC_FORM_START + 36)
#define SPECIES_VIVILLON_JUNGLE (SPECIES_COSMETIC_FORM_START + 37)
#define SPECIES_VIVILLON_MARINE (SPECIES_COSMETIC_FORM_START + 38)
#define SPECIES_VIVILLON_MODERN (SPECIES_COSMETIC_FORM_START + 39)
#define SPECIES_VIVILLON_MONSOON (SPECIES_COSMETIC_FORM_START + 40)
#define SPECIES_VIVILLON_OCEAN (SPECIES_COSMETIC_FORM_START + 41)
#define SPECIES_VIVILLON_POLAR (SPECIES_COSMETIC_FORM_START + 42)
#define SPECIES_VIVILLON_RIVER (SPECIES_COSMETIC_FORM_START + 43)
#define SPECIES_VIVILLON_SANDSTORM (SPECIES_COSMETIC_FORM_START + 44)
#define SPECIES_VIVILLON_SAVANNA (SPECIES_COSMETIC_FORM_START + 45)
#define SPECIES_VIVILLON_SUN (SPECIES_COSMETIC_FORM_START + 46)
#define SPECIES_VIVILLON_TUNDRA (SPECIES_COSMETIC_FORM_START + 47)
#define SPECIES_VIVILLON_POKEBALL (SPECIES_COSMETIC_FORM_START + 48)
#define SPECIES_VIVILLON_FANCY (SPECIES_COSMETIC_FORM_START + 49)
#define SPECIES_FLABEBE_RED (SPECIES_COSMETIC_FORM_START + 50)
#define SPECIES_FLABEBE_YELLOW (SPECIES_COSMETIC_FORM_START + 51)
#define SPECIES_FLABEBE_ORANGE (SPECIES_COSMETIC_FORM_START + 52)
#define SPECIES_FLABEBE_BLUE (SPECIES_COSMETIC_FORM_START + 53)
#define SPECIES_FLABEBE_WHITE (SPECIES_COSMETIC_FORM_START + 54)
#define SPECIES_FLOETTE_RED (SPECIES_COSMETIC_FORM_START + 55)
#define SPECIES_FLOETTE_YELLOW (SPECIES_COSMETIC_FORM_START + 56)
#define SPECIES_FLOETTE_ORANGE (SPECIES_COSMETIC_FORM_START + 57)
#define SPECIES_FLOETTE_BLUE (SPECIES_COSMETIC_FORM_START + 58)
#define SPECIES_FLOETTE_WHITE (SPECIES_COSMETIC_FORM_START + 59)
#define SPECIES_FLOETTE_ETERNAL (SPECIES_COSMETIC_FORM_START + 60)
#define SPECIES_FLORGES_RED (SPECIES_COSMETIC_FORM_START + 61)
#define SPECIES_FLORGES_YELLOW (SPECIES_COSMETIC_FORM_START + 62)
#define SPECIES_FLORGES_ORANGE (SPECIES_COSMETIC_FORM_START + 63)
#define SPECIES_FLORGES_BLUE (SPECIES_COSMETIC_FORM_START + 64)
#define SPECIES_FLORGES_WHITE (SPECIES_COSMETIC_FORM_START + 65)
#define SPECIES_FURFROU_HEART (SPECIES_COSMETIC_FORM_START + 66)
#define SPECIES_FURFROU_STAR (SPECIES_COSMETIC_FORM_START + 67)
#define SPECIES_FURFROU_DIAMOND (SPECIES_COSMETIC_FORM_START + 68)
#define SPECIES_FURFROU_DEBUTANTE (SPECIES_COSMETIC_FORM_START + 69)
#define SPECIES_FURFROU_MATRON (SPECIES_COSMETIC_FORM_START + 70)
#define SPECIES_FURFROU_DANDY (SPECIES_COSMETIC_FORM_START + 71)
#define SPECIES_FURFROU_LA_REINE (SPECIES_COSMETIC_FORM_START + 72)
#define SPECIES_FURFROU_KABUKI (SPECIES_COSMETIC_FORM_START + 73)
#define SPECIES_FURFROU_PHARAOH (SPECIES_COSMETIC_FORM_START + 74)
#define SPECIES_PUMPKABOO_SMALL (SPECIES_COSMETIC_FORM_START + 75)
#define SPECIES_PUMPKABOO_LARGE (SPECIES_COSMETIC_FORM_START + 76)
#define SPECIES_PUMPKABOO_SUPER (SPECIES_COSMETIC_FORM_START + 77)
#define SPECIES_GOURGEIST_SMALL (SPECIES_COSMETIC_FORM_START + 78)
#define SPECIES_GOURGEIST_LARGE (SPECIES_COSMETIC_FORM_START + 79)
#define SPECIES_GOURGEIST_SUPER (SPECIES_COSMETIC_FORM_START + 80)
#define SPECIES_HOOPA_UNBOUND (SPECIES_COSMETIC_FORM_START + 81)
#define SPECIES_ORICORIO_POM_POM (SPECIES_COSMETIC_FORM_START + 82)
#define SPECIES_ORICORIO_PAU (SPECIES_COSMETIC_FORM_START + 83)
#define SPECIES_ORICORIO_SENSU (SPECIES_COSMETIC_FORM_START + 84)
#define SPECIES_ROCKRUFF_DUSK (SPECIES_COSMETIC_FORM_START + 85)
#define SPECIES_LYCANROC_MIDNIGHT (SPECIES_COSMETIC_FORM_START + 86)
#define SPECIES_LYCANROC_DUSK (SPECIES_COSMETIC_FORM_START + 87)
#define SPECIES_MAGEARNA_ORIGINAL (SPECIES_COSMETIC_FORM_START + 88)
#define SPECIES_TOXTRICITY_LOW_KEY (SPECIES_COSMETIC_FORM_START + 89)
#define SPECIES_SINISTEA_ANTIQUE (SPECIES_COSMETIC_FORM_START + 90)
#define SPECIES_POLTEAGEIST_ANTIQUE (SPECIES_COSMETIC_FORM_START + 91)
//fuck alcremie
#define SPECIES_URSHIFU_RAPID_STRIKE (SPECIES_COSMETIC_FORM_START + 92)
#define SPECIES_ZARUDE_DADA (SPECIES_COSMETIC_FORM_START + 93)
#define SPECIES_CALYREX_ICE_RIDER (SPECIES_COSMETIC_FORM_START + 94)
#define SPECIES_CALYREX_SHADOW_RIDER (SPECIES_COSMETIC_FORM_START + 95)

#define MAX_COSMETIC_NUM (SPECIES_CALYREX_SHADOW_RIDER)


//battle forms
#define SPECIES_BATTLE_FORM_START (MAX_COSMETIC_NUM + 1)

#define SPECIES_CASTFORM_SUN (SPECIES_BATTLE_FORM_START)
#define SPECIES_CASTFORM_RAIN (SPECIES_BATTLE_FORM_START + 1)
#define SPECIES_CASTFORM_SNOW (SPECIES_BATTLE_FORM_START + 2)
#define SPECIES_CHERRIM_SUNSHINE (SPECIES_BATTLE_FORM_START + 3)
#define SPECIES_SHELLOS_EAST_SEA (SPECIES_BATTLE_FORM_START + 4)
#define SPECIES_GASTRODON_EAST_SEA (SPECIES_BATTLE_FORM_START + 5)
#define SPECIES_DARMANITAN_ZEN_MODE (SPECIES_BATTLE_FORM_START + 6)
#define SPECIES_GALARIAN_DARMANITAN_ZEN_MODE (SPECIES_BATTLE_FORM_START + 7)
#define SPECIES_MELOETTA_PIROUETTE (SPECIES_BATTLE_FORM_START + 8)
#define SPECIES_GRENINJA_ASH (SPECIES_BATTLE_FORM_START + 9)
#define SPECIES_AEGISLASH_BLADE (SPECIES_BATTLE_FORM_START + 10)
#define SPECIES_XERNEAS_ACTIVE (SPECIES_BATTLE_FORM_START + 11)
#define SPECIES_WISHIWASHI_SCHOOL (SPECIES_BATTLE_FORM_START + 12)
#define SPECIES_MINIOR_CORE_RED (SPECIES_BATTLE_FORM_START + 13)
#define SPECIES_MINIOR_CORE_ORANGE (SPECIES_BATTLE_FORM_START + 14)
#define SPECIES_MINIOR_CORE_YELLOW (SPECIES_BATTLE_FORM_START + 15)
#define SPECIES_MINIOR_CORE_GREEN (SPECIES_BATTLE_FORM_START + 16)
#define SPECIES_MINIOR_CORE_BLUE (SPECIES_BATTLE_FORM_START + 17)
#define SPECIES_MINIOR_CORE_INDIGO (SPECIES_BATTLE_FORM_START + 18)
#define SPECIES_MINIOR_CORE_VIOLET (SPECIES_BATTLE_FORM_START + 19)
#define SPECIES_MIMIKYU_BUSTED (SPECIES_BATTLE_FORM_START + 20)
#define SPECIES_NECROZMA_DUSK_MANE (SPECIES_BATTLE_FORM_START + 21)
#define SPECIES_NECROZMA_DAWN_WINGS (SPECIES_BATTLE_FORM_START + 22)
#define SPECIES_NECROZMA_ULTRA (SPECIES_BATTLE_FORM_START + 23)
#define SPECIES_CRAMORANT_GULPING (SPECIES_BATTLE_FORM_START + 24)
#define SPECIES_CRAMORANT_GORGING (SPECIES_BATTLE_FORM_START + 25)
#define SPECIES_EISCUE_NOICE_FACE (SPECIES_BATTLE_FORM_START + 26)
#define SPECIES_MORPEKO_HANGRY (SPECIES_BATTLE_FORM_START + 27)
#define SPECIES_ZACIAN_CROWNED (SPECIES_BATTLE_FORM_START + 28)
#define SPECIES_ZAMAZENTA_CROWNED (SPECIES_BATTLE_FORM_START + 29)

#define MAX_BATTLE_FORM_NUM (SPECIES_ZAMAZENTA_CROWNED)
