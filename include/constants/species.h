...
//galarians
#define SPECIES_GALARIAN_REGIONAL_START (MAX_ALOLAN_REGIONAL_NUM + 1) // 1150
...
//misc forms
#define SPECIES_MISC_FORM_START (MAX_GALARIAN_REGIONAL_NUM + 1) // 1174
...
//hisuian
#define SPECIES_HISUIAN_REGIONAL_START (MAX_MISC_FORM_NUM + 1) // 1320
...
#define SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1329
...
#define SPECIES_PALDEAN_FORMS_START (MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM + 1) // 1336
...
#define SPECIES_POLTCHAGEIST_MASTERPIECE (SPECIES_PALDEAN_FORMS_START + 19)
#define SPECIES_SINISTCHA_MASTERPIECE (SPECIES_PALDEAN_FORMS_START + 20)
#define SPECIES_KORAIDON_LIMITED_BUILD (SPECIES_PALDEAN_FORMS_START + 21)
#define SPECIES_KORAIDON_SPRINTING_BUILD (SPECIES_PALDEAN_FORMS_START + 22)
#define SPECIES_KORAIDON_SWIMMING_BUILD (SPECIES_PALDEAN_FORMS_START + 23)
#define SPECIES_KORAIDON_GLIDING_BUILD (SPECIES_PALDEAN_FORMS_START + 24)
#define SPECIES_MIRAIDON_LOW_POWER_MODE (SPECIES_PALDEAN_FORMS_START + 25)
#define SPECIES_MIRAIDON_DRIVE_MODE (SPECIES_PALDEAN_FORMS_START + 26)
#define SPECIES_MIRAIDON_AQUATIC_MODE (SPECIES_PALDEAN_FORMS_START + 27)
#define SPECIES_MIRAIDON_GLIDE_MODE (SPECIES_PALDEAN_FORMS_START + 28)
...
#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_TERAPAGOS_STELLAR)  // 1380
