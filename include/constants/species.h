...
//primals
#define SPECIES_PRIMAL_START (MAX_MEGA_NUM + 1)
...
//alolans
#define SPECIES_ALOLAN_REGIONAL_START (MAX_PRIMAL_NUM + 1)
...
//misc forms
#define SPECIES_MISC_FORM_START (MAX_HISUIAN_REGIONAL_NUM + 1)
