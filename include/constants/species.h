...
//hisuians
#define SPECIES_HISUIAN_REGIONAL_START (MAX_GALARIAN_REGIONAL_NUM + 1) // 1036

#define MAX_HISUIAN_REGIONAL_NUM (MAX_GALARIAN_REGIONAL_NUM) // skip over it for the moment--come back to it


//misc forms
#define SPECIES_MISC_FORM_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1036
...
#define MAX_MISC_FORM_NUM (SPECIES_CALYREX_SHADOW_RIDER)
