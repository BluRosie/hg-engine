...
#define SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_START (MAX_HISUIAN_REGIONAL_NUM + 1)
...
#define MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM (SPECIES_MEOWSTIC_FEMALE)
