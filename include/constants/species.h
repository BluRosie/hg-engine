...
//primals
#define SPECIES_PRIMAL_START (MAX_MEGA_NUM + 1) // 996
...
//alolans
#define SPECIES_ALOLAN_REGIONAL_START (MAX_PRIMAL_NUM + 1) // 998
...
//galarians
#define SPECIES_GALARIAN_REGIONAL_START (MAX_ALOLAN_REGIONAL_NUM + 1) // 1016
...
//hisuians
#define SPECIES_HISUIAN_REGIONAL_START (MAX_GALARIAN_REGIONAL_NUM + 1) // 1035

#define MAX_HISUIAN_REGIONAL_NUM (MAX_GALARIAN_REGIONAL_NUM) // skip over it for the moment--come back to it


//misc forms
#define SPECIES_MISC_FORM_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1035
