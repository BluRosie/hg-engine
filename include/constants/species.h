...
#define SPECIES_NECROZMA_ULTRA_DUSK_MANE (SPECIES_BATTLE_FORM_START + 23)
#define SPECIES_NECROZMA_ULTRA_DAWN_WINGS (SPECIES_BATTLE_FORM_START + 24)
#define SPECIES_CRAMORANT_GULPING (SPECIES_BATTLE_FORM_START + 25)
#define SPECIES_CRAMORANT_GORGING (SPECIES_BATTLE_FORM_START + 26)
#define SPECIES_EISCUE_NOICE_FACE (SPECIES_BATTLE_FORM_START + 27)
#define SPECIES_MORPEKO_HANGRY (SPECIES_BATTLE_FORM_START + 28)
#define SPECIES_ZACIAN_CROWNED (SPECIES_BATTLE_FORM_START + 29)
#define SPECIES_ZAMAZENTA_CROWNED (SPECIES_BATTLE_FORM_START + 30)
