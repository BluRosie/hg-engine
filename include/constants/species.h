...
#define SPECIES_DIALGA_ORIGIN (SPECIES_MISC_FORM_START + 20) //TODO see documentation/species data todo.txt for info on stats (dumped from PLA by Kaphotics)
#define SPECIES_PALKIA_ORIGIN (SPECIES_MISC_FORM_START + 21) //TODO see documentation/species data todo.txt for info on stats (dumped from PLA by Kaphotics)

#define SPECIES_BASCULIN_BLUE_STRIPED (SPECIES_MISC_FORM_START + 22)
#define SPECIES_BASCULIN_WHITE_STRIPED (SPECIES_MISC_FORM_START + 23) //TODO see documentation/species data todo.txt for info on stats (dumped from PLA by Kaphotics)
...
#define SPECIES_ALCREMIE_RUBY_CREAM (SPECIES_MISC_FORM_START + 131)
#define SPECIES_ALCREMIE_MATCHA_CREAM (SPECIES_MISC_FORM_START + 132)
#define SPECIES_ALCREMIE_MINT_CREAM (SPECIES_MISC_FORM_START + 133)
#define SPECIES_ALCREMIE_LEMON_CREAM (SPECIES_MISC_FORM_START + 134)
#define SPECIES_ALCREMIE_SALTED_CREAM (SPECIES_MISC_FORM_START + 135)
#define SPECIES_ALCREMIE_RUBY_SWIRL (SPECIES_MISC_FORM_START + 136)
#define SPECIES_ALCREMIE_CARAMEL_SWIRL (SPECIES_MISC_FORM_START + 137)
#define SPECIES_ALCREMIE_RAINBOW_SWIRL (SPECIES_MISC_FORM_START + 138)
...
#define SPECIES_ENAMORUS_THERIAN (SPECIES_MISC_FORM_START + 148) //TODO see documentation/species data todo.txt for info on stats (dumped from PLA by Kaphotics)

#define MAX_MISC_FORM_NUM (SPECIES_ENAMORUS_THERIAN)

//hisuians TODO see documentation/species data todo.txt for info on stats (dumped from PLA by Kaphotics)
