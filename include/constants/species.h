...
//regionals
#define SPECIES_REGIONAL_START (MAX_MEGA_NUM + 1)

#define SPECIES_ALOLAN_RATTATA (SPECIES_REGIONAL_START)
#define SPECIES_ALOLAN_RATICATE (SPECIES_REGIONAL_START + 1)
#define SPECIES_ALOLAN_RAICHU (SPECIES_REGIONAL_START + 2)
#define SPECIES_ALOLAN_SANDSHREW (SPECIES_REGIONAL_START + 3)
#define SPECIES_ALOLAN_SANDSLASH (SPECIES_REGIONAL_START + 4)
#define SPECIES_ALOLAN_VULPIX (SPECIES_REGIONAL_START + 5)
#define SPECIES_ALOLAN_NINETAILS (SPECIES_REGIONAL_START + 6)
#define SPECIES_ALOLAN_DIGLETT (SPECIES_REGIONAL_START + 7)
#define SPECIES_ALOLAN_DUGTRIO (SPECIES_REGIONAL_START + 8)
#define SPECIES_ALOLAN_MEOWTH (SPECIES_REGIONAL_START + 9)
#define SPECIES_GALARIAN_MEOWTH (SPECIES_REGIONAL_START + 10)
#define SPECIES_ALOLAN_PERSIAN (SPECIES_REGIONAL_START + 11)
#define SPECIES_ALOLAN_GEODUDE (SPECIES_REGIONAL_START + 12)
#define SPECIES_ALOLAN_GRAVELER (SPECIES_REGIONAL_START + 13)
#define SPECIES_ALOLAN_GOLEM (SPECIES_REGIONAL_START + 14)
#define SPECIES_GALARIAN_PONYTA (SPECIES_REGIONAL_START + 15)
#define SPECIES_GALARIAN_RAPIDASH (SPECIES_REGIONAL_START + 16)
#define SPECIES_GALARIAN_SLOWPOKE (SPECIES_REGIONAL_START + 17)
#define SPECIES_GALARIAN_SLOWBRO (SPECIES_REGIONAL_START + 18)
#define SPECIES_GALARIAN_FARFETCHD (SPECIES_REGIONAL_START + 19)
#define SPECIES_ALOLAN_GRIMER (SPECIES_REGIONAL_START + 20)
#define SPECIES_ALOLAN_MUK (SPECIES_REGIONAL_START + 21)
#define SPECIES_ALOLAN_EXEGGUTOR (SPECIES_REGIONAL_START + 22)
#define SPECIES_ALOLAN_MAROWAK (SPECIES_REGIONAL_START + 23)
#define SPECIES_GALARIAN_WEEZING (SPECIES_REGIONAL_START + 24)
#define SPECIES_GALARIAN_MR_MIME (SPECIES_REGIONAL_START + 25)
#define SPECIES_GALARIAN_ARTICUNO (SPECIES_REGIONAL_START + 26)
#define SPECIES_GALARIAN_ZAPDOS (SPECIES_REGIONAL_START + 27)
#define SPECIES_GALARIAN_MOLTRES (SPECIES_REGIONAL_START + 28)
#define SPECIES_GALARIAN_SLOWKING (SPECIES_REGIONAL_START + 29)
#define SPECIES_GALARIAN_CORSOLA (SPECIES_REGIONAL_START + 30)
#define SPECIES_GALARIAN_ZIGZAGOON (SPECIES_REGIONAL_START + 31)
#define SPECIES_GALARIAN_LINOONE (SPECIES_REGIONAL_START + 32)
#define SPECIES_GALARIAN_DARUMAKA (SPECIES_REGIONAL_START + 33)
#define SPECIES_GALARIAN_DARMANITAN (SPECIES_REGIONAL_START + 34)
#define SPECIES_GALARIAN_YAMASK (SPECIES_REGIONAL_START + 35)
#define SPECIES_GALARIAN_STUNFISK (SPECIES_REGIONAL_START + 36)

#define MAX_REGIONAL_NUM (SPECIES_GALARIAN_STUNFISK)


//cosmetic forms
#define SPECIES_COSMETIC_FORM_START (MAX_REGIONAL_NUM + 1)

#define SPECIES_PIKACHU_COSPLAY (SPECIES_COSMETIC_FORM_START)
#define SPECIES_PIKACHU_ROCK_STAR (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_BELLE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_POP_STAR (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_PHD (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_LIBRE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_ORIGINAL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_HOENN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_SINNOH (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_UNOVA (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_KALOS (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_ALOLA (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_PARTNER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PIKACHU_CAP_WORLD (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_BASCULIN_BLUE_STRIPE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_DEERLING_SUMMER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_DEERLING_AUTUMN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_DEERLING_WINTER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_SAWSBUCK_SUMMER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_SAWSBUCK_AUTUMN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_SAWSBUCK_WINTER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_KELDEO_RESOLUTE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GENESECT_SHOCK (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GENESECT_BURN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GENESECT_CHILL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GENESECT_DOUSE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_ARCHIPELAGO (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_CONTINENTAL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_ELEGANT (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_GARDEN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_HIGH_PLAINS (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_ICY_SNOW (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_JUNGLE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_MARINE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_MODERN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_MONSOON (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_OCEAN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_POLAR (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_RIVER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_SANDSTORM (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_SAVANNA (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_SUN (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_TUNDRA (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_POKEBALL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_VIVILLON_FANCY (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLABEBE_RED (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLABEBE_YELLOW (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLABEBE_ORANGE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLABEBE_BLUE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLABEBE_WHITE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_RED (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_YELLOW (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_ORANGE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_BLUE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_WHITE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLOETTE_ETERNAL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLORGES_RED (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLORGES_YELLOW (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLORGES_ORANGE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLORGES_BLUE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FLORGES_WHITE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_HEART (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_STAR (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_DIAMOND (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_DEBUTANTE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_MATRON (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_DANDY (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_LA_REINE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_KABUKI (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_FURFROU_PHARAOH (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PUMPKABOO_SMALL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PUMPKABOO_LARGE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_PUMPKABOO_SUPER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GOURGEIST_SMALL (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GOURGEIST_LARGE (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_GOURGEIST_SUPER (SPECIES_COSMETIC_FORM_START + 1)
#define SPECIES_XERNEAS (SPECIES_COSMETIC_FORM_START + 1)





#define MAX_COSMETIC_NUM ()
...
#define SPECIES_CASTFORM_RAIN (SPECIES_BATTLE_FORM_START)
#define SPECIES_CASTFORM_SNOW (SPECIES_BATTLE_FORM_START)
#define SPECIES_DARMANITAN_ZEN_MODE (SPECIES_BATTLE_FORM_START) // placeholder for the moment
