...
#define MOVE_EFFECT_CUSTOM_ELECTRO_BALL                     (MAX_BASE_MOVE_EFFECT_NUM + 1)
#define MOVE_EFFECT_CUSTOM_BITTER_MALICE                    (MAX_BASE_MOVE_EFFECT_NUM + 2)
#define MOVE_EFFECT_CUSTOM_REMOVE_ITEM_HIT                  (MAX_BASE_MOVE_EFFECT_NUM + 3)
#define MOVE_EFFECT_CUSTOM_GROWTH                           (MAX_BASE_MOVE_EFFECT_NUM + 4)
#define MOVE_EFFECT_CUSTOM_STATUS_FREEZE                    (MAX_BASE_MOVE_EFFECT_NUM + 5)
#define MOVE_EFFECT_CUSTOM_STORED_POWER                     (MAX_BASE_MOVE_EFFECT_NUM + 6)
#define MOVE_EFFECT_CUSTOM_BURN_HIT_HEAL_STATUS             (MAX_BASE_MOVE_EFFECT_NUM + 7)
#define MOVE_EFFECT_CUSTOM_HEAL_USER_AND_ALLY               (MAX_BASE_MOVE_EFFECT_NUM + 8)
#define MOVE_EFFECT_CUSTOM_FORCE_SWITCH_HIT                 (MAX_BASE_MOVE_EFFECT_NUM + 9)
#define MOVE_EFFECT_CUSTOM_USER_ATK_DOWN_2                  (MAX_BASE_MOVE_EFFECT_NUM + 10)
#define MOVE_EFFECT_CUSTOM_HIT_CANT_USE_CONSECUTIVELY       (MAX_BASE_MOVE_EFFECT_NUM + 11)
