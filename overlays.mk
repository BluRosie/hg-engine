...
BATTLECONTROLLER_TRYMOVE_LINK = $(BUILD)/battlecontroller_trymove_linked.o
BATTLECONTROLLER_TRYMOVE_OUTPUT = $(BUILD)/output_battlecontroller_trymove.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_TRYMOVE_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_TRYMOVE_LINK)
BATTLECONTROLLER_TRYMOVE2_LINK = $(BUILD)/battlecontroller_trymove2_linked.o
BATTLECONTROLLER_TRYMOVE2_OUTPUT = $(BUILD)/output_battlecontroller_trymove2.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_TRYMOVE2_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_TRYMOVE2_LINK)
...
BATTLECONTROLLER_TRYMOVE_C_SRCS := $(C_SUBDIR)/individual/BattleController_TryMove.c
BATTLECONTROLLER_TRYMOVE_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_TRYMOVE_C_SRCS))
BATTLECONTROLLER_TRYMOVE_OBJS := $(BATTLECONTROLLER_TRYMOVE_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_TRYMOVE_OBJS)

BATTLECONTROLLER_TRYMOVE2_C_SRCS := $(C_SUBDIR)/individual/BattleController_TryMove2.c
BATTLECONTROLLER_TRYMOVE2_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_TRYMOVE2_C_SRCS))
BATTLECONTROLLER_TRYMOVE2_OBJS := $(BATTLECONTROLLER_TRYMOVE2_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_TRYMOVE2_OBJS)
...
$(BATTLECONTROLLER_TRYMOVE_LINK):$(BATTLECONTROLLER_TRYMOVE_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_TRYMOVE_OBJS)

$(BATTLECONTROLLER_TRYMOVE_OUTPUT):$(BATTLECONTROLLER_TRYMOVE_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_TRYMOVE2_LINK):$(BATTLECONTROLLER_TRYMOVE2_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_TRYMOVE2_OBJS)

$(BATTLECONTROLLER_TRYMOVE2_OUTPUT):$(BATTLECONTROLLER_TRYMOVE2_LINK)
	$(OBJCOPY) -O binary $< $@
