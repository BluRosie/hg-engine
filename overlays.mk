...
BATTLECONTROLLER_BEFOREMOVE2_LINK = $(BUILD)/battlecontroller_beforemove2_linked.o
BATTLECONTROLLER_BEFOREMOVE2_OUTPUT = $(BUILD)/output_battlecontroller_beforemove2.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE2_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE2_LINK)

BATTLECONTROLLER_BEFOREMOVE3_LINK = $(BUILD)/battlecontroller_beforemove3_linked.o
BATTLECONTROLLER_BEFOREMOVE3_OUTPUT = $(BUILD)/output_battlecontroller_beforemove3.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE3_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE3_LINK)

BATTLECONTROLLER_BEFOREMOVE4_LINK = $(BUILD)/battlecontroller_beforemove4_linked.o
BATTLECONTROLLER_BEFOREMOVE4_OUTPUT = $(BUILD)/output_battlecontroller_beforemove4.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE4_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE4_LINK)

BATTLECONTROLLER_BEFOREMOVE5_LINK = $(BUILD)/battlecontroller_beforemove5_linked.o
BATTLECONTROLLER_BEFOREMOVE5_OUTPUT = $(BUILD)/output_battlecontroller_beforemove5.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE5_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE5_LINK)

BATTLECONTROLLER_BEFOREMOVE6_LINK = $(BUILD)/battlecontroller_beforemove6_linked.o
BATTLECONTROLLER_BEFOREMOVE6_OUTPUT = $(BUILD)/output_battlecontroller_beforemove6.bin
OVERLAY_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE6_OUTPUT)
LINKED_OUTPUTS += $(BATTLECONTROLLER_BEFOREMOVE6_LINK)
...
SERVERFIELDCONDITIONCHECK_OBJS := $(SERVERFIELDCONDITIONCHECK_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(SERVERFIELDCONDITIONCHECK_OBJS)
...
BATTLECONTROLLER_BEFOREMOVE_OBJS := $(BATTLECONTROLLER_BEFOREMOVE_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE_OBJS)

BATTLECONTROLLER_BEFOREMOVE2_C_SRCS := $(C_SUBDIR)/individual/BattleController_BeforeMove2.c
BATTLECONTROLLER_BEFOREMOVE2_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_BEFOREMOVE2_C_SRCS))
BATTLECONTROLLER_BEFOREMOVE2_OBJS := $(BATTLECONTROLLER_BEFOREMOVE2_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE2_OBJS)

BATTLECONTROLLER_BEFOREMOVE3_C_SRCS := $(C_SUBDIR)/individual/BattleController_BeforeMove3.c
BATTLECONTROLLER_BEFOREMOVE3_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_BEFOREMOVE3_C_SRCS))
BATTLECONTROLLER_BEFOREMOVE3_OBJS := $(BATTLECONTROLLER_BEFOREMOVE3_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE3_OBJS)

BATTLECONTROLLER_BEFOREMOVE4_C_SRCS := $(C_SUBDIR)/individual/BattleController_BeforeMove4.c
BATTLECONTROLLER_BEFOREMOVE4_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_BEFOREMOVE4_C_SRCS))
BATTLECONTROLLER_BEFOREMOVE4_OBJS := $(BATTLECONTROLLER_BEFOREMOVE4_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE4_OBJS)

BATTLECONTROLLER_BEFOREMOVE5_C_SRCS := $(C_SUBDIR)/individual/BattleController_BeforeMove5.c
BATTLECONTROLLER_BEFOREMOVE5_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_BEFOREMOVE5_C_SRCS))
BATTLECONTROLLER_BEFOREMOVE5_OBJS := $(BATTLECONTROLLER_BEFOREMOVE5_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE5_OBJS)

BATTLECONTROLLER_BEFOREMOVE6_C_SRCS := $(C_SUBDIR)/individual/BattleController_BeforeMove6.c
BATTLECONTROLLER_BEFOREMOVE6_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(BATTLECONTROLLER_BEFOREMOVE6_C_SRCS))
BATTLECONTROLLER_BEFOREMOVE6_OBJS := $(BATTLECONTROLLER_BEFOREMOVE6_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(BATTLECONTROLLER_BEFOREMOVE6_OBJS)
...
$(BATTLECONTROLLER_BEFOREMOVE_LINK):$(BATTLECONTROLLER_BEFOREMOVE_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_BEFOREMOVE2_LINK):$(BATTLECONTROLLER_BEFOREMOVE2_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE2_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE2_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE2_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_BEFOREMOVE3_LINK):$(BATTLECONTROLLER_BEFOREMOVE3_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE3_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE3_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE3_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_BEFOREMOVE4_LINK):$(BATTLECONTROLLER_BEFOREMOVE4_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE4_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE4_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE4_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_BEFOREMOVE5_LINK):$(BATTLECONTROLLER_BEFOREMOVE5_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE5_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE5_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE5_LINK)
	$(OBJCOPY) -O binary $< $@

$(BATTLECONTROLLER_BEFOREMOVE6_LINK):$(BATTLECONTROLLER_BEFOREMOVE6_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(BATTLECONTROLLER_BEFOREMOVE6_OBJS)

$(BATTLECONTROLLER_BEFOREMOVE6_OUTPUT):$(BATTLECONTROLLER_BEFOREMOVE6_LINK)
	$(OBJCOPY) -O binary $< $@