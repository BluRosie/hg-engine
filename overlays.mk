...
CALCDAMAGEOVERALL_LINK = $(BUILD)/calcdamageoverall_linked.o
CALCDAMAGEOVERALL_OUTPUT = $(BUILD)/output_calcdamageoverall.bin
OVERLAY_OUTPUTS += $(CALCDAMAGEOVERALL_OUTPUT)
LINKED_OUTPUTS += $(CALCDAMAGEOVERALL_LINK)
CALC_CHAINOTHERMODIFIERS_LINK = $(BUILD)/calc_chainothermodifiers_linked.o
CALC_CHAINOTHERMODIFIERS_OUTPUT = $(BUILD)/output_calc_chainothermodifiers.bin
OVERLAY_OUTPUTS += $(CALC_CHAINOTHERMODIFIERS_OUTPUT)
LINKED_OUTPUTS += $(CALC_CHAINOTHERMODIFIERS_LINK)
...
CALCDAMAGEOVERALL_C_SRCS := $(C_SUBDIR)/individual/CalcDamageOverall.c
CALCDAMAGEOVERALL_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(CALCDAMAGEOVERALL_C_SRCS))
CALCDAMAGEOVERALL_OBJS := $(CALCDAMAGEOVERALL_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(CALCDAMAGEOVERALL_OBJS)

CALC_CHAINOTHERMODIFIERS_C_SRCS := $(C_SUBDIR)/individual/Calc_ChainOtherModifiers.c
CALC_CHAINOTHERMODIFIERS_C_OBJS := $(patsubst $(C_SUBDIR)/%.c,$(BUILD)/%.o,$(CALC_CHAINOTHERMODIFIERS_C_SRCS))
CALC_CHAINOTHERMODIFIERS_OBJS := $(CALC_CHAINOTHERMODIFIERS_C_OBJS) build/thumb_help.d
OVERLAY_OBJS += $(CALC_CHAINOTHERMODIFIERS_OBJS)
...
$(CALCDAMAGEOVERALL_LINK):$(CALCDAMAGEOVERALL_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(CALCDAMAGEOVERALL_OBJS)

$(CALCDAMAGEOVERALL_OUTPUT):$(CALCDAMAGEOVERALL_LINK)
	$(OBJCOPY) -O binary $< $@

$(CALC_CHAINOTHERMODIFIERS_LINK):$(CALC_CHAINOTHERMODIFIERS_OBJS) rom_gen_battle.ld
	$(LD) $(LDFLAGS_SWITCHINABILITYCHECK) -o $@ $(CALC_CHAINOTHERMODIFIERS_OBJS)

$(CALC_CHAINOTHERMODIFIERS_OUTPUT):$(CALC_CHAINOTHERMODIFIERS_LINK)
	$(OBJCOPY) -O binary $< $@
